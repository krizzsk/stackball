...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
        ...
        if (fragment != null) {
            ...
            if (!fragment.isAdded() && view != null) {
                ...
                if (fragment.isAdded()) {
                    ...
                    beginTransaction.add(fragment, InneractiveMediationDefs.GENDER_FEMALE + fragmentViewHolder.getItemId()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
    ...
    class FragmentMaxLifecycleEnforcer {
        ...
        public void register(RecyclerView recyclerView) {
            ...
            C05151 r2 = new ViewPager2.OnPageChangeCallback() {
            ...
            C05162 r22 = new DataSetChangeObserver() {
