        ...
        synchronized (AppCompatDrawableManager.class) {
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new ResourceManagerInternal.ResourceManagerHooks() {
                    private final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {C0041R.C0042drawable.abc_popup_background_mtrl_mult, C0041R.C0042drawable.abc_cab_background_internal_bg, C0041R.C0042drawable.abc_menu_hardkey_panel_mtrl_mult};
                    private final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {C0041R.C0042drawable.abc_textfield_activated_mtrl_alpha, C0041R.C0042drawable.abc_textfield_search_activated_mtrl_alpha, C0041R.C0042drawable.abc_cab_background_top_mtrl_alpha, C0041R.C0042drawable.abc_text_cursor_material, C0041R.C0042drawable.abc_text_select_handle_left_mtrl_dark, C0041R.C0042drawable.abc_text_select_handle_middle_mtrl_dark, C0041R.C0042drawable.abc_text_select_handle_right_mtrl_dark, C0041R.C0042drawable.abc_text_select_handle_left_mtrl_light, C0041R.C0042drawable.abc_text_select_handle_middle_mtrl_light, C0041R.C0042drawable.abc_text_select_handle_right_mtrl_light};
                    private final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {C0041R.C0042drawable.abc_textfield_search_default_mtrl_alpha, C0041R.C0042drawable.abc_textfield_default_mtrl_alpha, C0041R.C0042drawable.abc_ab_share_pack_mtrl_alpha};
                    private final int[] TINT_CHECKABLE_BUTTON_LIST = {C0041R.C0042drawable.abc_btn_check_material, C0041R.C0042drawable.abc_btn_radio_material, C0041R.C0042drawable.abc_btn_check_material_anim, C0041R.C0042drawable.abc_btn_radio_material_anim};
                    private final int[] TINT_COLOR_CONTROL_NORMAL = {C0041R.C0042drawable.abc_ic_commit_search_api_mtrl_alpha, C0041R.C0042drawable.abc_seekbar_tick_mark_material, C0041R.C0042drawable.abc_ic_menu_share_mtrl_alpha, C0041R.C0042drawable.abc_ic_menu_copy_mtrl_am_alpha, C0041R.C0042drawable.abc_ic_menu_cut_mtrl_alpha, C0041R.C0042drawable.abc_ic_menu_selectall_mtrl_alpha, C0041R.C0042drawable.abc_ic_menu_paste_mtrl_am_alpha};
                    private final int[] TINT_COLOR_CONTROL_STATE_LIST = {C0041R.C0042drawable.abc_tab_indicator_material, C0041R.C0042drawable.abc_textfield_search_material};
                    ...
                    public Drawable createDrawableFor(ResourceManagerInternal resourceManagerInternal, Context context, int i) {
                        if (i != C0041R.C0042drawable.abc_cab_background_top_material) {
                            return null;
                        }
                        return new LayerDrawable(new Drawable[]{resourceManagerInternal.getDrawable(context, C0041R.C0042drawable.abc_cab_background_internal_bg), resourceManagerInternal.getDrawable(context, C0041R.C0042drawable.abc_cab_background_top_mtrl_alpha)});
                    }
                    ...
                    public boolean tintDrawable(Context context, int i, Drawable drawable) {
                        if (i == C0041R.C0042drawable.abc_seekbar_track_material) {
                            ...
                            return true;
                        } else if (i != C0041R.C0042drawable.abc_ratingbar_material && i != C0041R.C0042drawable.abc_ratingbar_indicator_material && i != C0041R.C0042drawable.abc_ratingbar_small_material) {
                            return false;
                        } else {
                    ...
                    public ColorStateList getTintListForDrawableRes(Context context, int i) {
                        if (i == C0041R.C0042drawable.abc_edit_text_material) {
                            return AppCompatResources.getColorStateList(context, C0041R.color.abc_tint_edittext);
                        }
                        if (i == C0041R.C0042drawable.abc_switch_track_mtrl_alpha) {
                            return AppCompatResources.getColorStateList(context, C0041R.color.abc_tint_switch_track);
                        }
                        if (i == C0041R.C0042drawable.abc_switch_thumb_material) {
                            return createSwitchThumbColorStateList(context);
                        }
                        if (i == C0041R.C0042drawable.abc_btn_default_mtrl_shape) {
                            return createDefaultButtonColorStateList(context);
                        }
                        if (i == C0041R.C0042drawable.abc_btn_borderless_material) {
                            return createBorderlessButtonColorStateList(context);
                        }
                        if (i == C0041R.C0042drawable.abc_btn_colored_material) {
                            return createColoredButtonColorStateList(context);
                        }
                        if (i == C0041R.C0042drawable.abc_spinner_mtrl_am_alpha || i == C0041R.C0042drawable.abc_spinner_textfield_background_material) {
                            return AppCompatResources.getColorStateList(context, C0041R.color.abc_tint_spinner);
                        }
                        ...
                        if (arrayContains(this.TINT_COLOR_CONTROL_STATE_LIST, i)) {
                            return AppCompatResources.getColorStateList(context, C0041R.color.abc_tint_default);
                        }
                        if (arrayContains(this.TINT_CHECKABLE_BUTTON_LIST, i)) {
                            return AppCompatResources.getColorStateList(context, C0041R.color.abc_tint_btn_checkable);
                        }
                        if (i == C0041R.C0042drawable.abc_seekbar_thumb_material) {
                            return AppCompatResources.getColorStateList(context, C0041R.color.abc_tint_seek_thumb);
                        }
                        return null;
                    }
                    ...
                    public boolean tintDrawableUsingColorFilter(android.content.Context r7, int r8, android.graphics.drawable.Drawable r9) {
                        ...
                        L_0x0022:
                            ...
                            goto L_0x0014
                        L_0x002d:
                            int r1 = androidx.appcompat.C0041R.C0042drawable.abc_list_divider_mtrl_alpha
                            ...
                            goto L_0x0015
                        L_0x003c:
                            int r1 = androidx.appcompat.C0041R.C0042drawable.abc_dialog_material_background
