...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        boolean z = true;
        if (getId() == C0041R.C0043id.split_action_bar) {
            this.mIsSplit = true;
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0041R.C0043id.action_bar);
        this.mContextView = findViewById(C0041R.C0043id.action_context_bar);
    }
