...
class DebugProperties {
    ...
    public static final String DEBUG_GDPR = "debug.gdpr";
    ...
    public Integer getDebugPropertyAsInteger(String str, Integer num) {
        ...
        try {
            ...
            this.logger.mo11020e("Unable to parse integer debug property - property: %s, value: %s", str, property);
            return num;
        }
    }
    ...
    public Boolean getDebugPropertyAsBoolean(String str, Boolean bool) {
        ...
        try {
            ...
            this.logger.mo11020e("Unable to parse boolean debug property - property: %s, value: %s", str, property);
            return bool;
        }
    }
    ...
    public Long getDebugPropertyAsLong(String str, Long l) {
        ...
        try {
            ...
            this.logger.mo11020e("Unable to parse long debug property - property: %s, value: %s", str, property);
            return l;
        }
    }
    ...
    public JSONObject getDebugPropertyAsJSONObject(String str, JSONObject jSONObject) {
        ...
        return this.jsonUtilities.getJSONObjectFromString(property);
    }
