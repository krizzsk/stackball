...
public class CustomTabMainActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION.equals(getIntent().getAction())) {
            ...
            if (C20302.$SwitchMap$com$facebook$login$LoginTargetApp[LoginTargetApp.fromString(getIntent().getStringExtra(EXTRA_TARGET_APP)).ordinal()] != 1) {
