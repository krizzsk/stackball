...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Sharer.Result> implements Sharer {
    ...
    public List<FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler> getOrderedModeHandlers() {
        ...
        arrayList.add(new NativeHandler(this, (C23011) null));
        arrayList.add(new FeedHandler(this, (C23011) null));
        arrayList.add(new WebShareHandler(this, (C23011) null));
        arrayList.add(new CameraEffectHandler(this, (C23011) null));
        arrayList.add(new ShareStoryHandler(this, (C23011) null));
        return arrayList;
    }
    ...
    private class NativeHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ NativeHandler(ShareDialog shareDialog, C23011 r2) {
            this();
        }
    ...
    private class WebShareHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ WebShareHandler(ShareDialog shareDialog, C23011 r2) {
            this();
        }
    ...
    private class FeedHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ FeedHandler(ShareDialog shareDialog, C23011 r2) {
            this();
        }
    ...
    private class CameraEffectHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, C23011 r2) {
            this();
        }
    ...
    private class ShareStoryHandler extends FacebookDialogBase<ShareContent, Sharer.Result>.ModeHandler {
        ...
        /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, C23011 r2) {
            this();
        }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i = C23011.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
        String str2 = i != 1 ? i != 2 ? i != 3 ? str : "native" : "web" : AnalyticsEvents.PARAMETER_SHARE_DIALOG_SHOW_AUTOMATIC;
    ...
    static /* synthetic */ class C23011 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.ShareDialog.C23011.<clinit>():void");
        }
    }
}
