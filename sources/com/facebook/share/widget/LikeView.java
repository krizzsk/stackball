...
public class LikeView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet != null && getContext() != null && (obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2100R.styleable.com_facebook_like_view)) != null) {
            this.objectId = Utility.coerceValueIfNullOrEmpty(obtainStyledAttributes.getString(C2100R.styleable.com_facebook_like_view_com_facebook_object_id), (String) null);
            this.objectType = ObjectType.fromInt(obtainStyledAttributes.getInt(C2100R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
            Style fromInt = Style.fromInt(obtainStyledAttributes.getInt(C2100R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
            this.likeViewStyle = fromInt;
            if (fromInt != null) {
                AuxiliaryViewPosition fromInt2 = AuxiliaryViewPosition.fromInt(obtainStyledAttributes.getInt(C2100R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
                this.auxiliaryViewPosition = fromInt2;
                if (fromInt2 != null) {
                    HorizontalAlignment fromInt3 = HorizontalAlignment.fromInt(obtainStyledAttributes.getInt(C2100R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
                    this.horizontalAlignment = fromInt3;
                    if (fromInt3 != null) {
                        this.foregroundColor = obtainStyledAttributes.getColor(C2100R.styleable.com_facebook_like_view_com_facebook_foreground_color, -1);
    ...
    private void initialize(Context context) {
        this.edgePadding = getResources().getDimensionPixelSize(C2100R.dimen.com_facebook_likeview_edge_padding);
        this.internalPadding = getResources().getDimensionPixelSize(C2100R.dimen.com_facebook_likeview_internal_padding);
        if (this.foregroundColor == -1) {
            this.foregroundColor = getResources().getColor(C2100R.color.com_facebook_likeview_text_color);
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        textView.setTextSize(0, getResources().getDimension(C2100R.dimen.com_facebook_likeview_text_size));
    ...
    private void updateLayout() {
        ...
        int i3 = C22972.f5285x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i3 == 1) {
    ...
    static /* synthetic */ class C22972 {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f5285x30689ac     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f5285x30689ac     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.LikeView.C22972.<clinit>():void");
        }
    }

    private void updateBoxCountCaretPosition() {
        int i = C22972.f5285x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i == 1) {
