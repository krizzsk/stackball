...
public class DeviceShareDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C2100R.style.com_facebook_auth_dialog);
        View inflate = getActivity().getLayoutInflater().inflate(C2100R.layout.com_facebook_device_auth_dialog_fragment, (ViewGroup) null);
        this.progressBar = (ProgressBar) inflate.findViewById(C2100R.C2102id.progress_bar);
        ...
        ((TextView) inflate.findViewById(C2100R.C2102id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C2100R.string.com_facebook_device_auth_instructions)));
