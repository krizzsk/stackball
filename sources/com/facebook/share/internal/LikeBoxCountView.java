...
public class LikeBoxCountView extends FrameLayout {
    ...
    public void setCaretPosition(LikeBoxCountViewCaretPosition likeBoxCountViewCaretPosition) {
        ...
        int i = C22381.f5279x5851190f[likeBoxCountViewCaretPosition.ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C22381 {
        ...
        static final /* synthetic */ int[] f5279x5851190f;
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f5279x5851190f     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f5279x5851190f     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f5279x5851190f     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.LikeBoxCountView.C22381.<clinit>():void");
        }
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int i = C22381.f5279x5851190f[this.caretPosition.ordinal()];
        if (i == 1) {
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(C2100R.dimen.com_facebook_likeboxcountview_caret_height);
        this.caretWidth = getResources().getDimension(C2100R.dimen.com_facebook_likeboxcountview_caret_width);
        this.borderRadius = getResources().getDimension(C2100R.dimen.com_facebook_likeboxcountview_border_radius);
        Paint paint = new Paint();
        this.borderPaint = paint;
        paint.setColor(getResources().getColor(C2100R.color.com_facebook_likeboxcountview_border_color));
        this.borderPaint.setStrokeWidth(getResources().getDimension(C2100R.dimen.com_facebook_likeboxcountview_border_width));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(C2100R.dimen.com_facebook_likeboxcountview_text_size));
        this.likeCountLabel.setTextColor(getResources().getColor(C2100R.color.com_facebook_likeboxcountview_text_color));
        this.textPadding = getResources().getDimensionPixelSize(C2100R.dimen.com_facebook_likeboxcountview_text_padding);
        this.additionalTextPadding = getResources().getDimensionPixelSize(C2100R.dimen.com_facebook_likeboxcountview_caret_height);
    }
