...
public class LikeActionController {
        ...
        return new ResultProcessor((FacebookCallback) null) {
            public void onSuccess(AppCall appCall, Bundle bundle) {
                ...
                if (bundle != null && bundle.containsKey(LikeActionController.LIKE_DIALOG_RESPONSE_OBJECT_IS_LIKED_KEY)) {
                    ...
                    LikeActionController.this.updateState(z, str2, str, str4, str3, str6);
                }
            }
        ...
        if (!AccessToken.isCurrentAccessTokenActive()) {
            ...
            fetchVerifiedObjectId(new RequestCompletionCallback() {
                public void onComplete() {
                    ...
                    if (C222612.$SwitchMap$com$facebook$share$widget$LikeView$ObjectType[LikeActionController.this.objectType.ordinal()] != 1) {
                        LikeActionController likeActionController = LikeActionController.this;
    ...
    static /* synthetic */ class C222612 {
