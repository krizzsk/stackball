...
public final class InstrumentUtility {
    ...
    public static final File[] listAnrReportFiles() {
        ...
        File[] listFiles = instrumentReportDir.listFiles(InstrumentUtility$listAnrReportFiles$reports$1.INSTANCE);
