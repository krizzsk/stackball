...
public class UnityReflection {
    ...
    public static Activity GetUnityActivity() {
        try {
            ...
            Activity activity = (Activity) unityPlayer.getField("currentActivity").get((Object) null);
            if (activity == null) {
                Log.d(C2305FB.TAG, "Current unity activity is null");
            }
            return activity;
        } catch (Exception e) {
            Log.d(C2305FB.TAG, e.toString());
            return null;
        }
    }
}
