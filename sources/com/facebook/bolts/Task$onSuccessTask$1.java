...
final class Task$onSuccessTask$1<TTaskResult, TContinuationResult> implements Continuation {
    final /* synthetic */ Continuation $continuation;
    final /* synthetic */ CancellationToken $ct;

    Task$onSuccessTask$1(CancellationToken cancellationToken, Continuation continuation) {
    ...
    public final Task<TContinuationResult> then(Task<TResult> task) {
        ...
        return task.continueWithTask(this.$continuation);
    }
}
