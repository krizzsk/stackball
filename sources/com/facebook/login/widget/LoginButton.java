...
import com.facebook.login.C2181R;
...
public class LoginButton extends FacebookButtonBase {
    ...
    static /* synthetic */ class C21913 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.login.widget.LoginButton.C21913.<clinit>():void");
        }
    }
    ...
    private void checkToolTipSettings() {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                int i = C21913.$SwitchMap$com$facebook$login$widget$LoginButton$ToolTipMode[this.toolTipMode.ordinal()];
                if (i == 1) {
                    ...
                    displayToolTip(getResources().getString(C2181R.string.com_facebook_tooltip_default));
                }
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
            }
    ...
    public void configureButton(Context context, AttributeSet attributeSet, int i, int i2) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (isInEditMode()) {
                    setBackgroundColor(getResources().getColor(C2100R.color.com_facebook_blue));
                ...
                setButtonText();
                setCompoundDrawablesWithIntrinsicBounds(AppCompatResources.getDrawable(getContext(), C2100R.C2101drawable.com_facebook_button_icon), (Drawable) null, (Drawable) null, (Drawable) null);
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
            }
        }
    ...
    public int getDefaultStyleResource() {
        return C2181R.style.com_facebook_loginview_default_style;
    }
    ...
    private void parseLoginButtonAttributes(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C2181R.styleable.com_facebook_login_view, i, i2);
                this.confirmLogout = obtainStyledAttributes.getBoolean(C2181R.styleable.com_facebook_login_view_com_facebook_confirm_logout, true);
                this.loginText = obtainStyledAttributes.getString(C2181R.styleable.com_facebook_login_view_com_facebook_login_text);
                this.logoutText = obtainStyledAttributes.getString(C2181R.styleable.com_facebook_login_view_com_facebook_logout_text);
                this.toolTipMode = ToolTipMode.fromInt(obtainStyledAttributes.getInt(C2181R.styleable.com_facebook_login_view_com_facebook_tooltip_mode, ToolTipMode.DEFAULT.getValue()));
    ...
    public void onMeasure(int i, int i2) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (str == null) {
                    str = resources.getString(C2181R.string.com_facebook_loginview_log_in_button_continue);
                    int measureButtonWidth = measureButtonWidth(str);
                    if (resolveSize(measureButtonWidth, i) < measureButtonWidth) {
                        str = resources.getString(C2181R.string.com_facebook_loginview_log_in_button);
                    }
                }
                int measureButtonWidth2 = measureButtonWidth(str);
                String str2 = this.logoutText;
                if (str2 == null) {
                    str2 = resources.getString(C2181R.string.com_facebook_loginview_log_out_button);
                }
            ...
            try {
                ...
                if (!isInEditMode() && AccessToken.isCurrentAccessTokenActive()) {
                    if (this.logoutText != null) {
                        ...
                        str = resources.getString(C2181R.string.com_facebook_loginview_log_out_button);
                    }
                    setText(str);
                } else if (this.loginText != null) {
                    setText(this.loginText);
                } else {
                    String string = resources.getString(C2181R.string.com_facebook_loginview_log_in_button_continue);
                    int width = getWidth();
                    if (width != 0 && measureButtonWidth(string) > width) {
                        string = resources.getString(C2181R.string.com_facebook_loginview_log_in_button);
                    }
                    setText(string);
                }
            } catch (Throwable th) {
            ...
            if (!CrashShieldHandler.isObjectCrashing(this)) {
                try {
                    ...
                    if (LoginButton.this.confirmLogout) {
                        String string = LoginButton.this.getResources().getString(C2181R.string.com_facebook_loginview_log_out_action);
                        String string2 = LoginButton.this.getResources().getString(C2181R.string.com_facebook_loginview_cancel_action);
                        Profile currentProfile = Profile.getCurrentProfile();
                        if (currentProfile == null || currentProfile.getName() == null) {
                            str = LoginButton.this.getResources().getString(C2181R.string.com_facebook_loginview_logged_in_using_facebook);
                        } else {
                            str = String.format(LoginButton.this.getResources().getString(C2181R.string.com_facebook_loginview_logged_in_as), new Object[]{currentProfile.getName()});
                        }
