...
public class ProfilePictureView extends FrameLayout {
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C2181R.styleable.com_facebook_profile_picture_view);
                setPresetSize(obtainStyledAttributes.getInt(C2181R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
                this.isCropped = obtainStyledAttributes.getBoolean(C2181R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
        ...
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (this.customizedDefaultProfilePicture == null) {
                    setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C2181R.C2182drawable.com_facebook_profile_picture_blank_square : C2181R.C2182drawable.com_facebook_profile_picture_blank_portrait));
                    return;
                }
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        try {
            ...
            if (i2 == -4) {
                i = C2181R.dimen.com_facebook_profilepictureview_preset_size_large;
            } else if (i2 == -3) {
                i = C2181R.dimen.com_facebook_profilepictureview_preset_size_normal;
            } else if (i2 == -2) {
                i = C2181R.dimen.com_facebook_profilepictureview_preset_size_small;
            } else if (i2 != -1 || !z) {
                return 0;
            } else {
                i = C2181R.dimen.com_facebook_profilepictureview_preset_size_normal;
