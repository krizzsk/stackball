...
public final class AppEventsLoggerImpl {
    ...
    public static final class Companion {
        ...
        public final void initializeLib(Context context, String str) {
            ...
            if (FacebookSdk.getAutoLogAppEventsEnabled()) {
                ...
                if (access$getBackgroundExecutor$cp != null) {
                    access$getBackgroundExecutor$cp.execute(new AppEventsLoggerImpl$Companion$initializeLib$1(context, appEventsLoggerImpl));
                    return;
                }
                throw new IllegalStateException("Required value was null.".toString());
            }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x0019, code lost:
            r2 = com.facebook.appevents.C2063x4b070522.INSTANCE;
            r1 = com.facebook.appevents.AppEventsLoggerImpl.access$getBackgroundExecutor$cp();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0022, code lost:
            if (r1 == null) goto L_0x0030;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:12:0x0024, code lost:
            r1.scheduleAtFixedRate(r2, 0, (long) com.facebook.appevents.AppEventsLoggerImpl.APP_SUPPORTS_ATTRIBUTION_ID_RECHECK_PERIOD_IN_SECONDS, java.util.concurrent.TimeUnit.SECONDS);
         */
        ...
        public final void initializeTimersIfNeeded() {
            /*
                ...
                monitor-enter(r0)
                java.util.concurrent.ScheduledThreadPoolExecutor r1 = com.facebook.appevents.AppEventsLoggerImpl.access$getBackgroundExecutor$cp()     // Catch:{ all -> 0x003e }
                if (r1 == 0) goto L_0x000d
                monitor-exit(r0)
                return
            L_0x000d:
                java.util.concurrent.ScheduledThreadPoolExecutor r1 = new java.util.concurrent.ScheduledThreadPoolExecutor     // Catch:{ all -> 0x003e }
                r2 = 1
                r1.<init>(r2)     // Catch:{ all -> 0x003e }
                com.facebook.appevents.AppEventsLoggerImpl.access$setBackgroundExecutor$cp(r1)     // Catch:{ all -> 0x003e }
                kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003e }
                monitor-exit(r0)
                com.facebook.appevents.AppEventsLoggerImpl$Companion$initializeTimersIfNeeded$attributionRecheckRunnable$1 r0 = com.facebook.appevents.C2063x4b070522.INSTANCE
                r2 = r0
