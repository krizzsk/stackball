...
public class C1551m {
    /* renamed from: a */
    public static String m3531a(String str, String str2) {
        return m3534a(str, str2, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    public static String m3532a(String str, String str2, long j) {
        return m3533a(str, str2, j, new byte[]{-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77});
    }

    /* renamed from: a */
    private static String m3533a(String str, String str2, long j, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    byte[] a = m3537a(substring2, bArr2);
                    ...
                    String b = m3539b(byteArrayOutputStream.toByteArray());
                    String a2 = m3535a(bArr);
    ...
    /* renamed from: a */
    private static String m3534a(String str, String str2, byte[] bArr) {
        String str3 = str;
        String str4 = str2;
        byte[] bArr2 = bArr;
        if (str4 == null) {
            ...
            if (bArr2.length < 32) {
                ...
                try {
                    ...
                    String str5 = split[1];
                    String str6 = split[2];
                    byte[] a = m3536a(split[3]);
                    if (!str4.endsWith(str6)) {
                        return null;
                    }
                    if (!m3535a(bArr).equals(str5)) {
                        return null;
                    }
                    byte[] a2 = m3537a(str4.substring(0, 32), bArr2);
    ...
    /* renamed from: a */
    private static String m3535a(byte[] bArr) {
        try {
            MessageDigest instance = MessageDigest.getInstance("SHA-1");
            instance.update(bArr);
            return C1553o.m3551a(instance.digest());
    ...
    /* renamed from: a */
    private static byte[] m3536a(String str) {
        return Base64.decode(m3538b(str), 0);
    }

    /* renamed from: a */
    private static byte[] m3537a(String str, byte[] bArr) {
        try {
    ...
    /* renamed from: b */
    private static String m3538b(String str) {
        return str.replace('-', '+').replace('_', '/').replace('*', '=');
    }

    /* renamed from: b */
    private static String m3539b(byte[] bArr) throws UnsupportedEncodingException {
        return m3540c(Base64.encode(bArr, 2));
    }

    /* renamed from: c */
    private static String m3540c(byte[] bArr) throws UnsupportedEncodingException {
