...
public final class C9323gk {
    ...
    public final boolean mo58214a(java.lang.String r20, int r21) {
        /*
            r19 = this;
            r1 = r19
            r0 = 0
            ...
            long r7 = r7 + r9
            r0 = 24
            long r13 = m24998b(r5, r0)     // Catch:{ Exception -> 0x00da, all -> 0x00d6 }
            r0 = 32
            long r15 = m24998b(r5, r0)     // Catch:{ Exception -> 0x00da, all -> 0x00d6 }
            long r4 = m24998b(r5, r12)     // Catch:{ Exception -> 0x00da, all -> 0x00d6 }
            long r17 = r4 - r15
            long r9 = r9 - r17
            long r15 = r15 - r13
            long r4 = r4 - r7
            ...
            long r7 = r7 + r15
            r4 = r19
            r4.f23068a = r7     // Catch:{ Exception -> 0x00f4, all -> 0x00d4 }
            r4.f23069b = r2     // Catch:{ Exception -> 0x00f4, all -> 0x00d4 }
            r4.f23070c = r9     // Catch:{ Exception -> 0x00f4, all -> 0x00d4 }
            r1.close()
            r0 = 1
            return r0
        L_0x00d4:
        ...
        L_0x0104:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tapjoy.internal.C9323gk.mo58214a(java.lang.String, int):boolean");
    }

    /* renamed from: a */
    private static long m24997a(byte[] bArr, int i) {
        byte b = bArr[i];
        byte b2 = bArr[i + 1];
        byte b3 = bArr[i + 2];
        byte b4 = bArr[i + 3];
    ...
    /* renamed from: b */
    private static long m24998b(byte[] bArr, int i) {
        return ((m24997a(bArr, i) - 2208988800L) * 1000) + ((m24997a(bArr, i + 4) * 1000) / 4294967296L);
    }
}
