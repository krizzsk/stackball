...
public class SamsungReferrer extends ContentProviderReferrer {
    ...
    public void start(Context context) {
        C17712 r0 = new ContentFetcher<Map<String, Object>>(context, "com.sec.android.app.samsungapps.referrer", "FBA3AF4E7757D9016E953FB3EE4671CA2BD9AF725F9A53D52ED4A38EAAA08901") {
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:23:0x00d2, code lost:
                ...
                r10.f4245.map.put(com.appsflyer.internal.referrer.Payload.API, java.lang.Long.valueOf(com.appsflyer.AndroidUtils.getVersionCode(r10.context, r0)));
                r10.f4245.map.put(com.appsflyer.internal.referrer.Payload.API_NAME, com.appsflyer.AndroidUtils.getVersionName(r10.context, r0));
                r10.f4245.finish();
             */
            /* JADX WARNING: Code restructure failed: missing block: B:24:0x010d, code lost:
                return r10.f4245.map;
             */
            /* renamed from: ι */
            ...
            public java.util.Map<java.lang.String, java.lang.Object> query() {
                /*
                    ...
                    m3902(r3, r4, r2)     // Catch:{ Exception -> 0x00c2 }
                    java.lang.String r3 = "click_ts"
                    com.appsflyer.internal.referrer.SamsungReferrer r4 = com.appsflyer.internal.referrer.SamsungReferrer.this     // Catch:{ Exception -> 0x00c2 }
                    java.util.Map<java.lang.String, java.lang.Object> r4 = r4.map     // Catch:{ Exception -> 0x00c2 }
                    m3901(r3, r4, r2)     // Catch:{ Exception -> 0x00c2 }
                ...
                L_0x0113:
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.referrer.SamsungReferrer.C17712.query():java.util.Map");
            }

            /* renamed from: ı */
            private static void m3901(String str, Map<String, Object> map, Cursor cursor) {
            ...
            /* renamed from: ǃ */
            private static void m3902(String str, Map<String, Object> map, Cursor cursor) {
                String string;
                int columnIndex = cursor.getColumnIndex(str);
