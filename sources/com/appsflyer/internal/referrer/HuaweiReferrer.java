...
public class HuaweiReferrer extends ContentProviderReferrer {
    ...
    public void start(Context context) {
        C17691 r0 = new ContentFetcher<Map<String, Object>>(context, "com.huawei.appmarket.commondata", "FFE391E0EA186D0734ED601E4E70E3224B7309D48E2075BAC46D8C667EAE7212", "3BAF59A2E5331C30675FAB35FF5FFF0D116142D3D4664F1C3CB804068B40614F") {
            /* access modifiers changed from: private */
            /* JADX WARNING: Code restructure failed: missing block: B:14:0x00f8, code lost:
                if (r2 != null) goto L_0x010a;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:19:0x0108, code lost:
            ...
            /* JADX WARNING: Code restructure failed: missing block: B:21:0x010d, code lost:
                r11.f4238.finish();
             */
            /* JADX WARNING: Code restructure failed: missing block: B:22:0x0116, code lost:
                return r11.f4238.map;
             */
            /* renamed from: ɩ */
            ...
            public java.util.Map<java.lang.String, java.lang.Object> query() {
                /*
                    ...
                    r3.put(r4, r2)
                    r2 = 0
                    android.content.Context r3 = r11.context     // Catch:{ Exception -> 0x00fd }
                    ...
                    java.lang.String r5 = r11.authority     // Catch:{ Exception -> 0x00fd }
                    ...
                    android.content.Context r9 = r11.context     // Catch:{ Exception -> 0x00fd }
                    ...
                    com.appsflyer.internal.referrer.HuaweiReferrer r4 = com.appsflyer.internal.referrer.HuaweiReferrer.this     // Catch:{ Exception -> 0x00fd }
                    java.util.Map<java.lang.String, java.lang.Object> r4 = r4.map     // Catch:{ Exception -> 0x00fd }
                    ...
                    com.appsflyer.internal.referrer.HuaweiReferrer r3 = com.appsflyer.internal.referrer.HuaweiReferrer.this     // Catch:{ Exception -> 0x00fd }
                    java.util.Map<java.lang.String, java.lang.Object> r3 = r3.map     // Catch:{ Exception -> 0x00fd }
                ...
                L_0x00fd:
                    r3 = move-exception
                    com.appsflyer.internal.referrer.HuaweiReferrer r4 = com.appsflyer.internal.referrer.HuaweiReferrer.this     // Catch:{ all -> 0x00fb }
                    java.util.Map<java.lang.String, java.lang.Object> r4 = r4.map     // Catch:{ all -> 0x00fb }
                    r4.put(r1, r0)     // Catch:{ all -> 0x00fb }
                    r11.onError(r3)     // Catch:{ all -> 0x00fb }
                    if (r2 == 0) goto L_0x010d
                L_0x010a:
                    r2.close()
                L_0x010d:
                ...
                L_0x011c:
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.appsflyer.internal.referrer.HuaweiReferrer.C17691.query():java.util.Map");
            }
        };
