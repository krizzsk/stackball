...
public class DeepLinkCallbacks {
    public static void onDeepLinkingError(String str) {
        if (AFDeepLinkManager.getInstance().deepLinkListener != null) {
            ...
            m3829(new DeepLinkResult((DeepLink) null, DeepLinkResult.Error.NETWORK));
    ...
    public static void onDeepLinkingSuccess(Map<String, String> map) {
        ...
        if (AFDeepLinkManager.getInstance().deepLinkListener != null) {
            try {
                DeepLink r4 = DeepLink.m3828(map);
                r4.f4107.put("is_deferred", false);
                deepLinkResult = new DeepLinkResult(r4, (DeepLinkResult.Error) null);
                ...
                m3829(new DeepLinkResult((DeepLink) null, (DeepLinkResult.Error) null));
                throw th;
            }
            m3829(deepLinkResult);
            return;
        }
    ...
    /* renamed from: ɩ */
    static void m3829(DeepLinkResult deepLinkResult) {
        if (AFDeepLinkManager.getInstance().deepLinkListener != null) {
