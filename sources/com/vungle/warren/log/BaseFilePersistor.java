...
class BaseFilePersistor {
    ...
    public boolean appendLineToFile(java.io.File r5, java.lang.String r6, com.vungle.warren.log.BaseFilePersistor.FileSaveCallback r7) {
        /*
            ...
            int r0 = r4.getLineCount(r5)     // Catch:{ IOException -> 0x0025, all -> 0x0022 }
            if (r0 <= 0) goto L_0x0012
            java.lang.String r3 = "\n"
            r1.append(r3)     // Catch:{ IOException -> 0x0025, all -> 0x0022 }
        L_0x0012:
            r1.append(r6)     // Catch:{ IOException -> 0x0025, all -> 0x0022 }
            r1.flush()     // Catch:{ IOException -> 0x0025, all -> 0x0022 }
