...
import com.vungle.warren.p261ui.view.MediaView;
...
public class NativeAd {
    ...
    public NativeAd(Context context2, String str) {
        ...
        instance.init(executors.getIOExecutor());
        this.adState = 1;
    }
    ...
    public void loadAd(AdConfig adConfig2, String str, NativeAdListener nativeAdListener) {
        ...
        Vungle.loadAdInternal(this.placementId, str, adConfig2, this.loadAdCallback);
    }
