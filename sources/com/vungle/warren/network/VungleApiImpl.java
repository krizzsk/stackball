...
public class VungleApiImpl implements VungleApi {
    ...
    /* renamed from: ri */
    public Call<JsonObject> mo60341ri(String str, String str2, JsonObject jsonObject) {
        return createNewPostCall(str, str2, jsonObject);
    }
    ...
    private Request.Builder defaultBuilder(String str, String str2) {
        Request.Builder addHeader = new Request.Builder().url(str2).addHeader("User-Agent", str).addHeader("Vungle-Version", "5.10.0").addHeader("Content-Type", WebRequest.CONTENT_TYPE_JSON);
