...
public class CacheBustJob implements Job {
    ...
    private void sendAnalytics() {
        ...
        L_0x003b:
            ...
            return
        L_0x0049:
            com.vungle.warren.VungleApiClient r0 = r8.client     // Catch:{ IOException -> 0x00a3 }
        ...
        L_0x005d:
            ...
            com.vungle.warren.persistence.Repository r2 = r8.repository     // Catch:{ DBException -> 0x006f }
