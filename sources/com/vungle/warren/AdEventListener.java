    ...
    public void onNext(String str, String str2, String str3) {
        ...
        try {
            ...
            if (str.equals("start")) {
                ...
                Placement placement2 = this.repository.load(this.request.getPlacementId(), Placement.class).get();
                this.placement = placement2;
                if (placement2 != null) {
                    this.adLoader.loadEndlessIfNeeded(placement2, placement2.getAdSize(), 0, this.request.getIsExplicit());
                }
                ...
                } else if ("attach".equals(str) && this.playAdCallback != null) {
