...
/* renamed from: com.vungle.warren.ui.presenter.NativeAdPresenter */
public class NativeAdPresenter implements NativeAdContract.NativePresenter {
    ...
    public void onDownload() {
        ...
        L_0x009a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vungle.warren.p261ui.presenter.NativeAdPresenter.onDownload():void");
    }
    ...
    public void attach(NativeAdContract.NativeView nativeView, OptionsState optionsState) {
        ...
        String str2 = TAG;
        Log.d(str2, "Requested Orientation " + i2);
    ...
    public void stop(int i) {
        String str = TAG;
        Log.d(str, "stop() " + this.placement + " " + hashCode());
        this.durationRecorder.stop();
        boolean z = false;
        boolean z2 = (i & 1) != 0;
        boolean z3 = (i & 2) != 0;
        ...
        if (!z2 && z3 && !this.isDestroying.getAndSet(true)) {
            ...
            if (eventListener != null) {
                ...
                eventListener.onNext("end", str2, this.placement.getId());
            }
        }
    }
    ...
    public void onProgressUpdate(int i, float f) {
        ...
        reportAction("videoLength", String.format(Locale.ENGLISH, "%d", new Object[]{5000}));
    ...
    private void showGDPR(final Cookie cookie) {
        C99723 r5 = new DialogInterface.OnClickListener() {
