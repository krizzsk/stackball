...
import com.vungle.warren.p261ui.presenter.MRAIDAdPresenter;
...
import com.vungle.warren.p261ui.view.LocalAdView;
import com.vungle.warren.p261ui.view.MRAIDAdView;
import com.vungle.warren.p261ui.view.NativeAdView;
...
public class AdvertisementPresentationFactory implements PresentationFactory {
    ...
    public void getFullScreenPresentation(Context context, AdRequest adRequest, FullAdWidget fullAdWidget, OptionsState optionsState, CloseDelegate closeDelegate, OrientationDelegate orientationDelegate, Bundle bundle, PresentationFactory.FullScreenCallback fullScreenCallback) {
        ...
        fullScreenPresentationTask3.executeOnExecutor(this.taskExecutor, new Void[0]);
    }
    ...
    public void getBannerViewPresentation(Context context, AdRequest adRequest, AdConfig adConfig, CloseDelegate closeDelegate, PresentationFactory.ViewCallback viewCallback) {
        cancelTask();
        BannerViewPresentationTask bannerViewPresentationTask = new BannerViewPresentationTask(context, adRequest, adConfig, this.adLoader, this.repository, this.vungleStaticApi, this.jobRunner, viewCallback, (Bundle) null, this.onModelLoadListener, this.apiClient, this.omTrackerFactory);
    ...
    public void getNativeViewPresentation(Context context, NativeAdLayout nativeAdLayout, AdRequest adRequest, AdConfig adConfig, PresentationFactory.NativeViewCallback nativeViewCallback) {
        cancelTask();
        NativeViewPresentationTask nativeViewPresentationTask = new NativeViewPresentationTask(context, nativeAdLayout, adRequest, adConfig, this.adLoader, this.repository, this.vungleStaticApi, this.jobRunner, nativeViewCallback, (Bundle) null, this.onModelLoadListener);
