...
public final class C5532k {
    ...
    /* renamed from: a */
    public static final ArrayList<String> f12747a = new ArrayList<>(Arrays.asList(new String[]{"applicationUserAgeGroup", "uAge", "advId", "appKey", "mCar", "medV", "connT", "dWidth", "dHeight", "dModel", "cTime", "sDepRV", "sDepIS", "sId", "plType", "dOSV", "dOSVF", "dOS", "dMake", "dAPI", "bId", "appV", "usId", "bat", "root", "diskFS", "dLang", "MD", "uGen", "advType", "isLAT", "dVol", "consent", "dHeight", "dWidth", "dScrenScle", "auid", "UA"}));

    /* renamed from: b */
    public static final HashMap<String, String> f12748b = new HashMap<String, String>() {
        {
            ...
            put(ServerParameters.DEVICE_CURRENT_BATTERY_LEVEL, "bat");
            put("unLocked", "root");
