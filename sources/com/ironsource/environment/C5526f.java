...
public final class C5526f extends SQLiteOpenHelper {
    public C5526f(Context context) {
    ...
    public static android.database.Cursor m13124a(int r4) {
        /*
            com.ironsource.environment.f r0 = new com.ironsource.environment.f
            com.ironsource.environment.e r1 = com.ironsource.environment.C5521e.m13114a()
            android.content.Context r1 = r1.f12729a
            r0.<init>(r1)
            r1 = 0
        ...
        L_0x0036:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.environment.C5526f.m13124a(int):android.database.Cursor");
    }

    /* JADX WARNING: Removed duplicated region for block: B:16:0x0052  */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.util.List<com.ironsource.environment.C5517c> m13125a() {
        /*
            com.ironsource.environment.f r0 = new com.ironsource.environment.f
            com.ironsource.environment.e r1 = com.ironsource.environment.C5521e.m13114a()
            android.content.Context r1 = r1.f12729a
        ...
        L_0x0055:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.environment.C5526f.m13125a():java.util.List");
    }

    /* JADX WARNING: Removed duplicated region for block: B:11:0x004a  */
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m13126a(com.ironsource.environment.C5517c r6) {
        /*
            com.ironsource.environment.f r0 = new com.ironsource.environment.f
            com.ironsource.environment.e r1 = com.ironsource.environment.C5521e.m13114a()
            android.content.Context r1 = r1.f12729a
            ...
            java.lang.String r3 = r6.mo41240a()     // Catch:{ all -> 0x0044 }
            java.lang.String r4 = r6.mo41241b()     // Catch:{ all -> 0x0044 }
            java.lang.String r6 = r6.mo41242c()     // Catch:{ all -> 0x0044 }
        ...
        L_0x0050:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.environment.C5526f.m13126a(com.ironsource.environment.c):void");
    }

    /* JADX WARNING: Removed duplicated region for block: B:12:0x0027  */
    /* renamed from: b */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.database.Cursor m13127b() {
        /*
            com.ironsource.environment.f r0 = new com.ironsource.environment.f
            com.ironsource.environment.e r1 = com.ironsource.environment.C5521e.m13114a()
            android.content.Context r1 = r1.f12729a
        ...
        L_0x002a:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.environment.C5526f.m13127b():android.database.Cursor");
    }

    /* JADX WARNING: Removed duplicated region for block: B:12:0x0020  */
    /* renamed from: c */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static void m13128c() {
        /*
            com.ironsource.environment.f r0 = new com.ironsource.environment.f
            com.ironsource.environment.e r1 = com.ironsource.environment.C5521e.m13114a()
            android.content.Context r1 = r1.f12729a
        ...
        L_0x0023:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.environment.C5526f.m13128c():void");
    }
