...
public class IronSourceStorageUtils {
    ...
    /* renamed from: a */
    private static C6022e f14833a;

    /* renamed from: a */
    private static void m14950a(File file) {
        if (file != null) {
            deleteFolder(m14951b(file).getPath());
        }
    }

    /* renamed from: b */
    private static File m14951b(File file) {
    ...
    public static JSONObject buildFilesMapOfDirectory(C6020c cVar, JSONObject jSONObject) {
        ...
        for (File path : listFiles) {
            C6020c cVar2 = new C6020c(path.getPath());
            if (cVar2.isFile()) {
                str = cVar2.getName();
                jSONObject2 = cVar2.mo42568a();
    ...
    /* renamed from: c */
    private static Object m14952c(File file) {
        JSONObject jSONObject = new JSONObject();
        ...
        try {
            ...
            for (File file2 : file.listFiles()) {
                if (file2.isDirectory()) {
                    jSONObject.put(file2.getName(), m14952c(file2));
                } else {
    ...
    public static void deleteCacheDirectories(Context context) {
        m14950a(C5527g.m13173s(context));
        m14950a(C5527g.m13176u(context));
    }

    public static synchronized boolean deleteFile(C6020c cVar) {
    ...
    public static void deleteFilesDirectories(Context context) {
        m14950a(C5527g.m13175t(context));
        m14950a(C5527g.m13177v(context));
    }
    ...
    public static String getDiskCacheDirPath(Context context) {
        if (SDKUtils.isExternalStorageAvailable()) {
            C6022e eVar = f14833a;
            File t = (eVar == null || !eVar.mo42575a()) ? C5527g.m13175t(context) : C5527g.m13173s(context);
            if (t != null && t.canWrite()) {
                return t.getPath();
            }
        }
        C6022e eVar2 = f14833a;
        return ((eVar2 == null || !eVar2.mo42575a()) ? C5527g.m13177v(context) : C5527g.m13176u(context)).getPath();
    }

    public static ArrayList<C6020c> getFilesInFolderRecursive(C6020c cVar) {
        if (cVar == null || !cVar.isDirectory()) {
            return new ArrayList<>();
        }
        ArrayList<C6020c> arrayList = new ArrayList<>();
        File[] listFiles = cVar.listFiles();
        if (listFiles != null) {
            for (File path : listFiles) {
                C6020c cVar2 = new C6020c(path.getPath());
    ...
    public static String getNetworkStorageDir(Context context) {
        File b = m14951b(new File(getDiskCacheDirPath(context)));
        if (!b.exists()) {
            b.mkdir();
        }
        return b.getPath();
    ...
    public static long getTotalSizeOfDir(C6020c cVar) {
        long totalSizeOfDir;
        long j = 0;
        if (cVar != null && cVar.isDirectory()) {
            File[] listFiles = cVar.listFiles();
    ...
    public static void initializeCacheDirectory(Context context, C6022e eVar) {
        f14833a = eVar;
        if (eVar != null && eVar.f14788a.optBoolean("deleteCacheDir", false)) {
            deleteCacheDirectories(context);
        }
        C6022e eVar2 = f14833a;
        if (eVar2 != null && eVar2.f14788a.optBoolean("deleteFilesDir", false)) {
    ...
    public static String readFile(C6020c cVar) {
