...
public class ServerURL {
    ...
    public static String getCPVProvidersURL(Context context, String str, String str2, String str3, String str4, Vector<Pair<String, String>> vector) {
        ...
        String c = C5517c.m13106c(context, context.getPackageName());
        ...
        ConcurrentHashMap<String, List<String>> d = C5790c.m14278a().mo42115d();
        ...
        String r = C5527g.m13171r();
        if (r.length() != 0) {
            vector2.add(new Pair(BROWSER_USER_AGENT, r));
        }
        String str5 = null;
        try {
            str5 = C5527g.m13138b(context) + "-" + C5527g.m13141c(context);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        if (context != null) {
            ...
            sb3.append(C5505a.C55061.m13080c(context));
            vector2.add(new Pair(MOBILE_COUNTRY_CODE, sb3.toString()));
            StringBuilder sb4 = new StringBuilder();
            sb4.append(C5505a.C55061.m13083d(context));
        ...
        String c2 = C5527g.m13140c();
        if (!TextUtils.isEmpty(c2)) {
            vector2.add(new Pair(TIME_ZONE_ID, c2));
        }
        StringBuilder sb5 = new StringBuilder();
        sb5.append(C5527g.m13137b());
        vector2.add(new Pair(TIME_ZONE_OFFSET, sb5.toString()));
        String z = C5527g.m13181z(context);
        if (!TextUtils.isEmpty(z)) {
            vector2.add(new Pair(AUID, z));
        }
        String createURLParams = createURLParams(vector2);
        IronLog.INTERNAL.info("parameters for url: " + createURLParams);
        return getBaseUrl(IronSourceUtils.getSDKVersion()) + URLEncoder.encode(IronSourceAES.encode(C5797g.m14321a().mo42123b(), createURLParams), "UTF-8");
    }
