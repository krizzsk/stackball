...
public class HttpFunctions {
    ...
    /* renamed from: a */
    private static final ExecutorService f13874a = Executors.newSingleThreadExecutor();

    public static String getStringFromURL(String str) {
        return getStringFromURL(str, (C5556E.C5558a) null);
    }
    ...
    public static java.lang.String getStringFromURL(java.lang.String r4, com.ironsource.mediationsdk.C5556E.C5558a r5) {
        /*
            r0 = 0
            java.net.URL r1 = new java.net.URL     // Catch:{ Exception -> 0x008a, all -> 0x007d }
            r1.<init>(r4)     // Catch:{ Exception -> 0x008a, all -> 0x007d }
            java.net.URLConnection r4 = r1.openConnection()     // Catch:{ Exception -> 0x008a, all -> 0x007d }
            java.net.HttpURLConnection r4 = (java.net.HttpURLConnection) r4     // Catch:{ Exception -> 0x008a, all -> 0x007d }
            ...
            r5.mo41396a(r1)     // Catch:{ Exception -> 0x007b, all -> 0x0076 }
        L_0x002f:
    ...
    public static void sendPostRequest(String str, String str2, C5781a aVar) {
        sendPostRequestWithAutho(str, str2, (String) null, (String) null, aVar);
    }

    public static void sendPostRequestWithAutho(String str, String str2, String str3, String str4, C5781a aVar) {
        final String str5 = str;
        final String str6 = str3;
        final String str7 = str4;
        final String str8 = str2;
        final C5781a aVar2 = aVar;
        f13874a.submit(new Runnable() {
            ...
            public final void run() {
                ...
                L_0x0077:
                    ...
                    r4.mo41878a(r3)     // Catch:{ Exception -> 0x008c }
                ...
                L_0x0094:
                    ...
                    r3.mo41878a(r0)     // Catch:{ all -> 0x00c3 }
                ...
                L_0x00d3:
                    throw r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.ironsource.mediationsdk.server.HttpFunctions.C57801.run():void");
            }
        });
    }
}
