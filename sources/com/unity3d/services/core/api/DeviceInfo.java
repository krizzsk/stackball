...
public class DeviceInfo {
    ...
    public static void registerVolumeChangeListener(final Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C97271 r0 = new IVolumeChangeListener() {
    ...
    static /* synthetic */ class C97282 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C97282.<clinit>():void");
        }
    }

    private static File getFileForStorageType(StorageType storageType) {
        int i = C97282.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i == 1) {
