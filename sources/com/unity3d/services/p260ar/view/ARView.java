...
import com.unity3d.services.p260ar.AREvent;
import com.unity3d.services.p260ar.ARUtils;
import com.unity3d.services.p260ar.view.GLSurfaceView;
...
public class ARView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private static void matrix4x4ToQuaternion(float[] fArr, float[] fArr2) {
        ...
        double d = (double) f;
        fArr2[0] = (float) (((double) fArr2[0]) * (0.5d / Math.sqrt(d)));
        fArr2[1] = (float) (((double) fArr2[1]) * (0.5d / Math.sqrt(d)));
        fArr2[2] = (float) (((double) fArr2[2]) * (0.5d / Math.sqrt(d)));
        fArr2[3] = (float) (((double) fArr2[3]) * (0.5d / Math.sqrt(d)));
    }
