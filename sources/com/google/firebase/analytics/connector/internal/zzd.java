...
public final class zzd {
    ...
    private static final List<String> zzc = Arrays.asList(new String[]{TtmlNode.TEXT_EMPHASIS_AUTO, TapjoyConstants.TJC_APP_PLACEMENT, "am"});
    ...
    public static AnalyticsConnector.ConditionalUserProperty zza(Bundle bundle) {
        ...
        conditionalUserProperty.name = (String) zzgz.zza(bundle, "name", String.class, null);
