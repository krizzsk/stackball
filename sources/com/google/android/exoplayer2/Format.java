...
public final class Format implements Parcelable {
    ...
    public static final class Builder {
        ...
        public Builder setId(int i) {
            this.f10039id = Integer.toString(i);
            return this;
        }
    ...
    private Format(Builder builder) {
        this.f10038id = builder.f10039id;
    ...
    public String toString() {
        return "Format(" + this.f10038id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
