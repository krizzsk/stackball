...
final class TtmlNode {
    ...
    private void traverseForStyle(long j, Map<String, TtmlStyle> map, Map<String, TtmlRegion> map2, String str, Map<String, Cue.Builder> map3) {
        ...
        if (isActive(j)) {
            ...
            while (true) {
                ...
                int intValue = this.nodeStartsByRegion.containsKey(str3) ? this.nodeStartsByRegion.get(str3).intValue() : 0;
                int intValue2 = ((Integer) next.getValue()).intValue();
                if (intValue != intValue2) {
                    applyStyleToOutput(map, (Cue.Builder) Assertions.checkNotNull(map3.get(str3)), intValue, intValue2, ((TtmlRegion) Assertions.checkNotNull(map2.get(str2))).verticalType);
                } else {
    ...
    private void applyStyleToOutput(Map<String, TtmlStyle> map, Cue.Builder builder, int i, int i2, int i3) {
        ...
        if (resolveStyle != null) {
            ...
            if (resolveStyle.getShearPercentage() != Float.MAX_VALUE && "p".equals(this.tag)) {
