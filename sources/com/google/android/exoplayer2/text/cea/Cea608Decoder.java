...
public final class Cea608Decoder extends CeaDecoder {
    ...
    private static final int[] SPECIAL_ES_FR_CHARACTER_SET = {193, ErrorCode.DIFFERENT_LINEARITY_EXPECTED_ERROR, 211, 218, 220, 252, 8216, 161, 42, 39, 8212, 169, 8480, 8226, 8220, 8221, 192, 194, 199, 200, ErrorCode.DIFFERENT_DURATION_EXPECTED_ERROR, ErrorCode.DIFFERENT_SIZE_EXPECTED_ERROR, 235, 206, 207, 239, 212, 217, 249, 219, 171, 187};
    private static final int[] SPECIAL_PT_DE_CHARACTER_SET = {195, 227, ErrorCode.INLINE_CATEGORY_VIOLATES_BLOCKED_CATEGORIES_ERROR, 204, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, 223, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    public Cea608Decoder(String str, int i, long j) {
        ...
        if (i == 1) {
            ...
            Log.m9247w(TAG, "Invalid channel. Defaulting to CC1.");
            this.selectedChannel = 0;
            this.selectedField = 0;
        } else {
            this.selectedChannel = 1;
    ...
    private static char getSpecialNorthAmericanChar(byte b) {
        return (char) SPECIAL_CHARACTER_SET[b & Ascii.f10109SI];
    }
    ...
    private static char getExtendedEsFrChar(byte b) {
        return (char) SPECIAL_ES_FR_CHARACTER_SET[b & Ascii.f10112US];
    }

    private static char getExtendedPtDeChar(byte b) {
        return (char) SPECIAL_PT_DE_CHARACTER_SET[b & Ascii.f10112US];
    }
