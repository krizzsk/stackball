...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.durationMs != eventMessage.durationMs || this.f10047id != eventMessage.f10047id || !Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) || !Util.areEqual(this.value, eventMessage.value) || !Arrays.equals(this.messageData, eventMessage.messageData)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f10047id + ", durationMs=" + this.durationMs + ", value=" + this.value;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.f10047id);
