...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(Object obj) {
        ...
        if (!this.f10053id.equals(urlLinkFrame.f10053id) || !Util.areEqual(this.description, urlLinkFrame.description) || !Util.areEqual(this.url, urlLinkFrame.url)) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return this.f10053id + ": url=" + this.url;
    }
