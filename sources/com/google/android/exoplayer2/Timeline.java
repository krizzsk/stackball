...
public abstract class Timeline {
    ...
    public static final class Window {
        ...
        public long getDefaultPositionMs() {
            return C3716C.usToMs(this.defaultPositionUs);
        }
        ...
        public long getDurationMs() {
            return C3716C.usToMs(this.durationUs);
        }
        ...
        public long getPositionInFirstPeriodMs() {
            return C3716C.usToMs(this.positionInFirstPeriodUs);
        }
    ...
    public static final class Period {
        ...
        public long getPositionInWindowMs() {
            return C3716C.usToMs(this.positionInWindowUs);
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (!Util.areEqual(this.f10042id, period.f10042id) || !Util.areEqual(this.uid, period.uid) || this.windowIndex != period.windowIndex || this.durationUs != period.durationUs || this.positionInWindowUs != period.positionInWindowUs || !Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                return false;
            }
            return true;
        }
