...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public void onOutputFormatChanged(Format format, MediaFormat mediaFormat) throws ExoPlaybackException {
        ...
        if (format2 != null) {
            ...
            Format build = new Format.Builder().setSampleMimeType("audio/raw").setPcmEncoding(i).setEncoderDelay(format.encoderDelay).setEncoderPadding(format.encoderPadding).setChannelCount(mediaFormat.getInteger("channel-count")).setSampleRate(mediaFormat.getInteger("sample-rate")).build();
