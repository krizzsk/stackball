...
public final class DefaultAudioSink implements AudioSink {
    ...
    public static class DefaultAudioProcessorChain implements AudioProcessorChain {
        ...
        public DefaultAudioProcessorChain(AudioProcessor[] audioProcessorArr, SilenceSkippingAudioProcessor silenceSkippingAudioProcessor2, SonicAudioProcessor sonicAudioProcessor2) {
            ...
            audioProcessorArr3[audioProcessorArr.length] = silenceSkippingAudioProcessor2;
    ...
    public int getFormatSupport(Format format) {
        ...
        if (!Util.isEncodingLinearPcm(format.pcmEncoding)) {
            Log.m9247w(TAG, "Invalid PCM encoding: " + format.pcmEncoding);
            return 0;
    ...
    public boolean handleBuffer(ByteBuffer byteBuffer, long j, int i) throws AudioSink.InitializationException, AudioSink.WriteException {
        ...
        if (this.inputBuffer == null) {
            ...
            if (!this.startMediaTimeUsNeedsSync && Math.abs(inputFramesToDurationUs - j2) > 200000) {
                Log.m9243e(TAG, "Discontinuity detected [expected " + inputFramesToDurationUs + ", got " + j2 + "]");
                this.startMediaTimeUsNeedsSync = true;
            }
        ...
        if (!this.inputBuffer.hasRemaining()) {
            ...
            Log.m9247w(TAG, "Resetting stalled audio track");
            flush();
            return true;
        }
    }
    ...
    private void setAudioTrackPlaybackParametersV23(PlaybackParameters playbackParameters) {
        if (isAudioTrackInitialized()) {
            try {
                ...
                Log.m9248w(TAG, "Failed to set playback params", e);
            }
    ...
    private void setAudioProcessorPlaybackParametersAndSkipSilence(PlaybackParameters playbackParameters, boolean z) {
        ...
        if (!playbackParameters.equals(mediaPositionParameters2.playbackParameters) || z != mediaPositionParameters2.skipSilence) {
            MediaPositionParameters mediaPositionParameters3 = new MediaPositionParameters(playbackParameters, z, -9223372036854775807L, -9223372036854775807L);
            if (isAudioTrackInitialized()) {
    ...
    private boolean shouldApplyAudioProcessorPlaybackParameters() {
        return !this.tunneling && "audio/raw".equals(this.configuration.inputFormat.sampleMimeType) && !shouldUseFloatOutput(this.configuration.inputFormat.pcmEncoding);
    }
    ...
    private static Pair<Integer, Integer> getEncodingAndChannelConfigForPassthrough(Format format, AudioCapabilities audioCapabilities2) {
        ...
        if (encoding != 18) {
            ...
            Log.m9247w(TAG, "E-AC3 JOC encoding supported but no channel count supported");
            return null;
        }
    ...
    private final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            ...
            if (!DefaultAudioSink.failOnSpuriousAudioTimestamp) {
                Log.m9247w(DefaultAudioSink.TAG, str);
                return;
            }
        ...
        public void onInvalidLatency(long j) {
            Log.m9247w(DefaultAudioSink.TAG, "Ignoring impossibly large audio latency: " + j);
        }
