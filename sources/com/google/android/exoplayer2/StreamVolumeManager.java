...
final class StreamVolumeManager {
    ...
    public StreamVolumeManager(Context context, Handler handler, Listener listener2) {
        ...
        try {
            ...
            Log.m9248w(TAG, "Error registering stream volume receiver", e);
        }
    }
    ...
    public void release() {
        ...
        if (volumeChangeReceiver != null) {
            try {
                ...
                Log.m9248w(TAG, "Error unregistering stream volume receiver", e);
            }
            this.receiver = null;
        }
    }
    ...
    private static int getVolumeFromManager(AudioManager audioManager2, int i) {
        try {
            ...
            Log.m9248w(TAG, "Could not retrieve stream volume for stream type " + i, e);
