    ...
    private static class LegacyStorage implements Storage {
        ...
        private boolean readFile(java.util.HashMap<java.lang.String, com.google.android.exoplayer2.upstream.cache.CachedContent> r11, android.util.SparseArray<java.lang.String> r12) {
            ...
            L_0x0072:
                ...
                int r8 = r7.f10071id     // Catch:{ IOException -> 0x00ae, all -> 0x00ab }
        ...
        private void writeFile(HashMap<String, CachedContent> hashMap) throws IOException {
            ...
            try {
                ...
                DataOutputStream dataOutputStream2 = new DataOutputStream(reusableBufferedOutputStream);
                try {
                    ...
                    if (this.encrypt) {
                        ...
                        dataOutputStream2 = new DataOutputStream(new CipherOutputStream(reusableBufferedOutputStream, this.cipher));
                    }
        ...
        private int hashCachedContent(CachedContent cachedContent, int i) {
            int hashCode = (cachedContent.f10071id * 31) + cachedContent.key.hashCode();
            if (i >= 2) {
        ...
        private void writeCachedContent(CachedContent cachedContent, DataOutputStream dataOutputStream) throws IOException {
            dataOutputStream.writeInt(cachedContent.f10071id);
    ...
    private static final class DatabaseStorage implements Storage {
        ...
        public void load(java.util.HashMap<java.lang.String, com.google.android.exoplayer2.upstream.cache.CachedContent> r8, android.util.SparseArray<java.lang.String> r9) throws java.io.IOException {
            ...
            L_0x000d:
                ...
                com.google.android.exoplayer2.database.DatabaseProvider r0 = r7.databaseProvider     // Catch:{ SQLiteException -> 0x0087 }
                android.database.sqlite.SQLiteDatabase r0 = r0.getReadableDatabase()     // Catch:{ SQLiteException -> 0x0087 }
                java.lang.String r3 = r7.hexUid     // Catch:{ SQLiteException -> 0x0087 }
                java.lang.Object r3 = com.google.android.exoplayer2.util.Assertions.checkNotNull(r3)     // Catch:{ SQLiteException -> 0x0087 }
                java.lang.String r3 = (java.lang.String) r3     // Catch:{ SQLiteException -> 0x0087 }
                int r0 = com.google.android.exoplayer2.database.VersionTable.getVersion(r0, r2, r3)     // Catch:{ SQLiteException -> 0x0087 }
                ...
                r7.initializeTable(r0)     // Catch:{ all -> 0x0037 }
                r0.setTransactionSuccessful()     // Catch:{ all -> 0x0037 }
                r0.endTransaction()     // Catch:{ SQLiteException -> 0x0087 }
                goto L_0x003c
            L_0x0037:
                r1 = move-exception
                r0.endTransaction()     // Catch:{ SQLiteException -> 0x0087 }
                throw r1     // Catch:{ SQLiteException -> 0x0087 }
            L_0x003c:
                android.database.Cursor r0 = r7.getCursor()     // Catch:{ SQLiteException -> 0x0087 }
            L_0x0040:
                boolean r3 = r0.moveToNext()     // Catch:{ all -> 0x0079 }
                if (r3 == 0) goto L_0x0073
                int r3 = r0.getInt(r1)     // Catch:{ all -> 0x0079 }
                java.lang.String r4 = r0.getString(r2)     // Catch:{ all -> 0x0079 }
                r5 = 2
                byte[] r5 = r0.getBlob(r5)     // Catch:{ all -> 0x0079 }
                java.io.ByteArrayInputStream r6 = new java.io.ByteArrayInputStream     // Catch:{ all -> 0x0079 }
                r6.<init>(r5)     // Catch:{ all -> 0x0079 }
                java.io.DataInputStream r5 = new java.io.DataInputStream     // Catch:{ all -> 0x0079 }
                r5.<init>(r6)     // Catch:{ all -> 0x0079 }
                com.google.android.exoplayer2.upstream.cache.DefaultContentMetadata r5 = com.google.android.exoplayer2.upstream.cache.CachedContentIndex.readContentMetadata(r5)     // Catch:{ all -> 0x0079 }
                com.google.android.exoplayer2.upstream.cache.CachedContent r6 = new com.google.android.exoplayer2.upstream.cache.CachedContent     // Catch:{ all -> 0x0079 }
                r6.<init>(r3, r4, r5)     // Catch:{ all -> 0x0079 }
                java.lang.String r3 = r6.key     // Catch:{ all -> 0x0079 }
                r8.put(r3, r6)     // Catch:{ all -> 0x0079 }
                int r3 = r6.f10071id     // Catch:{ all -> 0x0079 }
                java.lang.String r4 = r6.key     // Catch:{ all -> 0x0079 }
                r9.put(r3, r4)     // Catch:{ all -> 0x0079 }
                goto L_0x0040
            L_0x0073:
                if (r0 == 0) goto L_0x0078
                r0.close()     // Catch:{ SQLiteException -> 0x0087 }
            L_0x0078:
                return
            L_0x0079:
                r1 = move-exception
            ...
            L_0x0082:
                r0 = move-exception
                r1.addSuppressed(r0)     // Catch:{ SQLiteException -> 0x0087 }
            L_0x0086:
                throw r2     // Catch:{ SQLiteException -> 0x0087 }
            L_0x0087:
                r0 = move-exception
                r8.clear()
                r9.clear()
        ...
        public void onUpdate(CachedContent cachedContent) {
            this.pendingUpdates.put(cachedContent.f10071id, cachedContent);
        }

        public void onRemove(CachedContent cachedContent, boolean z) {
            if (z) {
                this.pendingUpdates.delete(cachedContent.f10071id);
            } else {
                this.pendingUpdates.put(cachedContent.f10071id, (Object) null);
            }
        }
        ...
        private void addOrUpdateRow(SQLiteDatabase sQLiteDatabase, CachedContent cachedContent) throws IOException {
            ...
            contentValues.put("id", Integer.valueOf(cachedContent.f10071id));
