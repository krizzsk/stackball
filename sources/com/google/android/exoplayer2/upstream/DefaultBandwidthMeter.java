...
public final class DefaultBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_2G = ImmutableList.m9351of(218000L, 159000L, 145000L, 130000L, 112000L);
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_3G = ImmutableList.m9351of(2200000L, 1300000L, 930000L, 730000L, 530000L);
    ...
    public static final ImmutableList<Long> DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI = ImmutableList.m9351of(6100000L, 3800000L, 2100000L, 1300000L, 590000L);
    ...
    static {
        ...
        DEFAULT_INITIAL_BITRATE_ESTIMATES_4G = ImmutableList.m9351of(4800000L, 2700000L, valueOf, 1200000L, 630000L);
        DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA = ImmutableList.m9351of(12000000L, 8800000L, 5900000L, 3500000L, valueOf);
    }
    ...
    public static final class Builder {
        ...
        private static ImmutableList<Integer> getCountryGroupIndices(String str) {
            ...
            return immutableList.isEmpty() ? ImmutableList.m9351of(2, 2, 2, 2, 2) : immutableList;
        }
    }
    ...
    public DefaultBandwidthMeter() {
        this((Context) null, ImmutableMap.m9365of(), 2000, Clock.DEFAULT, false);
    }
    ...
    private static class ConnectivityActionReceiver extends BroadcastReceiver {
        ...
        public synchronized void register(DefaultBandwidthMeter defaultBandwidthMeter) {
            ...
            this.mainHandler.post(new Runnable(defaultBandwidthMeter) {
                ...
                public final void run() {
                    DefaultBandwidthMeter.ConnectivityActionReceiver.this.mo22656xc0d413df(this.f$1);
                }
            });
        }
            ...
            if (!isInitialStickyBroadcast()) {
                ...
                for (int i = 0; i < this.bandwidthMeters.size(); i++) {
                    ...
                    if (defaultBandwidthMeter != null) {
                        mo22656xc0d413df(defaultBandwidthMeter);
                    }
                }
            }
        }
        ...
        public void mo22656xc0d413df(DefaultBandwidthMeter defaultBandwidthMeter) {
