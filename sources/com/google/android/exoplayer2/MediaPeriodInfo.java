...
final class MediaPeriodInfo {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f10040id;
    ...
    public MediaPeriodInfo copyWithStartPositionUs(long j) {
        ...
        return new MediaPeriodInfo(this.f10040id, j, this.requestedContentPositionUs, this.endPositionUs, this.durationUs, this.isLastInTimelinePeriod, this.isLastInTimelineWindow, this.isFinal);
    }
    ...
    public MediaPeriodInfo copyWithRequestedContentPositionUs(long j) {
        ...
        return new MediaPeriodInfo(this.f10040id, this.startPositionUs, j, this.endPositionUs, this.durationUs, this.isLastInTimelinePeriod, this.isLastInTimelineWindow, this.isFinal);
    }
    ...
    public int hashCode() {
        return ((((((((((((((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f10040id.hashCode()) * 31) + ((int) this.startPositionUs)) * 31) + ((int) this.requestedContentPositionUs)) * 31) + ((int) this.endPositionUs)) * 31) + ((int) this.durationUs)) * 31) + (this.isLastInTimelinePeriod ? 1 : 0)) * 31) + (this.isLastInTimelineWindow ? 1 : 0)) * 31) + (this.isFinal ? 1 : 0);
    }
}
