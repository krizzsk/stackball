...
public class FragmentedMp4Extractor implements Extractor {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                ...
                this.trackBundles.put(track.f10045id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f10045id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f10045id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f10045id));
            i++;
        }
    }
    ...
    private void onEmsgLeafAtomRead(com.google.android.exoplayer2.util.ParsableByteArray r27) {
        ...
        L_0x000a:
            ...
            com.google.android.exoplayer2.util.Log.m9247w(r2, r1)
            return
        L_0x0038:
    ...
    private static int checkNonNegative(int i) throws ParserException {
        ...
        throw new ParserException("Unexpected negative value: " + i);
    }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (trackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m9247w(TAG, "Ignoring negative offset to sample data.");
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (parseUuid == null) {
                    Log.m9247w(TAG, "Skipped pssh atom (failed to extract uuid)");
                } else {
