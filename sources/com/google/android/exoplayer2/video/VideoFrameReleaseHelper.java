...
public final class VideoFrameReleaseHelper {
    ...
    private static void setSurfaceFrameRateV30(Surface surface2, float f) {
        try {
            surface2.setFrameRate(f, f == 0.0f ? 0 : 1);
        } catch (IllegalStateException e) {
            Log.m9244e(TAG, "Failed to call Surface.setFrameRate", e);
        }
    }
    ...
    public void updateDefaultDisplayRefreshRateParams() {
        ...
        Log.m9247w(TAG, "Unable to query display refresh rate");
        this.vsyncDurationNs = -9223372036854775807L;
        this.vsyncOffsetNs = -9223372036854775807L;
    }
