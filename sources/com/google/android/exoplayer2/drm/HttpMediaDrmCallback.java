...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest) throws MediaDrmCallbackException {
        ...
        if (!TextUtils.isEmpty(licenseServerUrl)) {
            ...
            if (C3716C.PLAYREADY_UUID.equals(uuid)) {
                str = "text/xml";
            } else {
                str = C3716C.CLEARKEY_UUID.equals(uuid) ? WebRequest.CONTENT_TYPE_JSON : "application/octet-stream";
            }
        ...
        throw new MediaDrmCallbackException(new DataSpec.Builder().setUri(Uri.EMPTY).build(), Uri.EMPTY, ImmutableMap.m9365of(), 0, new IllegalStateException("No license URL"));
    }
