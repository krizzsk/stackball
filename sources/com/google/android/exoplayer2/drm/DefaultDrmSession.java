...
class DefaultDrmSession implements DrmSession {
            ...
            if (i == 0 || i == 1) {
                if (this.offlineLicenseKeySetId == null) {
                    ...
                    if (this.mode == 0 && licenseDurationRemainingSec <= 60) {
                        Log.m9241d(TAG, "Offline license has expired or will expire soon. Remaining seconds: " + licenseDurationRemainingSec);
    ...
    private boolean restoreKeys() {
        try {
            ...
            Log.m9244e(TAG, "Error trying to restore keys.", e);
            onError(e);
            return false;
        }
    }
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C3716C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private class RequestHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r6) {
            ...
            L_0x0033:
                ...
                com.google.android.exoplayer2.util.Log.m9248w(r2, r3, r1)
                goto L_0x0044
            L_0x003c:
                r1 = move-exception
