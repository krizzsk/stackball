...
public interface DrmSessionEventListener {
    ...
    public static class EventDispatcher {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener) {
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.mo20938xb124957e(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo20938xb124957e(DrmSessionEventListener drmSessionEventListener) {
        ...
        public void drmSessionManagerError(Exception exc) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener, exc) {
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.mo20939xf6fa3d4d(this.f$1, this.f$2);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo20939xf6fa3d4d(DrmSessionEventListener drmSessionEventListener, Exception exc) {
        ...
        public void drmSessionReleased() {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable(next.listener) {
                    ...
                    public final void run() {
                        DrmSessionEventListener.EventDispatcher.this.mo20940xd1e970b2(this.f$1);
                    }
                });
            }
        }
        ...
        public /* synthetic */ void mo20940xd1e970b2(DrmSessionEventListener drmSessionEventListener) {
