...
final class MediaPeriodQueue {
    ...
    public MediaPeriodHolder enqueueNextMediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, TrackSelector trackSelector, Allocator allocator, MediaSourceList mediaSourceList, MediaPeriodInfo mediaPeriodInfo, TrackSelectorResult trackSelectorResult) {
        ...
        MediaPeriodHolder mediaPeriodHolder = this.loading;
        if (mediaPeriodHolder == null) {
            j = (!mediaPeriodInfo2.f10040id.isAd() || mediaPeriodInfo2.requestedContentPositionUs == -9223372036854775807L) ? 0 : mediaPeriodInfo2.requestedContentPositionUs;
        } else {
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (i == 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = this.playing.info.f10040id.windowSequenceNumber;
        }
    ...
    public void clear() {
        if (this.length != 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder.info.f10040id.windowSequenceNumber;
    ...
    public MediaPeriodInfo getUpdatedMediaPeriodInfo(Timeline timeline, MediaPeriodInfo mediaPeriodInfo) {
        long durationUs;
        MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodInfo.f10040id;
        ...
        timeline.getPeriodByUid(mediaPeriodInfo.f10040id.periodUid, this.period);
    ...
    private void notifyQueueUpdate() {
        if (this.analyticsCollector != null) {
            ...
            for (MediaPeriodHolder mediaPeriodHolder = this.playing; mediaPeriodHolder != null; mediaPeriodHolder = mediaPeriodHolder.getNext()) {
                builder.add((Object) mediaPeriodHolder.info.f10040id);
            }
            MediaPeriodHolder mediaPeriodHolder2 = this.reading;
            this.analyticsCollectorHandler.post(new Runnable(builder, mediaPeriodHolder2 == null ? null : mediaPeriodHolder2.info.f10040id) {
    ...
    private long resolvePeriodIndexToWindowSequenceNumber(Timeline timeline, Object obj) {
        ...
        for (MediaPeriodHolder mediaPeriodHolder = this.playing; mediaPeriodHolder != null; mediaPeriodHolder = mediaPeriodHolder.getNext()) {
            if (mediaPeriodHolder.uid.equals(obj)) {
                return mediaPeriodHolder.info.f10040id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder mediaPeriodHolder2 = this.playing; mediaPeriodHolder2 != null; mediaPeriodHolder2 = mediaPeriodHolder2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i) {
                return mediaPeriodHolder2.info.f10040id.windowSequenceNumber;
            }
        }
    ...
    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f10040id.equals(mediaPeriodInfo2.f10040id);
    }
    ...
    private MediaPeriodInfo getFollowingMediaPeriodInfo(Timeline timeline, MediaPeriodHolder mediaPeriodHolder, long j) {
        ...
        if (mediaPeriodInfo.isLastInTimelinePeriod) {
            long j3 = 0;
            int nextPeriodIndex = timeline.getNextPeriodIndex(timeline2.getIndexOfPeriod(mediaPeriodInfo.f10040id.periodUid), this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
            if (nextPeriodIndex == -1) {
                return null;
            }
            int i = timeline2.getPeriod(nextPeriodIndex, this.period, true).windowIndex;
            Object obj = this.period.uid;
            long j4 = mediaPeriodInfo.f10040id.windowSequenceNumber;
            if (timeline2.getWindow(i, this.window).firstPeriodIndex == nextPeriodIndex) {
                ...
                if (next == null || !next.uid.equals(obj)) {
                    ...
                    j4 = next.info.f10040id.windowSequenceNumber;
                }
                j2 = longValue;
    ...
    private MediaPeriodInfo getMediaPeriodInfoForAd(Timeline timeline, Object obj, int i, int i2, long j, long j2) {
        ...
        return new MediaPeriodInfo(mediaPeriodId, (adDurationUs == -9223372036854775807L || adResumePositionUs < adDurationUs) ? adResumePositionUs : Math.max(0, adDurationUs - 1), j, -9223372036854775807L, adDurationUs, false, false, false);
    }
