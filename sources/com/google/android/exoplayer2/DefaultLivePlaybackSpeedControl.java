...
public final class DefaultLivePlaybackSpeedControl implements LivePlaybackSpeedControl {
    ...
    public static final class Builder {
        ...
        private long maxLiveOffsetErrorUsForUnitSpeed = C3716C.msToUs(20);
        ...
        private long targetLiveOffsetIncrementOnRebufferUs = C3716C.msToUs(500);
        ...
        public Builder setMaxLiveOffsetErrorMsForUnitSpeed(long j) {
            Assertions.checkArgument(j > 0);
            this.maxLiveOffsetErrorUsForUnitSpeed = C3716C.msToUs(j);
            return this;
        }

        public Builder setTargetLiveOffsetIncrementOnRebufferMs(long j) {
            Assertions.checkArgument(j >= 0);
            this.targetLiveOffsetIncrementOnRebufferUs = C3716C.msToUs(j);
            return this;
        }
    ...
    public void setLiveConfiguration(MediaItem.LiveConfiguration liveConfiguration) {
        float f;
        float f2;
        this.mediaConfigurationTargetLiveOffsetUs = C3716C.msToUs(liveConfiguration.targetOffsetMs);
        this.minTargetLiveOffsetUs = C3716C.msToUs(liveConfiguration.minOffsetMs);
        this.maxTargetLiveOffsetUs = C3716C.msToUs(liveConfiguration.maxOffsetMs);
    ...
    private void adjustTargetLiveOffsetUs(long j) {
        ...
        if (this.currentTargetLiveOffsetUs > j2) {
            float msToUs = (float) C3716C.msToUs(this.minUpdateIntervalMs);
