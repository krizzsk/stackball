...
public final class SingleSampleMediaSource extends BaseMediaSource {
    ...
    public static final class Factory {
        ...
        public SingleSampleMediaSource createMediaSource(Uri uri, Format format, long j) {
            return new SingleSampleMediaSource(format.f10038id == null ? this.trackId : format.f10038id, new MediaItem.Subtitle(uri, (String) Assertions.checkNotNull(format.sampleMimeType), format.language, format.selectionFlags), this.dataSourceFactory, j, this.loadErrorHandlingPolicy, this.treatLoadErrorsAsEndOfStream, this.tag);
        }
    }
    ...
    private SingleSampleMediaSource(String str, MediaItem.Subtitle subtitle, DataSource.Factory factory, long j, LoadErrorHandlingPolicy loadErrorHandlingPolicy2, boolean z, Object obj) {
        ...
        this.loadErrorHandlingPolicy = loadErrorHandlingPolicy2;
        this.treatLoadErrorsAsEndOfStream = z;
        this.mediaItem = new MediaItem.Builder().setUri(Uri.EMPTY).setMediaId(subtitle2.uri.toString()).setSubtitles(Collections.singletonList(subtitle)).setTag(obj).build();
        String str2 = str;
        ...
        this.timeline = new SinglePeriodTimeline(j2, true, false, false, (Object) null, this.mediaItem);
    }
