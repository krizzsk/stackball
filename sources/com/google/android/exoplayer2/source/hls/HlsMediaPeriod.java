...
public final class HlsMediaPeriod implements MediaPeriod, HlsSampleStreamWrapper.Callback, HlsPlaylistTracker.PlaylistEventListener {
    ...
    private void buildAndPrepareMainSampleStreamWrapper(com.google.android.exoplayer2.source.hls.playlist.HlsMasterPlaylist r20, long r21, java.util.List<com.google.android.exoplayer2.source.hls.HlsSampleStreamWrapper> r23, java.util.List<int[]> r24, java.util.Map<java.lang.String, com.google.android.exoplayer2.drm.DrmInitData> r25) {
        ...
        L_0x0088:
            ...
            int r4 = com.google.android.exoplayer2.util.Util.getCodecCountOfType(r2, r8)
            int r2 = com.google.android.exoplayer2.util.Util.getCodecCountOfType(r2, r9)
        ...
        L_0x009f:
            ...
            r16 = r25
            r17 = r21
            com.google.android.exoplayer2.source.hls.HlsSampleStreamWrapper r8 = r10.buildSampleStreamWrapper(r11, r12, r13, r14, r15, r16, r17)
            r10 = r23
            r10.add(r8)
            r10 = r24
            r10.add(r7)
            r7 = r19
            boolean r10 = r7.allowChunklessPreparation
        ...
        L_0x00ee:
            ...
            r4 = r6[r3]
            com.google.android.exoplayer2.Format r6 = r0.muxedAudioFormat
            com.google.android.exoplayer2.Format r4 = deriveAudioFormat(r4, r6, r3)
            r2[r3] = r4
        ...
        L_0x0125:
            ...
            com.google.android.exoplayer2.Format r10 = deriveAudioFormat(r10, r11, r9)
            r2[r4] = r10
            int r4 = r4 + 1
            goto L_0x0125
        L_0x0134:
        ...
        L_0x013c:
            ...
            com.google.android.exoplayer2.Format$Builder r2 = r2.setId((java.lang.String) r4)
            ...
            r2[r3] = r0
            r8.prepareWithMasterPlaylistInfo(r1, r3, r2)
        L_0x0170:
            return
        */
    ...
    private static Format deriveVideoFormat(Format format) {
        ...
        return new Format.Builder().setId(format.f10038id).setLabel(format.label).setContainerMimeType(format.containerMimeType).setSampleMimeType(MimeTypes.getMediaMimeType(codecsOfType)).setCodecs(codecsOfType).setMetadata(format.metadata).setAverageBitrate(format.averageBitrate).setPeakBitrate(format.peakBitrate).setWidth(format.width).setHeight(format.height).setFrameRate(format.frameRate).setSelectionFlags(format.selectionFlags).setRoleFlags(format.roleFlags).build();
    }
    ...
    private static Format deriveAudioFormat(Format format, Format format2, boolean z) {
        ...
        return new Format.Builder().setId(format.f10038id).setLabel(str).setContainerMimeType(format.containerMimeType).setSampleMimeType(mediaMimeType).setCodecs(str3).setMetadata(metadata).setAverageBitrate(i12).setPeakBitrate(i4).setChannelCount(i).setSelectionFlags(i2).setRoleFlags(i3).setLanguage(str2).build();
    }
}
