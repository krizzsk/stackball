...
import com.google.android.exoplayer2.extractor.p086ts.Ac3Extractor;
import com.google.android.exoplayer2.extractor.p086ts.Ac4Extractor;
import com.google.android.exoplayer2.extractor.p086ts.AdtsExtractor;
import com.google.android.exoplayer2.extractor.p086ts.DefaultTsPayloadReaderFactory;
...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    public BundledHlsMediaChunkExtractor createExtractor(Uri uri, Format format, List<Format> list, TimestampAdjuster timestampAdjuster, Map<String, List<String>> map, ExtractorInput extractorInput) throws IOException {
        ...
        for (int addFileTypeIfValidAndNotPresent : DEFAULT_EXTRACTOR_ORDER) {
