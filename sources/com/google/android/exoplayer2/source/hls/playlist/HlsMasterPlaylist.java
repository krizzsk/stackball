...
public final class HlsMasterPlaylist extends HlsPlaylist {
    ...
    public static final class Variant {
        ...
        public static Variant createMediaPlaylistVariantUrl(Uri uri) {
            return new Variant(uri, new Format.Builder().setId(AppEventsConstants.EVENT_PARAM_VALUE_NO).setContainerMimeType("application/x-mpegURL").build(), (String) null, (String) null, (String) null, (String) null);
        }
