...
class SampleDataQueue {
    ...
    private static AllocationNode readEncryptionData(AllocationNode allocationNode, DecoderInputBuffer decoderInputBuffer, SampleQueue.SampleExtrasHolder sampleExtrasHolder, ParsableByteArray parsableByteArray) {
        ...
        if (cryptoInfo.f10043iv == null) {
            cryptoInfo.f10043iv = new byte[16];
        } else {
            Arrays.fill(cryptoInfo.f10043iv, (byte) 0);
        }
        AllocationNode readData2 = readData(readData, j2, cryptoInfo.f10043iv, (int) b2);
        long j3 = j2 + ((long) b2);
        if (z) {
        ...
        cryptoInfo.set(i, iArr2, iArr4, cryptoData.encryptionKey, cryptoInfo.f10043iv, cryptoData.cryptoMode, cryptoData.encryptedBlocks, cryptoData.clearBlocks);
