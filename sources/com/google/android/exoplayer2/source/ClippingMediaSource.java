...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    public long getMediaTimeForChildMediaTime(Void voidR, long j) {
        ...
        long usToMs = C3716C.usToMs(this.startUs);
        long max = Math.max(0, j - usToMs);
        long j2 = this.endUs;
        return j2 != Long.MIN_VALUE ? Math.min(C3716C.usToMs(j2) - usToMs, max) : max;
    }
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            if (window.defaultPositionUs != -9223372036854775807L) {
                ...
                int i2 = (this.endUs > -9223372036854775807L ? 1 : (this.endUs == -9223372036854775807L ? 0 : -1));
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f10042id, period.uid, 0, j == -9223372036854775807L ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
    }
}
