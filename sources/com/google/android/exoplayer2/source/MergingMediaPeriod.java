...
final class MergingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < exoTrackSelectionArr2.length; i2++) {
            Integer num = sampleStreamArr2[i2] == null ? null : this.streamPeriodIndices.get(sampleStreamArr2[i2]);
            if (num == null) {
                i = -1;
            } else {
                i = num.intValue();
        ...
        while (i4 < this.periods.length) {
            for (int i5 = 0; i5 < exoTrackSelectionArr2.length; i5++) {
                ...
                exoTrackSelectionArr3[i5] = iArr2[i5] == i4 ? exoTrackSelectionArr2[i5] : null;
            }
            int i6 = i4;
