...
public final class MaskingMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f10060id;
    ...
    public void maybeThrowPrepareError() throws IOException {
        try {
            ...
            if (prepareListener == null) {
                ...
                prepareListener.onPrepareError(this.f10060id, e);
            }
        }
    }
    ...
    public void onPrepared(MediaPeriod mediaPeriod2) {
        ...
        PrepareListener prepareListener = this.listener;
        if (prepareListener != null) {
            prepareListener.onPrepareComplete(this.f10060id);
        }
    }
