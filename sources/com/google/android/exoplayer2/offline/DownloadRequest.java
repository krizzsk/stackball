...
public final class DownloadRequest implements Parcelable {
    ...
    DownloadRequest(Parcel parcel) {
        this.f10057id = (String) Util.castNonNull(parcel.readString());
    ...
    public DownloadRequest copyWithKeySetId(byte[] bArr) {
        return new DownloadRequest(this.f10057id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List list;
        Assertions.checkArgument(this.f10057id.equals(downloadRequest.f10057id));
        ...
        return new DownloadRequest(this.f10057id, downloadRequest.uri, downloadRequest.mimeType, list, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }

    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f10057id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).setDrmKeySetId(this.keySetId).build();
    }

    public String toString() {
        return this.mimeType + CertificateUtil.DELIMITER + this.f10057id;
    }
    ...
    public final int hashCode() {
        int hashCode = ((this.f10057id.hashCode() * 31 * 31) + this.uri.hashCode()) * 31;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f10057id);
