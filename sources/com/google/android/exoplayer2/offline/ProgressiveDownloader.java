...
public final class ProgressiveDownloader implements Downloader {
    ...
    public ProgressiveDownloader(MediaItem mediaItem, CacheDataSource.Factory factory) {
        this(mediaItem, factory, (Executor) $$Lambda$_14QHG018Z6p13d3hzJuGTWnNeo.INSTANCE);
    }
    ...
    public ProgressiveDownloader(MediaItem mediaItem, CacheDataSource.Factory factory, Executor executor2) {
        ...
        this.cacheWriter = new CacheWriter(this.dataSource, this.dataSpec, false, (byte[]) null, new CacheWriter.ProgressListener() {
