...
public final class DownloadManager {
    ...
    public DownloadManager(Context context2, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context2, databaseProvider, cache, factory, $$Lambda$_14QHG018Z6p13d3hzJuGTWnNeo.INSTANCE);
    }
    ...
    private static final class InternalHandler extends Handler {
        ...
        private void initialize(int i) {
            ...
            try {
                ...
                Log.m9244e(DownloadManager.TAG, "Failed to load index.", e);
        ...
        private void setStopReason(String str, int i) {
            if (str == null) {
                ...
                try {
                    ...
                    Log.m9244e(DownloadManager.TAG, "Failed to set manual stop reason", e);
                }
            } else {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.m9244e(DownloadManager.TAG, "Failed to set manual stop reason: " + str, e2);
                    }
                }
            }
            syncTasks();
        ...
        private void addDownload(DownloadRequest downloadRequest, int i) {
            Download download = getDownload(downloadRequest.f10057id, true);
        ...
        private void removeDownload(String str) {
            ...
            if (download == null) {
                Log.m9243e(DownloadManager.TAG, "Failed to remove nonexistent download: " + str);
                return;
            }
        ...
        private void removeAllDownloads() {
            ...
            L_0x003a:
                ...
                com.google.android.exoplayer2.util.Log.m9243e(r0, r4)
            L_0x003f:
                r4 = 0
            L_0x0040:
                ...
                com.google.android.exoplayer2.offline.Download r6 = copyDownloadWithState(r7, r6, r3)
                r5.set(r4, r6)
                int r4 = r4 + 1
                goto L_0x0040
            L_0x005b:
            ...
            L_0x005c:
                ...
                com.google.android.exoplayer2.offline.Download r7 = (com.google.android.exoplayer2.offline.Download) r7
                com.google.android.exoplayer2.offline.Download r7 = copyDownloadWithState(r7, r6, r3)
                r5.add(r7)
                int r4 = r4 + 1
                goto L_0x005c
            L_0x0074:
                java.util.ArrayList<com.google.android.exoplayer2.offline.Download> r1 = r8.downloads
                com.google.android.exoplayer2.offline.-$$Lambda$DownloadManager$InternalHandler$NXQcmC9peGeDWV0s_8pBfzdJpS0 r4 = com.google.android.exoplayer2.offline.C3813x7c64c816.INSTANCE
            ...
            L_0x0081:
                ...
                com.google.android.exoplayer2.util.Log.m9244e(r0, r4, r1)
            L_0x0087:
        ...
        private void release() {
            ...
            try {
                ...
                Log.m9244e(DownloadManager.TAG, "Failed to update index.", e);
            }
            this.downloads.clear();
            this.thread.quit();
            synchronized (this) {
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task task = this.activeTasks.get(download.request.f10057id);
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(putDownloadWithState.request.f10057id, task2);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(download.request.f10057id, task2);
                task2.start();
        ...
        private void onContentLengthChanged(Task task, long j) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f10057id, false));
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f10057id;
            ...
            if (access$400 != null) {
                Log.m9244e(DownloadManager.TAG, "Task failed: " + task.request + ", " + access$000, access$400);
            }
        ...
        private void onDownloadTaskStopped(Download download, Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download3.request.f10057id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            ...
            this.downloads.remove(getDownloadIndex(download.request.f10057id));
            try {
                this.downloadIndex.removeDownload(download.request.f10057id);
            } catch (IOException unused) {
                Log.m9243e(DownloadManager.TAG, "Failed to remove from database");
            }
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex2 = getDownloadIndex(download.request.f10057id);
            if (downloadIndex2 == -1) {
                this.downloads.add(download);
                Collections.sort(this.downloads, C3813x7c64c816.INSTANCE);
            } else {
        ...
        private Download getDownload(String str, boolean z) {
            ...
            try {
                ...
                Log.m9244e(DownloadManager.TAG, "Failed to load download: " + str, e);
                return null;
            }
        }
        ...
        private int getDownloadIndex(String str) {
            for (int i = 0; i < this.downloads.size(); i++) {
                if (this.downloads.get(i).request.f10057id.equals(str)) {
                    return i;
                }
            }
            return -1;
