...
public final class MediaCodecUtil {
    ...
    public static void warmDecoderInfoCache(String str, boolean z, boolean z2) {
        try {
            ...
            Log.m9244e(TAG, "Codec warming failed", e);
        }
    }
        ...
        synchronized (MediaCodecUtil.class) {
            ...
            if (z && decoderInfosInternal.isEmpty() && 21 <= Util.SDK_INT && Util.SDK_INT <= 23) {
                ...
                if (!decoderInfosInternal.isEmpty()) {
                    Log.m9247w(TAG, "MediaCodecList API didn't list secure decoder for: " + str + ". Assuming: " + decoderInfosInternal.get(0).name);
                }
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0063, code lost:
        if (r3.equals(CODEC_ID_AVC1) != false) goto L_0x0071;
     */
    ...
    private static java.util.ArrayList<com.google.android.exoplayer2.mediacodec.MediaCodecInfo> getDecoderInfosInternal(com.google.android.exoplayer2.mediacodec.MediaCodecUtil.CodecKey r24, com.google.android.exoplayer2.mediacodec.MediaCodecUtil.MediaCodecListCompat r25) throws com.google.android.exoplayer2.mediacodec.MediaCodecUtil.DecoderQueryException {
        /*
            ...
            java.lang.String r15 = r1.mimeType     // Catch:{ Exception -> 0x0153 }
            int r14 = r25.getCodecCount()     // Catch:{ Exception -> 0x0153 }
            boolean r13 = r25.secureDecodersExplicit()     // Catch:{ Exception -> 0x0153 }
            r0 = 0
            r12 = 0
        L_0x0019:
            if (r12 >= r14) goto L_0x0152
            android.media.MediaCodecInfo r0 = r2.getCodecInfoAt(r12)     // Catch:{ Exception -> 0x0153 }
            boolean r6 = isAlias(r0)     // Catch:{ Exception -> 0x0153 }
        ...
        L_0x002d:
            ...
            boolean r6 = isCodecUsableDecoder(r0, r11, r13, r15)     // Catch:{ Exception -> 0x0153 }
            if (r6 != 0) goto L_0x0038
            goto L_0x0025
        L_0x0038:
            java.lang.String r10 = getCodecMimeType(r0, r11, r15)     // Catch:{ Exception -> 0x0153 }
            if (r10 != 0) goto L_0x003f
            goto L_0x0025
        L_0x003f:
            android.media.MediaCodecInfo$CodecCapabilities r9 = r0.getCapabilitiesForType(r10)     // Catch:{ Exception -> 0x00f3 }
            boolean r6 = r2.isFeatureSupported(r4, r10, r9)     // Catch:{ Exception -> 0x00f3 }
            boolean r7 = r2.isFeatureRequired(r4, r10, r9)     // Catch:{ Exception -> 0x00f3 }
            boolean r8 = r1.tunneling     // Catch:{ Exception -> 0x00f3 }
            if (r8 != 0) goto L_0x0051
            if (r7 != 0) goto L_0x0025
        L_0x0051:
            boolean r7 = r1.tunneling     // Catch:{ Exception -> 0x00f3 }
            if (r7 == 0) goto L_0x0058
            if (r6 != 0) goto L_0x0058
            goto L_0x0025
        L_0x0058:
            boolean r6 = r2.isFeatureSupported(r3, r10, r9)     // Catch:{ Exception -> 0x00f3 }
            boolean r7 = r2.isFeatureRequired(r3, r10, r9)     // Catch:{ Exception -> 0x00f3 }
            boolean r8 = r1.secure     // Catch:{ Exception -> 0x00f3 }
            if (r8 != 0) goto L_0x0066
            if (r7 != 0) goto L_0x0025
        L_0x0066:
            boolean r7 = r1.secure     // Catch:{ Exception -> 0x00f3 }
            if (r7 == 0) goto L_0x006d
            if (r6 != 0) goto L_0x006d
            goto L_0x0025
        L_0x006d:
            boolean r16 = isHardwareAccelerated(r0)     // Catch:{ Exception -> 0x00f3 }
            boolean r17 = isSoftwareOnly(r0)     // Catch:{ Exception -> 0x00f3 }
            boolean r0 = isVendor(r0)     // Catch:{ Exception -> 0x00f3 }
        ...
        L_0x00b7:
            ...
            r1 = r14
            r14 = r19
            com.google.android.exoplayer2.mediacodec.MediaCodecInfo r0 = com.google.android.exoplayer2.mediacodec.MediaCodecInfo.newInstance(r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ Exception -> 0x00ee }
        ...
        L_0x00f3:
            ...
            r18 = r14
        L_0x00fd:
            int r6 = com.google.android.exoplayer2.util.Util.SDK_INT     // Catch:{ Exception -> 0x0153 }
            r7 = 23
            ...
            com.google.android.exoplayer2.util.Log.m9243e(r8, r0)     // Catch:{ Exception -> 0x0153 }
        L_0x0124:
            int r12 = r22 + 1
            r1 = r24
            r14 = r18
        ...
        L_0x012e:
            ...
            com.google.android.exoplayer2.util.Log.m9243e(r8, r1)     // Catch:{ Exception -> 0x0153 }
    ...
    private static Pair<Integer, Integer> getDolbyVisionProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m9247w(TAG, "Ignoring malformed Dolby Vision codec string: " + str);
            return null;
        }
        ...
        if (dolbyVisionStringToProfile == null) {
            Log.m9247w(TAG, "Unknown Dolby Vision profile string: " + group);
            return null;
        }
        ...
        Log.m9247w(TAG, "Unknown Dolby Vision level string: " + str2);
        return null;
    }

    private static Pair<Integer, Integer> getHevcProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 4) {
            Log.m9247w(TAG, "Ignoring malformed HEVC codec string: " + str);
            return null;
        }
        int i = 1;
        Matcher matcher = PROFILE_PATTERN.matcher(strArr[1]);
        ...
        if (!"1".equals(group)) {
            if ("2".equals(group)) {
                ...
                Log.m9247w(TAG, "Unknown HEVC profile string: " + group);
                return null;
            }
        }
        ...
        Log.m9247w(TAG, "Unknown HEVC level string: " + str2);
        return null;
    }
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        int i2;
        if (strArr.length < 2) {
            Log.m9247w(TAG, "Ignoring malformed AVC codec string: " + str);
            return null;
        }
        try {
            ...
            if (avcProfileNumberToConst == -1) {
                Log.m9247w(TAG, "Unknown AVC profile: " + i2);
                return null;
            }
            ...
            Log.m9247w(TAG, "Unknown AVC level: " + i);
            return null;
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        if (strArr.length < 3) {
            Log.m9247w(TAG, "Ignoring malformed VP9 codec string: " + str);
            return null;
        }
        try {
            int parseInt = Integer.parseInt(strArr[1]);
            ...
            if (vp9ProfileNumberToConst == -1) {
                Log.m9247w(TAG, "Unknown VP9 profile: " + parseInt);
                return null;
            }
            ...
            Log.m9247w(TAG, "Unknown VP9 level: " + parseInt2);
            return null;
        } catch (NumberFormatException unused) {
            Log.m9247w(TAG, "Ignoring malformed VP9 codec string: " + str);
            return null;
    ...
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, ColorInfo colorInfo) {
        if (strArr.length < 4) {
            Log.m9247w(TAG, "Ignoring malformed AV1 codec string: " + str);
            return null;
        }
        int i = 1;
        try {
            ...
            if (parseInt != 0) {
                Log.m9247w(TAG, "Unknown AV1 profile: " + parseInt);
                return null;
                ...
                Log.m9247w(TAG, "Unknown AV1 level: " + parseInt2);
                return null;
            } else {
                Log.m9247w(TAG, "Unknown AV1 bit depth: " + parseInt3);
                return null;
            }
        } catch (NumberFormatException unused) {
            Log.m9247w(TAG, "Ignoring malformed AV1 codec string: " + str);
    ...
    private static Pair<Integer, Integer> getAacCodecProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length != 3) {
            Log.m9247w(TAG, "Ignoring malformed MP4A codec string: " + str);
            return null;
        }
        try {
