...
final class AudioFocusManager {
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes2) {
        ...
        switch (audioAttributes2.usage) {
            case 0:
                Log.m9247w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
            ...
            case 16:
                ...
                return 2;
            default:
                Log.m9247w(TAG, "Unidentified audio usage: " + audioAttributes2.usage);
                return 0;
        }
        return 3;
    }
    ...
    public void handlePlatformAudioFocusChange(int i) {
        if (i == -3 || i == -2) {
            ...
            Log.m9247w(TAG, "Unknown focus change type: " + i);
        } else {
            setAudioFocusState(1);
            executePlayerCommand(1);
        }
