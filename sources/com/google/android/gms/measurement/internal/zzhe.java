...
public final class zzhe extends zzg {
    ...
    public final Boolean zzab() {
        ...
        return (Boolean) zzp().zza(atomicReference, MBInterstitialActivity.WEB_LOAD_TIME, "boolean test flag value", new zzhj(this, atomicReference));
    }

    public final String zzac() {
        AtomicReference atomicReference = new AtomicReference();
        return (String) zzp().zza(atomicReference, MBInterstitialActivity.WEB_LOAD_TIME, "String test flag value", new zzht(this, atomicReference));
    }

    public final Long zzad() {
        AtomicReference atomicReference = new AtomicReference();
        return (Long) zzp().zza(atomicReference, MBInterstitialActivity.WEB_LOAD_TIME, "long test flag value", new zzhx(this, atomicReference));
    }

    public final Integer zzae() {
        AtomicReference atomicReference = new AtomicReference();
        return (Integer) zzp().zza(atomicReference, MBInterstitialActivity.WEB_LOAD_TIME, "int test flag value", new zzhw(this, atomicReference));
    }

    public final Double zzaf() {
        AtomicReference atomicReference = new AtomicReference();
        return (Double) zzp().zza(atomicReference, MBInterstitialActivity.WEB_LOAD_TIME, "double test flag value", new zzhz(this, atomicReference));
    }
    ...
    public final void zzal() {
        ...
        if (zza2 != null) {
            if ("unset".equals(zza2)) {
                ...
                zza(TapjoyConstants.TJC_APP_PLACEMENT, "_npa", (Object) Long.valueOf("true".equals(zza2) ? 1 : 0), zzl().currentTimeMillis());
            }
        }
        ...
        if (this.zzy.zzaf()) {
            ...
            if (!TextUtils.isEmpty(zzx)) {
                ...
                if (!zzx.equals(Build.VERSION.RELEASE)) {
                    ...
                    zza(TtmlNode.TEXT_EMPHASIS_AUTO, "_ou", bundle);
                }
            }
        }
    }
