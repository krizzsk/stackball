...
public final class zzkt extends zzkm {
    ...
    public final String zza(zzcd.zzf zzf) {
        ...
        for (zzcd.zzg next : zzf.zza()) {
            if (next != null) {
                ...
                zza(sb, 1, TapjoyConstants.TJC_APP_VERSION_NAME, (Object) next.zzy());
                if (next.zzar()) {
                ...
                zza(sb, 1, TapjoyConstants.TJC_DEVICE_OS_VERSION_NAME, (Object) next.zzr());
            ...
            for (zzcd.zze next : list) {
                if (next != null) {
                    ...
                    if (!zzmh.zzb() || !zzs().zza(zzat.zzbx)) {
                        zza(sb, i2, "name", (Object) zzn().zzb(next.zzb()));
    ...
    static <Builder extends zzjf> Builder zza(Builder builder, byte[] bArr) throws zzig {
        zzhi zzb = zzhi.zzb();
        if (zzb != null) {
    ...
    /* renamed from: f_ */
    public final /* bridge */ /* synthetic */ zzkt mo31916f_() {
        return super.mo31916f_();
    }
