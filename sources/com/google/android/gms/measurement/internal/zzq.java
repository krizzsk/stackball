...
final class zzq {
    ...
    public final zzcd.zza zza(int i) {
        ArrayList arrayList;
        List list;
        zzcd.zza.C15663zza zzh2 = zzcd.zza.zzh();
        zzh2.zza(i);
        zzh2.zza(this.zzb);
        ...
        if (this.zzf == null) {
            ...
            for (Integer intValue : this.zzf.keySet()) {
                ...
                arrayList.add((zzcd.zzb) ((zzhv) zzcd.zzb.zze().zza(intValue2).zza(this.zzf.get(Integer.valueOf(intValue2)).longValue()).zzy()));
            }
        }
        zza2.zzc(arrayList);
        if (this.zzg == null) {
            ...
            for (Integer next : this.zzg.keySet()) {
                ...
                arrayList2.add((zzcd.zzj) ((zzhv) zza3.zzy()));
            }
            list = arrayList2;
        }
        zza2.zzd(list);
