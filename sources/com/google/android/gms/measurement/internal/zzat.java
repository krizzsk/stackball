...
public final class zzat {
    ...
    static {
        ...
        Long valueOf2 = Long.valueOf(MBInterstitialActivity.WEB_LOAD_TIME);
        zzz = zza("measurement.upload.initial_upload_delay_time", valueOf2, valueOf2, zzbk.zza);
        Long valueOf3 = Long.valueOf(TapjoyConstants.SESSION_ID_INACTIVITY_TIME);
        zzaa = zza("measurement.upload.retry_time", valueOf3, valueOf3, zzbn.zza);
        Integer valueOf4 = Integer.valueOf(TJAdUnitConstants.DEFAULT_VOLUME_CHECK_INTERVAL);
        zzag = zza("measurement.upload.max_event_name_cardinality", valueOf4, valueOf4, (zzek) null);
