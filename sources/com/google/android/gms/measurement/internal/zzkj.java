...
final class zzkj {
    ...
    private final void zzb(long j, boolean z) {
        ...
        if (this.zza.zzy.zzaa()) {
            ...
            this.zza.zze().zza(TtmlNode.TEXT_EMPHASIS_AUTO, "_sid", (Object) valueOf, j);
            ...
            this.zza.zze().zza(TtmlNode.TEXT_EMPHASIS_AUTO, "_s", j, bundle);
            if (zzmn.zzb() && this.zza.zzs().zza(zzat.zzbq)) {
                String zza2 = this.zza.zzr().zzu.zza();
                if (!TextUtils.isEmpty(zza2)) {
                    Bundle bundle2 = new Bundle();
                    bundle2.putString("_ffr", zza2);
                    this.zza.zze().zza(TtmlNode.TEXT_EMPHASIS_AUTO, "_ssr", j, bundle2);
                }
            }
        }
    }
