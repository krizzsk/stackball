            ...
            if (zzb2 == null) {
                ...
                try {
                    ...
                    if (zzky == null || zzky.zze == null) {
                        zzky zzky2 = new zzky(zzc2, TtmlNode.TEXT_EMPHASIS_AUTO, "_lte", zzl().currentTimeMillis(), 0L);
                        zza6.add(zzky2);
                        zzi().zza(zzky2);
                    }
                    zzkt f_ = mo31916f_();
                    ...
                    if (f_.zzk().zzi()) {
                        ...
                        if (zzb2.zzaf() && f_.zzj().zze(zzc3)) {
                            ...
                            zza6.add(new zzky(zzc3, TtmlNode.TEXT_EMPHASIS_AUTO, "_npa", f_.zzl().currentTimeMillis(), 1L));
                        }
                    }
                    ...
                    for (int i = 0; i < zza6.size(); i++) {
                        ...
                        mo31916f_().zza(zza7, zza6.get(i).zze);
                    ...
                    while (it3.hasNext()) {
                        ...
                        mo31916f_().zza(zza10, zzak.zze.zza(next));
                        zzb3.zza(zza10);
                    }
                    ...
                    zzf.zzv();
                    zza11.zzg((int) zzf.zzs()).zzg(31049).zza(zzl().currentTimeMillis()).zzb(Boolean.TRUE.booleanValue());
                    ...
                    zzi().mo31679b_();
                    try {
                        return mo31916f_().zzc(((zzcd.zzf) ((zzhv) zza12.zzy())).zzbk());
