...
final class zzac extends zzkm {
    ...
    public final void zze() {
        zzaj();
        mo31680c_().beginTransaction();
    }

    /* renamed from: b_ */
    public final void mo31679b_() {
        zzaj();
        mo31680c_().setTransactionSuccessful();
    }

    public final void zzg() {
        zzaj();
        mo31680c_().endTransaction();
    }

    private final long zzb(String str, String[] strArr) {
        Cursor cursor = null;
        try {
            cursor = mo31680c_().rawQuery(str, strArr);
    ...
    private final long zza(String str, String[] strArr, long j) {
        Cursor cursor = null;
        try {
            Cursor rawQuery = mo31680c_().rawQuery(str, strArr);
    ...
    /* renamed from: c_ */
    public final SQLiteDatabase mo31680c_() {
        zzc();
        try {
    ...
    public final com.google.android.gms.measurement.internal.zzan zza(java.lang.String r26, java.lang.String r27) {
        /*
            ...
            r0.<init>(r1)
            r18 = 0
            android.database.sqlite.SQLiteDatabase r1 = r25.mo31680c_()     // Catch:{ SQLiteException -> 0x0127, all -> 0x0125 }
        ...
        L_0x00e1:
            ...
            com.google.android.gms.measurement.internal.zzex r0 = r25.zzq()     // Catch:{ SQLiteException -> 0x0117, all -> 0x0115 }
            com.google.android.gms.measurement.internal.zzez r0 = r0.zze()     // Catch:{ SQLiteException -> 0x0117, all -> 0x0115 }
            java.lang.String r1 = "Got multiple records for event aggregates, expected one. appId"
            java.lang.Object r2 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r26)     // Catch:{ SQLiteException -> 0x0117, all -> 0x0115 }
        ...
        L_0x0127:
            ...
            r14 = r18
        L_0x012a:
            com.google.android.gms.measurement.internal.zzex r1 = r25.zzq()     // Catch:{ all -> 0x014b }
            com.google.android.gms.measurement.internal.zzez r1 = r1.zze()     // Catch:{ all -> 0x014b }
            java.lang.String r2 = "Error querying events. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r26)     // Catch:{ all -> 0x014b }
            com.google.android.gms.measurement.internal.zzev r4 = r25.zzn()     // Catch:{ all -> 0x014b }
            r5 = r27
    ...
    public final void zza(zzan zzan) {
        ...
        try {
            if (mo31680c_().insertWithOnConflict("events", (String) null, contentValues, 5) == -1) {
    ...
    public final void zzb(String str, String str2) {
        ...
        zzaj();
        try {
            mo31680c_().delete("user_attributes", "app_id=? and name=?", new String[]{str, str2});
        } catch (SQLiteException e) {
    ...
    public final boolean zza(zzky zzky) {
        ...
        try {
            if (mo31680c_().insertWithOnConflict("user_attributes", (String) null, contentValues, 5) == -1) {
    ...
    public final com.google.android.gms.measurement.internal.zzky zzc(java.lang.String r19, java.lang.String r20) {
        /*
            ...
            r18.zzaj()
            r9 = 0
            android.database.sqlite.SQLiteDatabase r10 = r18.mo31680c_()     // Catch:{ SQLiteException -> 0x0082, all -> 0x007e }
        ...
        L_0x0082:
            ...
            r10 = r9
        L_0x0086:
            com.google.android.gms.measurement.internal.zzex r1 = r18.zzq()     // Catch:{ all -> 0x00a5 }
            com.google.android.gms.measurement.internal.zzez r1 = r1.zze()     // Catch:{ all -> 0x00a5 }
            java.lang.String r2 = "Error querying user property. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r19)     // Catch:{ all -> 0x00a5 }
            com.google.android.gms.measurement.internal.zzev r4 = r18.zzn()     // Catch:{ all -> 0x00a5 }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzky> zza(java.lang.String r14) {
        /*
            ...
            r0.<init>()
            r1 = 0
            android.database.sqlite.SQLiteDatabase r2 = r13.mo31680c_()     // Catch:{ SQLiteException -> 0x0084, all -> 0x0082 }
        ...
        L_0x0084:
            ...
            r2 = r1
        L_0x0086:
            com.google.android.gms.measurement.internal.zzex r3 = r13.zzq()     // Catch:{ all -> 0x00b9 }
            com.google.android.gms.measurement.internal.zzez r3 = r3.zze()     // Catch:{ all -> 0x00b9 }
            java.lang.String r4 = "Error querying user properties. appId"
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r14)     // Catch:{ all -> 0x00b9 }
            r3.zza(r4, r5, r0)     // Catch:{ all -> 0x00b9 }
            boolean r0 = com.google.android.gms.internal.measurement.zzmy.zzb()     // Catch:{ all -> 0x00b9 }
            if (r0 == 0) goto L_0x00b3
            com.google.android.gms.measurement.internal.zzy r0 = r13.zzs()     // Catch:{ all -> 0x00b9 }
            com.google.android.gms.measurement.internal.zzem<java.lang.Boolean> r3 = com.google.android.gms.measurement.internal.zzat.zzcm     // Catch:{ all -> 0x00b9 }
    ...
    public final java.util.List<com.google.android.gms.measurement.internal.zzky> zza(java.lang.String r21, java.lang.String r22, java.lang.String r23) {
        ...
        L_0x004c:
            ...
            android.database.sqlite.SQLiteDatabase r11 = r20.mo31680c_()     // Catch:{ SQLiteException -> 0x00f7, all -> 0x00fb }
    ...
    public final boolean zza(zzw zzw) {
        ...
        try {
            if (mo31680c_().insertWithOnConflict("conditional_properties", (String) null, contentValues, 5) == -1) {
    ...
    public final com.google.android.gms.measurement.internal.zzw zzd(java.lang.String r30, java.lang.String r31) {
        /*
            ...
            r29.zzaj()
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r29.mo31680c_()     // Catch:{ SQLiteException -> 0x00fe, all -> 0x00fa }
        ...
        L_0x0063:
            ...
            com.google.android.gms.measurement.internal.zzkt r0 = r29.mo31916f_()     // Catch:{ SQLiteException -> 0x00f0 }
            r1 = 5
        ...
        L_0x00fe:
            ...
            r9 = r8
        L_0x0102:
            com.google.android.gms.measurement.internal.zzex r1 = r29.zzq()     // Catch:{ all -> 0x0121 }
            com.google.android.gms.measurement.internal.zzez r1 = r1.zze()     // Catch:{ all -> 0x0121 }
            java.lang.String r2 = "Error querying conditional property"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r30)     // Catch:{ all -> 0x0121 }
            com.google.android.gms.measurement.internal.zzev r4 = r29.zzn()     // Catch:{ all -> 0x0121 }
    ...
    public final int zze(String str, String str2) {
        ...
        zzaj();
        try {
            return mo31680c_().delete("conditional_properties", "app_id=? and name=?", new String[]{str, str2});
        } catch (SQLiteException e) {
        ...
        try {
            ...
            while (true) {
                if (arrayList.size() < 1000) {
                    ...
                    boolean z2 = z;
                    zzw zzw = r3;
                    zzw zzw2 = new zzw(string, string2, new zzkw(string3, j3, zza, string2), j2, z2, string4, (zzar) mo31916f_().zza(cursor.getBlob(7), zzar.CREATOR), j, (zzar) mo31916f_().zza(cursor.getBlob(9), zzar.CREATOR), cursor.getLong(11), (zzar) mo31916f_().zza(cursor.getBlob(12), zzar.CREATOR));
                    arrayList.add(zzw);
    ...
    public final com.google.android.gms.measurement.internal.zzf zzb(java.lang.String r35) {
        /*
            ...
            r34.zzaj()
            r2 = 0
            android.database.sqlite.SQLiteDatabase r3 = r34.mo31680c_()     // Catch:{ SQLiteException -> 0x020e, all -> 0x020a }
        ...
        L_0x020e:
            ...
            r3 = r2
        L_0x0212:
            com.google.android.gms.measurement.internal.zzex r4 = r34.zzq()     // Catch:{ all -> 0x0229 }
            com.google.android.gms.measurement.internal.zzez r4 = r4.zze()     // Catch:{ all -> 0x0229 }
            java.lang.String r6 = "Error querying app. appId"
            java.lang.Object r1 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r35)     // Catch:{ all -> 0x0229 }
    ...
    public final long zzc(String str) {
        ...
        zzaj();
        try {
            return (long) mo31680c_().delete("raw_events", "rowid in (select rowid from raw_events where app_id=? order by rowid desc limit -1 offset ?)", new String[]{str, String.valueOf(Math.max(0, Math.min(DurationKt.NANOS_IN_MILLIS, zzs().zzb(str, zzat.zzo))))});
        } catch (SQLiteException e) {
    ...
    public final byte[] zzd(java.lang.String r11) {
        /*
            ...
            r10.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r10.mo31680c_()     // Catch:{ SQLiteException -> 0x0056, all -> 0x0054 }
        ...
        L_0x0056:
            ...
            r1 = r0
        L_0x0058:
            com.google.android.gms.measurement.internal.zzex r3 = r10.zzq()     // Catch:{ all -> 0x006f }
            com.google.android.gms.measurement.internal.zzez r3 = r3.zze()     // Catch:{ all -> 0x006f }
            java.lang.String r4 = "Error querying remote config. appId"
            java.lang.Object r11 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r11)     // Catch:{ all -> 0x006f }
    ...
    public final boolean zza(zzcd.zzg zzg2, boolean z) {
        ...
        try {
            byte[] zzc2 = mo31916f_().zzc(zzg2.zzbk());
            ...
            try {
                if (mo31680c_().insert("queue", (String) null, contentValues) != -1) {
                    return true;
                }
                zzq().zze().zza("Failed to insert bundle (got -1). appId", zzex.zza(zzg2.zzx()));
                return false;
            } catch (SQLiteException e) {
                zzq().zze().zza("Error storing bundle. appId", zzex.zza(zzg2.zzx()), e);
                return false;
            }
        } catch (IOException e2) {
            zzq().zze().zza("Data loss. Failed to serialize bundle. appId", zzex.zza(zzg2.zzx()), e2);
            return false;
        }
    }
    ...
    /* renamed from: d_ */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.String mo31681d_() {
        /*
            r6 = this;
            android.database.sqlite.SQLiteDatabase r0 = r6.mo31680c_()
            r1 = 0
        ...
        L_0x0044:
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.zzac.mo31681d_():java.lang.String");
    }

    /* renamed from: e_ */
    public final boolean mo31682e_() {
    ...
    public final List<Pair<zzcd.zzg, Long>> zza(String str, int i, int i2) {
        ...
        Cursor cursor = null;
        try {
            cursor = mo31680c_().query("queue", new String[]{"rowid", "data", "retry_count"}, "app_id=?", new String[]{str}, (String) null, (String) null, "rowid", String.valueOf(i));
            if (!cursor.moveToFirst()) {
            ...
            do {
                long j = cursor.getLong(0);
                try {
                    byte[] zzb2 = mo31916f_().zzb(cursor.getBlob(1));
                    if (!arrayList.isEmpty() && zzb2.length + i3 > i2) {
                        break;
                    }
                    try {
                        zzcd.zzg.zza zza = (zzcd.zzg.zza) zzkt.zza(zzcd.zzg.zzbh(), zzb2);
                        if (!cursor.isNull(2)) {
                            zza.zzi(cursor.getInt(2));
                        }
                        i3 += zzb2.length;
                        arrayList.add(Pair.create((zzcd.zzg) ((zzhv) zza.zzy()), Long.valueOf(j)));
                    } catch (IOException e) {
                        zzq().zze().zza("Failed to merge queued bundle. appId", zzex.zza(str), e);
                    }
                    if (!cursor.moveToNext()) {
                        break;
                    }
                } catch (IOException e2) {
                    zzq().zze().zza("Failed to unzip queued bundle. appId", zzex.zza(str), e2);
                }
            } while (i3 <= i2);
            if (cursor != null) {
                cursor.close();
    ...
    public final void zzu() {
        ...
        if (zzal()) {
            ...
            if (Math.abs(elapsedRealtime - zza) > zzat.zzx.zza(null).longValue()) {
                ...
                zzc();
                zzaj();
                if (zzal() && (delete = mo31680c_().delete("queue", "abs(bundle_end_timestamp - ?) > cast(? as integer)", new String[]{String.valueOf(zzl().currentTimeMillis()), String.valueOf(zzy.zzi())})) > 0) {
    ...
    private final boolean zza(String str, int i, zzbv.zzb zzb2) {
        ...
        try {
            if (mo31680c_().insertWithOnConflict("event_filters", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    private final boolean zza(String str, int i, zzbv.zze zze2) {
        ...
        contentValues.put("data", zzbk);
        try {
            if (mo31680c_().insertWithOnConflict("property_filters", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<com.google.android.gms.internal.measurement.zzbv.zzb>> zzf(java.lang.String r13, java.lang.String r14) {
        /*
            ...
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r1 = r12.mo31680c_()
            r9 = 0
        ...
        L_0x009a:
            ...
            r14 = r9
        L_0x009c:
            com.google.android.gms.measurement.internal.zzex r1 = r12.zzq()     // Catch:{ all -> 0x00cf }
            com.google.android.gms.measurement.internal.zzez r1 = r1.zze()     // Catch:{ all -> 0x00cf }
            java.lang.String r2 = "Database error querying filters. appId"
            java.lang.Object r3 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r13)     // Catch:{ all -> 0x00cf }
            r1.zza(r2, r3, r0)     // Catch:{ all -> 0x00cf }
            boolean r0 = com.google.android.gms.internal.measurement.zzmy.zzb()     // Catch:{ all -> 0x00cf }
            if (r0 == 0) goto L_0x00c9
            com.google.android.gms.measurement.internal.zzy r0 = r12.zzs()     // Catch:{ all -> 0x00cf }
            com.google.android.gms.measurement.internal.zzem<java.lang.Boolean> r1 = com.google.android.gms.measurement.internal.zzat.zzcm     // Catch:{ all -> 0x00cf }
    ...
    public final Map<Integer, List<zzbv.zzb>> zze(String str) {
        ...
        Cursor cursor = null;
        try {
            cursor = mo31680c_().query("event_filters", new String[]{"audience_id", "data"}, "app_id=?", new String[]{str}, (String) null, (String) null, (String) null);
            if (!cursor.moveToFirst()) {
    ...
    public final java.util.Map<java.lang.Integer, java.util.List<java.lang.Integer>> zzf(java.lang.String r8) {
        /*
            ...
            androidx.collection.ArrayMap r0 = new androidx.collection.ArrayMap
            r0.<init>()
            android.database.sqlite.SQLiteDatabase r1 = r7.mo31680c_()
            r2 = 0
        ...
        L_0x0069:
            ...
            r1 = r2
        L_0x006b:
            com.google.android.gms.measurement.internal.zzex r3 = r7.zzq()     // Catch:{ all -> 0x009e }
            com.google.android.gms.measurement.internal.zzez r3 = r3.zze()     // Catch:{ all -> 0x009e }
            java.lang.String r4 = "Database error querying scoped filters. appId"
            java.lang.Object r5 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r8)     // Catch:{ all -> 0x009e }
            r3.zza(r4, r5, r0)     // Catch:{ all -> 0x009e }
            boolean r0 = com.google.android.gms.internal.measurement.zzmy.zzb()     // Catch:{ all -> 0x009e }
            if (r0 == 0) goto L_0x0098
            com.google.android.gms.measurement.internal.zzy r0 = r7.zzs()     // Catch:{ all -> 0x009e }
            com.google.android.gms.measurement.internal.zzem<java.lang.Boolean> r3 = com.google.android.gms.measurement.internal.zzat.zzcm     // Catch:{ all -> 0x009e }
    ...
    public final java.util.Map<java.lang.Integer, com.google.android.gms.internal.measurement.zzcd.zzi> zzg(java.lang.String r12) {
        /*
            ...
            android.database.sqlite.SQLiteDatabase r0 = r11.mo31680c_()
            r8 = 0
        ...
        L_0x009c:
            ...
            r0 = r8
        L_0x009e:
            com.google.android.gms.measurement.internal.zzex r2 = r11.zzq()     // Catch:{ all -> 0x00d1 }
            com.google.android.gms.measurement.internal.zzez r2 = r2.zze()     // Catch:{ all -> 0x00d1 }
            java.lang.String r3 = "Database error querying filter results. appId"
            java.lang.Object r4 = com.google.android.gms.measurement.internal.zzex.zza((java.lang.String) r12)     // Catch:{ all -> 0x00d1 }
            r2.zza(r3, r4, r1)     // Catch:{ all -> 0x00d1 }
            boolean r1 = com.google.android.gms.internal.measurement.zzmy.zzb()     // Catch:{ all -> 0x00d1 }
            if (r1 == 0) goto L_0x00cb
            com.google.android.gms.measurement.internal.zzy r1 = r11.zzs()     // Catch:{ all -> 0x00d1 }
            com.google.android.gms.measurement.internal.zzem<java.lang.Boolean> r2 = com.google.android.gms.measurement.internal.zzat.zzcm     // Catch:{ all -> 0x00d1 }
        ...
        try {
            ...
            try {
                ...
                if (zza == -1) {
                    ...
                    if (c_.insertWithOnConflict("app2", (String) null, contentValues, 5) == -1) {
                        zzq().zze().zza("Failed to insert column (got -1). appId", zzex.zza(str), str4);
                        c_.endTransaction();
                        return -1;
                    }
                    zza = 0;
                ...
                e = e;
                try {
                    zzq().zze().zza("Error inserting column. appId", zzex.zza(str), str4, e);
                    c_.endTransaction();
                    return j;
                } catch (Throwable th) {
                    th = th;
            ...
            try {
                ...
                if (((long) c_.update("app2", contentValues2, "app_id = ?", new String[]{str3})) == 0) {
                    zzq().zze().zza("Failed to update column (got 0). appId", zzex.zza(str), str4);
                    c_.endTransaction();
                    return -1;
                }
    ...
    public final long zza(zzcd.zzg zzg2) throws IOException {
        ...
        Preconditions.checkNotEmpty(zzg2.zzx());
        byte[] zzbk = zzg2.zzbk();
        long zza = mo31916f_().zza(zzbk);
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", zzg2.zzx());
        contentValues.put("metadata_fingerprint", Long.valueOf(zza));
        contentValues.put("metadata", zzbk);
        try {
            mo31680c_().insertWithOnConflict("raw_events_metadata", (String) null, contentValues, 4);
            return zza;
        } catch (SQLiteException e) {
    ...
    public final java.lang.String zza(long r5) {
        /*
            ...
            r4.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r4.mo31680c_()     // Catch:{ SQLiteException -> 0x0042, all -> 0x0040 }
        ...
        L_0x0042:
            ...
            r5 = r0
        L_0x0044:
            com.google.android.gms.measurement.internal.zzex r1 = r4.zzq()     // Catch:{ all -> 0x0057 }
            com.google.android.gms.measurement.internal.zzez r1 = r1.zze()     // Catch:{ all -> 0x0057 }
    ...
    public final long zzz() {
        Cursor cursor = null;
        try {
            cursor = mo31680c_().rawQuery("select rowid from raw_events order by rowid desc limit 1;", (String[]) null);
            if (!cursor.moveToFirst()) {
                if (cursor != null) {
                    cursor.close();
                }
    ...
    public final android.util.Pair<com.google.android.gms.internal.measurement.zzcd.zzc, java.lang.Long> zza(java.lang.String r8, java.lang.Long r9) {
        /*
            ...
            r7.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.mo31680c_()     // Catch:{ SQLiteException -> 0x007b, all -> 0x0079 }
        ...
        L_0x007b:
            ...
            r1 = r0
        L_0x007d:
            com.google.android.gms.measurement.internal.zzex r9 = r7.zzq()     // Catch:{ all -> 0x0090 }
            com.google.android.gms.measurement.internal.zzez r9 = r9.zze()     // Catch:{ all -> 0x0090 }
    ...
    public final boolean zza(String str, Long l, long j, zzcd.zzc zzc2) {
        ...
        try {
            if (mo31680c_().insertWithOnConflict("main_event_params", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final boolean zza(String str, Bundle bundle) {
        zzc();
        zzaj();
        byte[] zzbk = mo31916f_().zza(new zzak(this.zzy, "", str, "dep", 0, 0, bundle)).zzbk();
        ...
        try {
            if (mo31680c_().insertWithOnConflict("default_event_params", (String) null, contentValues, 5) != -1) {
                return true;
            }
    ...
    public final android.os.Bundle zzi(java.lang.String r8) {
        /*
            ...
            r7.zzaj()
            r0 = 0
            android.database.sqlite.SQLiteDatabase r1 = r7.mo31680c_()     // Catch:{ SQLiteException -> 0x00c0, all -> 0x00be }
        ...
        L_0x0030:
            ...
            r7.mo31916f_()     // Catch:{ SQLiteException -> 0x00bc }
        ...
        L_0x00c0:
            ...
            r1 = r0
        L_0x00c2:
            com.google.android.gms.measurement.internal.zzex r2 = r7.zzq()     // Catch:{ all -> 0x00d5 }
            com.google.android.gms.measurement.internal.zzez r2 = r2.zze()     // Catch:{ all -> 0x00d5 }
    ...
    public final boolean zza(zzak zzak, long j, boolean z) {
        ...
        byte[] zzbk = mo31916f_().zza(zzak).zzbk();
        ContentValues contentValues = new ContentValues();
        ...
        try {
            if (mo31680c_().insert("raw_events", (String) null, contentValues) != -1) {
                return true;
            }
    ...
    public final void zza(String str, List<zzbv.zza> list) {
        ...
        Preconditions.checkNotNull(list);
        for (int i = 0; i < list.size(); i++) {
            zzbv.zza.C15661zza zza = (zzbv.zza.C15661zza) list2.get(i).zzbo();
            if (zza.zzb() != 0) {
                for (int i2 = 0; i2 < zza.zzb(); i2++) {
                    zzbv.zzb.zza zza2 = (zzbv.zzb.zza) zza.zzb(i2).zzbo();
                    zzbv.zzb.zza zza3 = (zzbv.zzb.zza) ((zzhv.zzb) zza2.clone());
                    ...
                    for (int i3 = 0; i3 < zza2.zzb(); i3++) {
                        ...
                        String zza5 = zzhb.zza(zza4.zzh());
                        if (zza5 != null) {
                            zza3.zza(i3, (zzbv.zzc) ((zzhv) ((zzbv.zzc.zza) zza4.zzbo()).zza(zza5).zzy()));
                            z2 = true;
                        }
                    }
                    if (z2) {
                        zza = zza.zza(i2, zza3);
                        list2.set(i, (zzbv.zza) ((zzhv) zza.zzy()));
                    }
                }
            }
            if (zza.zza() != 0) {
