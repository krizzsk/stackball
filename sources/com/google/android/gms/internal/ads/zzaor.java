...
public final class zzaor extends zzapb {
    private static final Set<String> zzdik = CollectionUtils.setOf("top-left", C5073cj.DEFAULT_POSITION, "top-center", "center", "bottom-left", "bottom-right", "bottom-center");
    ...
    private String zzdil = C5073cj.DEFAULT_POSITION;
    ...
    public zzaor(zzbek zzbek, zzapa zzapa) {
        super(zzbek, MraidJsMethods.RESIZE);
        this.zzdce = zzbek;
    ...
    public final void zzg(java.util.Map<java.lang.String, java.lang.String> r17) {
        /*
            ...
            monitor-enter(r2)
            android.app.Activity r3 = r1.zzdia     // Catch:{ all -> 0x04bb }
            if (r3 != 0) goto L_0x0012
            java.lang.String r0 = "Not an activity context. Cannot resize."
            r1.zzdv(r0)     // Catch:{ all -> 0x04bb }
            monitor-exit(r2)     // Catch:{ all -> 0x04bb }
            return
        L_0x0012:
            com.google.android.gms.internal.ads.zzbek r3 = r1.zzdce     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbfz r3 = r3.zzabh()     // Catch:{ all -> 0x04bb }
        ...
        L_0x0021:
            com.google.android.gms.internal.ads.zzbek r3 = r1.zzdce     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbfz r3 = r3.zzabh()     // Catch:{ all -> 0x04bb }
            boolean r3 = r3.zzaco()     // Catch:{ all -> 0x04bb }
        ...
        L_0x0034:
            com.google.android.gms.internal.ads.zzbek r3 = r1.zzdce     // Catch:{ all -> 0x04bb }
            boolean r3 = r3.zzabo()     // Catch:{ all -> 0x04bb }
        ...
        L_0x0043:
            ...
            int r3 = com.google.android.gms.internal.ads.zzaxa.zzel(r3)     // Catch:{ all -> 0x04bb }
        ...
        L_0x00f8:
            ...
            return
        L_0x0101:
            android.app.Activity r0 = r1.zzdia     // Catch:{ all -> 0x04bb }
            ...
            goto L_0x04b4
        L_0x0111:
            com.google.android.gms.internal.ads.zzaxa r5 = com.google.android.gms.ads.internal.zzq.zzkw()     // Catch:{ all -> 0x04bb }
            android.app.Activity r6 = r1.zzdia     // Catch:{ all -> 0x04bb }
            int[] r5 = r5.zze((android.app.Activity) r6)     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzaxa r6 = com.google.android.gms.ads.internal.zzq.zzkw()     // Catch:{ all -> 0x04bb }
            android.app.Activity r7 = r1.zzdia     // Catch:{ all -> 0x04bb }
        ...
        L_0x0144:
            ...
            com.google.android.gms.internal.ads.zzawr.zzfc(r5)     // Catch:{ all -> 0x04bb }
            goto L_0x0238
        L_0x0153:
            boolean r5 = r1.zzdim     // Catch:{ all -> 0x04bb }
            if (r5 == 0) goto L_0x022b
            java.lang.String r5 = r1.zzdil     // Catch:{ all -> 0x04bb }
        ...
        L_0x019e:
            ...
            int r5 = r1.zzdin     // Catch:{ all -> 0x04bb }
            int r8 = r1.zzdip     // Catch:{ all -> 0x04bb }
            int r5 = r5 + r8
            int r8 = r1.width     // Catch:{ all -> 0x04bb }
            int r5 = r5 + r8
            int r5 = r5 - r14
            int r8 = r1.zzdio     // Catch:{ all -> 0x04bb }
            int r15 = r1.zzdiq     // Catch:{ all -> 0x04bb }
            goto L_0x021b
        L_0x01b8:
            int r5 = r1.zzdin     // Catch:{ all -> 0x04bb }
            int r8 = r1.zzdip     // Catch:{ all -> 0x04bb }
        ...
        L_0x023d:
            ...
            int r6 = r1.zzdin     // Catch:{ all -> 0x04bb }
            int r7 = r1.zzdip     // Catch:{ all -> 0x04bb }
            int r6 = r6 + r7
            r5[r4] = r6     // Catch:{ all -> 0x04bb }
            int r6 = r1.zzdio     // Catch:{ all -> 0x04bb }
            int r7 = r1.zzdiq     // Catch:{ all -> 0x04bb }
            int r6 = r6 + r7
        ...
        L_0x0252:
            ...
            int r7 = r1.zzdin     // Catch:{ all -> 0x04bb }
            int r8 = r1.zzdip     // Catch:{ all -> 0x04bb }
            int r7 = r7 + r8
            int r8 = r1.zzdio     // Catch:{ all -> 0x04bb }
            int r15 = r1.zzdiq     // Catch:{ all -> 0x04bb }
        ...
        L_0x0299:
            ...
            return
        L_0x02a2:
            com.google.android.gms.internal.ads.zzvj.zzpr()     // Catch:{ all -> 0x04bb }
            android.app.Activity r6 = r1.zzdia     // Catch:{ all -> 0x04bb }
            int r7 = r1.width     // Catch:{ all -> 0x04bb }
            int r6 = com.google.android.gms.internal.ads.zzazm.zzc(r6, r7)     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzvj.zzpr()     // Catch:{ all -> 0x04bb }
            android.app.Activity r7 = r1.zzdia     // Catch:{ all -> 0x04bb }
            int r8 = r1.height     // Catch:{ all -> 0x04bb }
            int r7 = com.google.android.gms.internal.ads.zzazm.zzc(r7, r8)     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbek r8 = r1.zzdce     // Catch:{ all -> 0x04bb }
            ...
            com.google.android.gms.internal.ads.zzbek r9 = r1.zzdce     // Catch:{ all -> 0x04bb }
            android.view.View r9 = r9.getView()     // Catch:{ all -> 0x04bb }
            r15.removeView(r9)     // Catch:{ all -> 0x04bb }
            android.widget.PopupWindow r9 = r1.zzdiu     // Catch:{ all -> 0x04bb }
            if (r9 != 0) goto L_0x0305
            android.view.ViewGroup r8 = (android.view.ViewGroup) r8     // Catch:{ all -> 0x04bb }
            r1.zzdiw = r8     // Catch:{ all -> 0x04bb }
            com.google.android.gms.ads.internal.zzq.zzkw()     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbek r8 = r1.zzdce     // Catch:{ all -> 0x04bb }
            android.view.View r8 = r8.getView()     // Catch:{ all -> 0x04bb }
            android.graphics.Bitmap r8 = com.google.android.gms.internal.ads.zzaxa.zzm(r8)     // Catch:{ all -> 0x04bb }
            android.widget.ImageView r9 = new android.widget.ImageView     // Catch:{ all -> 0x04bb }
            android.app.Activity r15 = r1.zzdia     // Catch:{ all -> 0x04bb }
            r9.<init>(r15)     // Catch:{ all -> 0x04bb }
            r1.zzdis = r9     // Catch:{ all -> 0x04bb }
            r9.setImageBitmap(r8)     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbek r8 = r1.zzdce     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbfz r8 = r8.zzabh()     // Catch:{ all -> 0x04bb }
            r1.zzdir = r8     // Catch:{ all -> 0x04bb }
            android.view.ViewGroup r8 = r1.zzdiw     // Catch:{ all -> 0x04bb }
            android.widget.ImageView r9 = r1.zzdis     // Catch:{ all -> 0x04bb }
            r8.addView(r9)     // Catch:{ all -> 0x04bb }
            goto L_0x030a
        L_0x0305:
            android.widget.PopupWindow r8 = r1.zzdiu     // Catch:{ all -> 0x04bb }
            r8.dismiss()     // Catch:{ all -> 0x04bb }
        L_0x030a:
            android.widget.RelativeLayout r8 = new android.widget.RelativeLayout     // Catch:{ all -> 0x04bb }
            android.app.Activity r9 = r1.zzdia     // Catch:{ all -> 0x04bb }
            r8.<init>(r9)     // Catch:{ all -> 0x04bb }
            r1.zzdiv = r8     // Catch:{ all -> 0x04bb }
            r8.setBackgroundColor(r4)     // Catch:{ all -> 0x04bb }
            android.widget.RelativeLayout r8 = r1.zzdiv     // Catch:{ all -> 0x04bb }
            ...
            com.google.android.gms.ads.internal.zzq.zzkw()     // Catch:{ all -> 0x04bb }
            android.widget.RelativeLayout r8 = r1.zzdiv     // Catch:{ all -> 0x04bb }
            android.widget.PopupWindow r8 = com.google.android.gms.internal.ads.zzaxa.zza((android.view.View) r8, (int) r6, (int) r7, (boolean) r4)     // Catch:{ all -> 0x04bb }
            r1.zzdiu = r8     // Catch:{ all -> 0x04bb }
            r8.setOutsideTouchable(r3)     // Catch:{ all -> 0x04bb }
            android.widget.PopupWindow r8 = r1.zzdiu     // Catch:{ all -> 0x04bb }
            r8.setTouchable(r3)     // Catch:{ all -> 0x04bb }
            android.widget.PopupWindow r8 = r1.zzdiu     // Catch:{ all -> 0x04bb }
            boolean r9 = r1.zzdim     // Catch:{ all -> 0x04bb }
        ...
        L_0x033c:
            ...
            android.app.Activity r9 = r1.zzdia     // Catch:{ all -> 0x04bb }
            r8.<init>(r9)     // Catch:{ all -> 0x04bb }
            r1.zzdit = r8     // Catch:{ all -> 0x04bb }
            android.widget.RelativeLayout$LayoutParams r8 = new android.widget.RelativeLayout$LayoutParams     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzvj.zzpr()     // Catch:{ all -> 0x04bb }
            android.app.Activity r9 = r1.zzdia     // Catch:{ all -> 0x04bb }
            int r9 = com.google.android.gms.internal.ads.zzazm.zzc(r9, r14)     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzvj.zzpr()     // Catch:{ all -> 0x04bb }
            android.app.Activity r15 = r1.zzdia     // Catch:{ all -> 0x04bb }
            int r14 = com.google.android.gms.internal.ads.zzazm.zzc(r15, r14)     // Catch:{ all -> 0x04bb }
            r8.<init>(r9, r14)     // Catch:{ all -> 0x04bb }
            java.lang.String r9 = r1.zzdil     // Catch:{ all -> 0x04bb }
        ...
        L_0x03ef:
            ...
            r8.addRule(r9)     // Catch:{ all -> 0x04bb }
        L_0x03f5:
            android.widget.LinearLayout r9 = r1.zzdit     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzaoq r10 = new com.google.android.gms.internal.ads.zzaoq     // Catch:{ all -> 0x04bb }
            ...
            android.widget.RelativeLayout r9 = r1.zzdiv     // Catch:{ all -> 0x04bb }
            android.widget.LinearLayout r10 = r1.zzdit     // Catch:{ all -> 0x04bb }
            r9.addView(r10, r8)     // Catch:{ all -> 0x04bb }
            android.widget.PopupWindow r8 = r1.zzdiu     // Catch:{ RuntimeException -> 0x0465 }
            android.view.View r0 = r0.getDecorView()     // Catch:{ RuntimeException -> 0x0465 }
            com.google.android.gms.internal.ads.zzvj.zzpr()     // Catch:{ RuntimeException -> 0x0465 }
            android.app.Activity r9 = r1.zzdia     // Catch:{ RuntimeException -> 0x0465 }
            r10 = r5[r4]     // Catch:{ RuntimeException -> 0x0465 }
            int r9 = com.google.android.gms.internal.ads.zzazm.zzc(r9, r10)     // Catch:{ RuntimeException -> 0x0465 }
            com.google.android.gms.internal.ads.zzvj.zzpr()     // Catch:{ RuntimeException -> 0x0465 }
            android.app.Activity r10 = r1.zzdia     // Catch:{ RuntimeException -> 0x0465 }
            r11 = r5[r3]     // Catch:{ RuntimeException -> 0x0465 }
            int r10 = com.google.android.gms.internal.ads.zzazm.zzc(r10, r11)     // Catch:{ RuntimeException -> 0x0465 }
            r8.showAtLocation(r0, r4, r9, r10)     // Catch:{ RuntimeException -> 0x0465 }
            r0 = r5[r4]     // Catch:{ all -> 0x04bb }
            r8 = r5[r3]     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzapa r9 = r1.zzdau     // Catch:{ all -> 0x04bb }
            if (r9 == 0) goto L_0x043d
            com.google.android.gms.internal.ads.zzapa r9 = r1.zzdau     // Catch:{ all -> 0x04bb }
            int r10 = r1.width     // Catch:{ all -> 0x04bb }
            int r11 = r1.height     // Catch:{ all -> 0x04bb }
            r9.zza(r0, r8, r10, r11)     // Catch:{ all -> 0x04bb }
        L_0x043d:
            com.google.android.gms.internal.ads.zzbek r0 = r1.zzdce     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbfz r6 = com.google.android.gms.internal.ads.zzbfz.zzq(r6, r7)     // Catch:{ all -> 0x04bb }
            r0.zza((com.google.android.gms.internal.ads.zzbfz) r6)     // Catch:{ all -> 0x04bb }
            r0 = r5[r4]     // Catch:{ all -> 0x04bb }
            ...
            int r5 = r1.height     // Catch:{ all -> 0x04bb }
            r1.zzb(r0, r3, r4, r5)     // Catch:{ all -> 0x04bb }
        ...
        L_0x0480:
            r1.zzdv(r0)     // Catch:{ all -> 0x04bb }
            android.widget.RelativeLayout r0 = r1.zzdiv     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbek r3 = r1.zzdce     // Catch:{ all -> 0x04bb }
            android.view.View r3 = r3.getView()     // Catch:{ all -> 0x04bb }
            r0.removeView(r3)     // Catch:{ all -> 0x04bb }
            android.view.ViewGroup r0 = r1.zzdiw     // Catch:{ all -> 0x04bb }
            if (r0 == 0) goto L_0x04ab
            android.view.ViewGroup r0 = r1.zzdiw     // Catch:{ all -> 0x04bb }
            android.widget.ImageView r3 = r1.zzdis     // Catch:{ all -> 0x04bb }
            r0.removeView(r3)     // Catch:{ all -> 0x04bb }
            android.view.ViewGroup r0 = r1.zzdiw     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbek r3 = r1.zzdce     // Catch:{ all -> 0x04bb }
            android.view.View r3 = r3.getView()     // Catch:{ all -> 0x04bb }
            ...
            com.google.android.gms.internal.ads.zzbek r0 = r1.zzdce     // Catch:{ all -> 0x04bb }
            com.google.android.gms.internal.ads.zzbfz r3 = r1.zzdir     // Catch:{ all -> 0x04bb }
            r0.zza((com.google.android.gms.internal.ads.zzbfz) r3)     // Catch:{ all -> 0x04bb }
        L_0x04ab:
            monitor-exit(r2)     // Catch:{ all -> 0x04bb }
            return
        L_0x04ad:
