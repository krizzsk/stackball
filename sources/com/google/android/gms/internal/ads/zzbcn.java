...
final class zzbcn implements zznu {
    ...
    public final long zza(com.google.android.gms.internal.ads.zznv r24) throws com.google.android.gms.internal.ads.zzoa {
        /*
            ...
            byte[] r7 = r2.zzbfm     // Catch:{ IOException -> 0x0248 }
            long r8 = r2.position     // Catch:{ IOException -> 0x0248 }
            long r10 = r2.zzce     // Catch:{ IOException -> 0x0248 }
        ...
        L_0x0025:
            ...
            javax.net.ssl.SSLSocketFactory r6 = r1.zzefb     // Catch:{ IOException -> 0x0248 }
            r13.setSSLSocketFactory(r6)     // Catch:{ IOException -> 0x0248 }
        L_0x003d:
            int r6 = r1.zzbfr     // Catch:{ IOException -> 0x0248 }
            r14.setConnectTimeout(r6)     // Catch:{ IOException -> 0x0248 }
            int r6 = r1.zzbfs     // Catch:{ IOException -> 0x0248 }
            r14.setReadTimeout(r6)     // Catch:{ IOException -> 0x0248 }
            com.google.android.gms.internal.ads.zzoc r6 = r1.zzbfw     // Catch:{ IOException -> 0x0248 }
            java.util.Map r6 = r6.zzis()     // Catch:{ IOException -> 0x0248 }
        ...
        L_0x00d0:
            ...
            java.lang.String r5 = r1.zzbft     // Catch:{ IOException -> 0x0248 }
            r14.setRequestProperty(r4, r5)     // Catch:{ IOException -> 0x0248 }
        ...
        L_0x010b:
            ...
            goto L_0x01da
        L_0x012b:
            r1.zzbfz = r14     // Catch:{ IOException -> 0x0248 }
        ...
        L_0x0173:
            ...
            r1.zzbgd = r3
        L_0x0177:
            java.net.HttpURLConnection r0 = r1.zzbfz     // Catch:{ IOException -> 0x018c }
            java.io.InputStream r0 = r0.getInputStream()     // Catch:{ IOException -> 0x018c }
            r1.zzbga = r0     // Catch:{ IOException -> 0x018c }
            r3 = 1
            r1.zzbgb = r3
    ...
    private static long zzc(java.net.HttpURLConnection r9) {
        ...
        L_0x006c:
            ...
            com.google.android.gms.internal.ads.zzawr.zzfc(r0)     // Catch:{ NumberFormatException -> 0x00a8 }
