...
public final class zzrg extends zzqv {
    ...
    public final byte[] zzbr(java.lang.String r10) {
        /*
            r9 = this;
            java.lang.Object r0 = r9.mLock
            monitor-enter(r0)
            java.security.MessageDigest r1 = r9.zzmm()     // Catch:{ all -> 0x0067 }
            r9.zzbrp = r1     // Catch:{ all -> 0x0067 }
            r2 = 0
        ...
        L_0x0010:
            ...
            java.security.MessageDigest r1 = r9.zzbrp     // Catch:{ all -> 0x0067 }
            ...
            java.security.MessageDigest r10 = r9.zzbrp     // Catch:{ all -> 0x0067 }
            byte[] r10 = r10.digest()     // Catch:{ all -> 0x0067 }
            int r1 = r10.length     // Catch:{ all -> 0x0067 }
            int r3 = r9.zzbrw     // Catch:{ all -> 0x0067 }
            if (r1 <= r3) goto L_0x0030
            int r1 = r9.zzbrw     // Catch:{ all -> 0x0067 }
            goto L_0x0031
        L_0x0030:
            int r1 = r10.length     // Catch:{ all -> 0x0067 }
        L_0x0031:
            ...
            int r10 = r9.zzbrx     // Catch:{ all -> 0x0067 }
            r4 = 8
            int r10 = r10 % r4
        ...
        L_0x004d:
            ...
            int r10 = 8 - r10
            long r1 = r5 >>> r10
            int r10 = r9.zzbrw     // Catch:{ all -> 0x0067 }
            int r10 = r10 + -1
        L_0x0058:
            if (r10 < 0) goto L_0x0065
        ...
        L_0x0067:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzrg.zzbr(java.lang.String):byte[]");
    }
}
