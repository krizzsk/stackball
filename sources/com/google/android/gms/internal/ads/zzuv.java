...
import com.google.android.gms.ads.C3893R;
...
public final class zzuv {
    ...
    public zzuv(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C3893R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C3893R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C3893R.styleable.AdsAttrs_adSizes);
        ...
        String string3 = obtainAttributes.getString(C3893R.styleable.AdsAttrs_adUnitId);
        this.zzbsc = string3;
