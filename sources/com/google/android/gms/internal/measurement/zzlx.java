...
public final class zzlx implements zzly {
    ...
    static {
        ...
        zza = zzdl.zza("measurement.ad_id_cache_time", (long) TapjoyConstants.TIMER_INCREMENT);
        ...
        zzn = zzdl.zza("measurement.upload.realtime_upload_interval", (long) TapjoyConstants.TIMER_INCREMENT);
        ...
        zzu = zzdl.zza("measurement.upload.initial_upload_delay_time", (long) MBInterstitialActivity.WEB_LOAD_TIME);
        ...
        zzah = zzdl.zza("measurement.upload.retry_time", (long) TapjoyConstants.SESSION_ID_INACTIVITY_TIME);
