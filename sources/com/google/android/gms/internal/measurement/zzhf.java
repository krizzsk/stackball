...
public abstract class zzhf extends zzgn {
    ...
    public abstract void zza(int i, zzjg zzjg, zzjv zzjv) throws IOException;
    ...
    static class zzb extends zzhf {
        ...
        /* access modifiers changed from: package-private */
        public final void zza(int i, zzjg zzjg, zzjv zzjv) throws IOException {
            zza(i, 2);
            zzgd zzgd = (zzgd) zzjg;
            int zzbl = zzgd.zzbl();
            if (zzbl == -1) {
        ...
        public final void zzb(int i) throws IOException {
            if (!zzhf.zzc || zzgj.zza() || zza() < 5) {
                ...
                if ((i6 & -128) == 0) {
                    ...
                    int i7 = this.zze;
                    this.zze = i7 + 1;
                    zzkt.zza(bArr5, (long) i7, (byte) i6);
                    return;
                }
                byte[] bArr6 = this.zzb;
                int i8 = this.zze;
                this.zze = i8 + 1;
                zzkt.zza(bArr6, (long) i8, (byte) (i6 | 128));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                    byte[] bArr7 = this.zzb;
                    int i10 = this.zze;
                    this.zze = i10 + 1;
                    zzkt.zza(bArr7, (long) i10, (byte) i9);
                    return;
                }
                byte[] bArr8 = this.zzb;
                int i11 = this.zze;
                this.zze = i11 + 1;
                zzkt.zza(bArr8, (long) i11, (byte) (i9 | 128));
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                    byte[] bArr9 = this.zzb;
                    int i13 = this.zze;
                    this.zze = i13 + 1;
                    zzkt.zza(bArr9, (long) i13, (byte) i12);
                    return;
                }
                byte[] bArr10 = this.zzb;
                int i14 = this.zze;
                this.zze = i14 + 1;
                zzkt.zza(bArr10, (long) i14, (byte) (i12 | 128));
                byte[] bArr11 = this.zzb;
                int i15 = this.zze;
                this.zze = i15 + 1;
                zzkt.zza(bArr11, (long) i15, (byte) (i12 >>> 7));
            }
        }
        ...
        public final void zza(long j) throws IOException {
            if (!zzhf.zzc || zza() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.zze;
                    this.zze = i3 + 1;
                    zzkt.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.zzb;
                int i4 = this.zze;
    ...
    /* access modifiers changed from: package-private */
    public final void zza(String str, zzkz zzkz) throws IOException {
