...
final class zzgi {
    ...
    static int zzc(byte[] bArr, int i, zzgl zzgl) throws zzig {
    ...
    static int zzd(byte[] bArr, int i, zzgl zzgl) throws zzig {
        int zza = zza(bArr, i, zzgl);
        int i2 = zzgl.zza;
        if (i2 < 0) {
            throw zzig.zzb();
    ...
    static int zze(byte[] bArr, int i, zzgl zzgl) throws zzig {
        int zza = zza(bArr, i, zzgl);
        int i2 = zzgl.zza;
        if (i2 < 0) {
            throw zzig.zzb();
    ...
    static int zza(com.google.android.gms.internal.measurement.zzjv r6, byte[] r7, int r8, int r9, com.google.android.gms.internal.measurement.zzgl r10) throws java.io.IOException {
        /*
            int r0 = r8 + 1
            byte r8 = r7[r8]
    ...
    static int zza(zzjv zzjv, byte[] bArr, int i, int i2, int i3, zzgl zzgl) throws IOException {
        zzjk zzjk = (zzjk) zzjv;
        Object zza = zzjk.zza();
    ...
    static int zza(byte[] bArr, int i, zzid<?> zzid, zzgl zzgl) throws IOException {
        zzhy zzhy = (zzhy) zzid;
        int zza = zza(bArr, i, zzgl);
        int i2 = zzgl.zza + zza;
        while (zza < i2) {
    ...
    static int zza(zzjv<?> zzjv, int i, byte[] bArr, int i2, int i3, zzid<?> zzid, zzgl zzgl) throws IOException {
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzkq zzkq, zzgl zzgl) throws zzig {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
                ...
                if (i5 < 0) {
                    ...
                    if (i5 == 0) {
                        zzkq.zza(i, (Object) zzgm.zza);
                    } else {
                        zzkq.zza(i, (Object) zzgm.zza(bArr, zza, i5));
                    }
                    return zza + i5;
                } else {
                    throw zzig.zza();
                ...
                while (true) {
                    ...
                    int zza3 = zza(i7, bArr, zza2, i3, zzb2, zzgl);
                    i7 = i8;
                    i2 = zza3;
                }
                if (i2 > i3 || i7 != i6) {
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzgl zzgl) throws zzig {
        if ((i >>> 3) != 0) {
            int i4 = i & 7;
            if (i4 == 0) {
