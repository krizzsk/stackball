...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f10196FS = '\u001c';

    /* renamed from: GS */
    private static final char f10197GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f10198NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f10199RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f10197GS + format + f10197GS + format2 + f10197GS);
            } else {
                sb.insert(0, str + f10197GS + format + f10197GS + format2 + f10197GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f10112US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f10101EM, Ascii.SUB, Ascii.ESC, Ascii.f10103FS, Ascii.f10104GS, Ascii.f10108RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f10100CR, Ascii.f10110SO, Ascii.f10109SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f10113VT, Ascii.f10102FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        return String.valueOf(new char[]{SETS[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f10112US, 32})), SETS[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f10101EM, Ascii.SUB})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f10103FS, Ascii.f10104GS, Ascii.f10108RS, 19, Ascii.DC4})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f10100CR, Ascii.f10110SO})), SETS[0].charAt(getInt(bArr, new byte[]{Ascii.f10109SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), SETS[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f10113VT, Ascii.f10102FF, 1, 2}))});
    }
