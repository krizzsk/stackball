...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    /* renamed from: is */
    public static CharMatcher m9309is(char c) {
        return new C3923Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m9309is(charSequence.charAt(0));
        }
        if (length != 2) {
    ...
    /* renamed from: or */
    public CharMatcher mo32620or(CharMatcher charMatcher) {
        return new C3924Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m9309is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C3924Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C3924Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C3923Is extends FastMatcher {
        ...
        /* renamed from: or */
        public CharMatcher mo32620or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo32620or(charMatcher);
        }
