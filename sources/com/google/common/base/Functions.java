...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        /* renamed from: f */
        private final Function<A, ? extends B> f10114f;

        /* renamed from: g */
        private final Function<B, C> f10115g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f10115g = (Function) Preconditions.checkNotNull(function);
            this.f10114f = (Function) Preconditions.checkNotNull(function2);
        }

        public C apply(@NullableDecl A a) {
            return this.f10115g.apply(this.f10114f.apply(a));
        }
        ...
        public boolean equals(@NullableDecl Object obj) {
            ...
            if (!this.f10114f.equals(functionComposition.f10114f) || !this.f10115g.equals(functionComposition.f10115g)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f10114f.hashCode() ^ this.f10115g.hashCode();
        }

        public String toString() {
            return this.f10115g + "(" + this.f10114f + ")";
        }
    }
