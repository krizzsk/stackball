...
final class ConfigurableMutableNetwork<N, E> extends ConfigurableNetwork<N, E> implements MutableNetwork<N, E> {
    ...
    public boolean addEdge(N n, N n2, E e) {
        ...
        Preconditions.checkNotNull(e, VungleApiClient.ConnectionTypeDetail.EDGE);
        boolean z = false;
        if (containsEdge(e)) {
            EndpointPair incidentNodes = incidentNodes(e);
            EndpointPair of = EndpointPair.m9446of((Network<?, ?>) this, n, n2);
    ...
    private NetworkConnections<N, E> newConnections() {
        if (isDirected()) {
            if (allowsParallelEdges()) {
                return DirectedMultiNetworkConnections.m9443of();
            }
            return DirectedNetworkConnections.m9444of();
        } else if (allowsParallelEdges()) {
            return UndirectedMultiNetworkConnections.m9449of();
        } else {
            return UndirectedNetworkConnections.m9450of();
        }
    }
}
