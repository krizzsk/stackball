...
public final class ImmutableDoubleArray implements Serializable {
    ...
    /* renamed from: of */
    public static ImmutableDoubleArray m9459of() {
        return EMPTY;
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9460of(double d) {
        return new ImmutableDoubleArray(new double[]{d});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9461of(double d, double d2) {
        return new ImmutableDoubleArray(new double[]{d, d2});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9462of(double d, double d2, double d3) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9463of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9464of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9465of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* renamed from: of */
    public static ImmutableDoubleArray m9466of(double d, double... dArr) {
