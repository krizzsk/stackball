...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    private long aggregateBelowRange(Aggregate aggregate, @NullableDecl AvlNode<E> avlNode) {
        ...
        if (compare == 0) {
            int i = C41904.$SwitchMap$com$google$common$collect$BoundType[this.range.getLowerBoundType().ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class C41904 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.collect.TreeMultiset.C41904.<clinit>():void");
        }
    }
    ...
    private long aggregateAboveRange(Aggregate aggregate, @NullableDecl AvlNode<E> avlNode) {
        ...
        if (compare == 0) {
            int i = C41904.$SwitchMap$com$google$common$collect$BoundType[this.range.getUpperBoundType().ordinal()];
            if (i == 1) {
                treeAggregate = (long) aggregate.nodeAggregate(avlNode);
