...
final class Murmur3_128HashFunction extends AbstractHashFunction implements Serializable {
    ...
    private static final class Murmur3_128Hasher extends AbstractStreamingHasher {
        ...
        /* renamed from: C1 */
        private static final long f10145C1 = -8663945395140668459L;

        /* renamed from: C2 */
        private static final long f10146C2 = 5545529020109919103L;
        ...
        private void bmix64(long j, long j2) {
            long mixK1 = mixK1(j) ^ this.f10147h1;
            this.f10147h1 = mixK1;
            long rotateLeft = Long.rotateLeft(mixK1, 27);
            this.f10147h1 = rotateLeft;
            long j3 = this.f10148h2;
            long j4 = rotateLeft + j3;
            this.f10147h1 = j4;
            this.f10147h1 = (j4 * 5) + 1390208809;
            long mixK2 = mixK2(j2) ^ j3;
            this.f10148h2 = mixK2;
            long rotateLeft2 = Long.rotateLeft(mixK2, 31);
            this.f10148h2 = rotateLeft2;
            long j5 = rotateLeft2 + this.f10147h1;
            this.f10148h2 = j5;
            this.f10148h2 = (j5 * 5) + 944331445;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:32:0x00f6, code lost:
            r11.f10147h1 ^= mixK1(r2);
            r11.f10148h2 ^= mixK2(r6);
         */
        ...
        public void processRemaining(java.nio.ByteBuffer r12) {
            ...
            L_0x00eb:
                ...
                long r2 = r2 ^ r0
            L_0x00f6:
                long r0 = r11.f10147h1
                long r2 = mixK1(r2)
                long r0 = r0 ^ r2
                r11.f10147h1 = r0
                long r0 = r11.f10148h2
                long r2 = mixK2(r6)
                long r0 = r0 ^ r2
                r11.f10148h2 = r0
                return
        ...
        public HashCode makeHash() {
            long j = this.f10147h1;
            int i = this.length;
            long j2 = j ^ ((long) i);
            this.f10147h1 = j2;
            long j3 = this.f10148h2 ^ ((long) i);
            this.f10148h2 = j3;
            long j4 = j2 + j3;
            this.f10147h1 = j4;
            this.f10148h2 = j3 + j4;
            this.f10147h1 = fmix64(j4);
            long fmix64 = fmix64(this.f10148h2);
            this.f10148h2 = fmix64;
            long j5 = this.f10147h1 + fmix64;
            this.f10147h1 = j5;
            this.f10148h2 = fmix64 + j5;
            return HashCode.fromBytesNoCopy(ByteBuffer.wrap(new byte[16]).order(ByteOrder.LITTLE_ENDIAN).putLong(this.f10147h1).putLong(this.f10148h2).array());
        }

        private static long mixK1(long j) {
            return Long.rotateLeft(j * f10145C1, 31) * f10146C2;
        }

        private static long mixK2(long j) {
            return Long.rotateLeft(j * f10146C2, 33) * f10145C1;
        }
    }
}
