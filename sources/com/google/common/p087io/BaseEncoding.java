...
public abstract class BaseEncoding {
    ...
    static class StandardBaseEncoding extends BaseEncoding {
        ...
        public com.google.common.p087io.BaseEncoding withPadChar(char r3) {
            /*
                r2 = this;
            ...
            L_0x001f:
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.common.p087io.BaseEncoding.StandardBaseEncoding.withPadChar(char):com.google.common.io.BaseEncoding");
        }
    ...
    static final class Base64Encoding extends StandardBaseEncoding {
        ...
        public void encodeTo(Appendable appendable, byte[] bArr, int i, int i2) throws IOException {
            ...
            while (i2 >= 3) {
                ...
                appendable.append(this.alphabet.encode((b >>> Ascii.f10102FF) & 63));
        ...
        return new Reader() {
            ...
            public int read() throws java.io.IOException {
                ...
                L_0x0012:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.google.common.p087io.BaseEncoding.C42773.read():int");
            }
