...
public class Campaign implements C6219c, NoProGuard, Serializable {
    ...
    public void loadIconUrlAsyncWithBlock(OnImageLoadListener onImageLoadListener) {
        ...
        if (!TextUtils.isEmpty(getIconUrl())) {
            C6216b.m15729a(C6122a.m15302b().mo42895d()).mo43786a(getIconUrl(), (C6219c) this);
        }
    }
    ...
    public void loadImageUrlAsyncWithBlock(OnImageLoadListener onImageLoadListener) {
        ...
        if (!TextUtils.isEmpty(getImageUrl())) {
            C6216b.m15729a(C6122a.m15302b().mo42895d()).mo43786a(getImageUrl(), (C6219c) this);
        }
    }
