        ...
        try {
            ...
            if (parse != null) {
                ...
                if (!TextUtils.isEmpty(host)) {
                    if (host.contains(CampaignEx.JSON_KEY_HB) && !TextUtils.isEmpty(path) && path.contains(BidResponsed.KEY_BID_ID)) {
            ...
            C6361q.m16155a(TAG, "Exception", th);
        }
        return "";
    }
}
