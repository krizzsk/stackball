...
public class LoadingActivity extends Activity {
    ...
    private C6219c cipl = new C6219c() {
    ...
    private View initView() {
        if (this.rlayout_main == null) {
            ...
            int b = C6366u.m16203b((Context) this, 15.0f);
            ...
            this.rlayout.addView(new TextView(this), new RelativeLayout.LayoutParams(C6366u.m16203b((Context) this, 140.0f), C6366u.m16203b((Context) this, 31.5f)));
            MBImageView mBImageView = new MBImageView(this);
            this.img_icon = mBImageView;
            mBImageView.setId(C6366u.m16185a());
            this.img_icon.setTag(this.icon_url);
            if (!TextUtils.isEmpty(this.icon_url)) {
                C6216b.m15729a(getApplicationContext()).mo43786a(this.icon_url, this.cipl);
            }
            int b2 = C6366u.m16203b((Context) this, 64.0f);
