...
public class MBridgeLevelLayoutView extends LinearLayout {
    ...
    public void setRating(int i) {
        this.f17264a = (double) i;
        m17620a();
    }

    /* renamed from: a */
    private void m17620a() {
        ...
        if (linearLayout != null) {
            ...
            Drawable drawable = getResources().getDrawable(C6347k.m16084a(getContext(), "mbridge_reward_user", "drawable"));
            drawable.setBounds(0, 0, drawable.getMinimumWidth(), drawable.getMinimumHeight());
            textView2.setCompoundDrawables(drawable, (Drawable) null, (Drawable) null, (Drawable) null);
            textView2.setText(this.f17265b + " )");
            linearLayout.addView(textView, layoutParams2);
            linearLayout.addView(textView2, layoutParams2);
        }
        double d = this.f17264a;
        if (d == 0.0d) {
            d = 5.0d;
        }
        for (int i = 0; i < 5; i++) {
            ...
            if (((double) i) < d) {
                imageView.setImageResource(C6347k.m16084a(getContext(), "mbridge_download_message_dialog_star_sel", "drawable"));
            } else {
                imageView.setImageResource(C6347k.m16084a(getContext(), "mbridge_download_message_dilaog_star_nor", "drawable"));
            }
