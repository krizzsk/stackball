...
public class MBBidInterstitialVideoHandler {
    ...
    /* renamed from: a */
    private void m16525a(String str, String str2) {
        try {
            if (this.f16077a == null) {
                C6738a aVar = new C6738a();
                this.f16077a = aVar;
                aVar.mo46979a(true);
                this.f16077a.mo46984b(true);
            }
            this.f16077a.mo46983b(str, str2);
        } catch (Throwable th) {
            C6361q.m16155a("MBBidRewardVideoHandler", th.getMessage(), th);
        }
    }

    public void loadFromBid(String str) {
        C6738a aVar = this.f16077a;
        if (aVar != null) {
