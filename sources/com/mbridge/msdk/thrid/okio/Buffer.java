...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public long readDecimalLong() {
        ...
        L_0x003d:
            ...
            r1.<init>()
            com.mbridge.msdk.thrid.okio.Buffer r1 = r1.writeDecimalLong((long) r3)
            com.mbridge.msdk.thrid.okio.Buffer r1 = r1.writeByte((int) r15)
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (this.size != 0) {
            ...
            if ((b3 & 128) == 0) {
                ...
                b2 = b3 & Ascii.f10112US;
                i = 2;
                b = 128;
            } else if ((b3 & 240) == 224) {
                b2 = b3 & Ascii.f10109SI;
                i = 3;
                b = 2048;
            } else if ((b3 & 248) == 240) {
                b2 = b3 & 7;
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m17205of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m17205of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
