...
public final class Http2Stream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f16834id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public synchronized com.mbridge.msdk.thrid.okhttp.Headers takeHeaders() throws java.io.IOException {
        /*
            r2 = this;
            monitor-enter(r2)
            com.mbridge.msdk.thrid.okhttp.internal.http2.Http2Stream$StreamTimeout r0 = r2.readTimeout     // Catch:{ all -> 0x003c }
            r0.enter()     // Catch:{ all -> 0x003c }
        L_0x0006:
            java.util.Deque<com.mbridge.msdk.thrid.okhttp.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x0035 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x0035 }
            if (r0 == 0) goto L_0x0016
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r0 = r2.errorCode     // Catch:{ all -> 0x0035 }
            if (r0 != 0) goto L_0x0016
        ...
        L_0x0016:
            ...
            java.util.Deque<com.mbridge.msdk.thrid.okhttp.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x003c }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x003c }
            if (r0 != 0) goto L_0x002d
            java.util.Deque<com.mbridge.msdk.thrid.okhttp.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x003c }
            java.lang.Object r0 = r0.removeFirst()     // Catch:{ all -> 0x003c }
            com.mbridge.msdk.thrid.okhttp.Headers r0 = (com.mbridge.msdk.thrid.okhttp.Headers) r0     // Catch:{ all -> 0x003c }
            monitor-exit(r2)
            return r0
        L_0x002d:
            com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException r0 = new com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException     // Catch:{ all -> 0x003c }
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r1 = r2.errorCode     // Catch:{ all -> 0x003c }
            r0.<init>(r1)     // Catch:{ all -> 0x003c }
            throw r0     // Catch:{ all -> 0x003c }
        L_0x0035:
            r0 = move-exception
            com.mbridge.msdk.thrid.okhttp.internal.http2.Http2Stream$StreamTimeout r1 = r2.readTimeout     // Catch:{ all -> 0x003c }
        ...
        L_0x003c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.http2.Http2Stream.takeHeaders():com.mbridge.msdk.thrid.okhttp.Headers");
    }
    ...
    public void writeHeaders(List<Header> list, boolean z) throws IOException {
        ...
        if (list != null) {
            ...
            this.connection.writeSynReply(this.f16834id, z4, list);
            if (z3) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f16834id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f16834id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f16834id);
            return true;
        }
    }
                                ...
                                if (Http2Stream.this.headersQueue.isEmpty() || Http2Stream.this.headersListener == null) {
                                    if (this.readBuffer.size() > 0) {
                                        ...
                                        if (errorCode == null && Http2Stream.this.unacknowledgedBytesRead >= ((long) (Http2Stream.this.connection.okHttpSettings.getInitialWindowSize() / 2))) {
                                            Http2Stream.this.connection.writeWindowUpdateLater(Http2Stream.this.f16834id, Http2Stream.this.unacknowledgedBytesRead);
    ...
    final class FramingSink implements Sink {
        ...
        private void emitFrame(boolean z) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f16834id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r8.this$0.connection.writeData(r8.this$0.f16834id, true, (com.mbridge.msdk.thrid.okio.Buffer) null, 0);
         */
