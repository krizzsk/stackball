package com.mbridge.msdk.thrid.okhttp.internal.p213ws;
...
import com.mbridge.msdk.thrid.okhttp.internal.p213ws.WebSocketReader;
...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m17205of(bArr).base64();
    ...
    public synchronized void onReadPing(com.mbridge.msdk.thrid.okio.ByteString r2) {
        /*
            ...
            goto L_0x0022
        L_0x0012:
            java.util.ArrayDeque<com.mbridge.msdk.thrid.okio.ByteString> r0 = r1.pongQueue     // Catch:{ all -> 0x0024 }
        ...
        L_0x0024:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.onReadPing(com.mbridge.msdk.thrid.okio.ByteString):void");
    }
    ...
    private synchronized boolean send(com.mbridge.msdk.thrid.okio.ByteString r7, int r8) {
        ...
        L_0x0022:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Message r1 = new com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Message     // Catch:{ all -> 0x003e }
        ...
        L_0x003e:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.send(com.mbridge.msdk.thrid.okio.ByteString, int):boolean");
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x005e, code lost:
        if ((r4 instanceof com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Message) == false) goto L_0x008c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x0060, code lost:
        r2 = ((com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Message) r4).data;
        r0 = com.mbridge.msdk.thrid.okio.Okio.buffer(r0.newMessageSink(((com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Message) r4).formatOpcode, (long) r2.size()));
        r0.write(r2);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x008e, code lost:
        if ((r4 instanceof com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Close) == false) goto L_0x00a5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x0090, code lost:
        r4 = (com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Close) r4;
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        /*
            ...
            return r1
        L_0x0008:
            com.mbridge.msdk.thrid.okhttp.internal.ws.WebSocketWriter r0 = r12.writer     // Catch:{ all -> 0x00b0 }
            java.util.ArrayDeque<com.mbridge.msdk.thrid.okio.ByteString> r2 = r12.pongQueue     // Catch:{ all -> 0x00b0 }
            java.lang.Object r2 = r2.poll()     // Catch:{ all -> 0x00b0 }
            com.mbridge.msdk.thrid.okio.ByteString r2 = (com.mbridge.msdk.thrid.okio.ByteString) r2     // Catch:{ all -> 0x00b0 }
            r3 = -1
            r4 = 0
            ...
            boolean r6 = r5 instanceof com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Close     // Catch:{ all -> 0x00b0 }
            if (r6 == 0) goto L_0x004b
            int r1 = r12.receivedCloseCode     // Catch:{ all -> 0x00b0 }
            java.lang.String r6 = r12.receivedCloseReason     // Catch:{ all -> 0x00b0 }
            if (r1 == r3) goto L_0x0034
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Streams r3 = r12.streams     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0034:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$CancelRunnable r7 = new com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$CancelRunnable     // Catch:{ all -> 0x00b0 }
            r7.<init>()     // Catch:{ all -> 0x00b0 }
            r8 = r5
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Close r8 = (com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00b0 }
        ...
        L_0x0055:
            ...
            goto L_0x00a0
        L_0x005c:
            boolean r2 = r4 instanceof com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Message     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x008c
            r2 = r4
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Message r2 = (com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Message) r2     // Catch:{ all -> 0x00ab }
            com.mbridge.msdk.thrid.okio.ByteString r2 = r2.data     // Catch:{ all -> 0x00ab }
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Message r4 = (com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Message) r4     // Catch:{ all -> 0x00ab }
            int r3 = r4.formatOpcode     // Catch:{ all -> 0x00ab }
            int r4 = r2.size()     // Catch:{ all -> 0x00ab }
            long r4 = (long) r4     // Catch:{ all -> 0x00ab }
            com.mbridge.msdk.thrid.okio.Sink r0 = r0.newMessageSink(r3, r4)     // Catch:{ all -> 0x00ab }
            com.mbridge.msdk.thrid.okio.BufferedSink r0 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Sink) r0)     // Catch:{ all -> 0x00ab }
            r0.write((com.mbridge.msdk.thrid.okio.ByteString) r2)     // Catch:{ all -> 0x00ab }
        ...
        L_0x008c:
            boolean r2 = r4 instanceof com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Close     // Catch:{ all -> 0x00ab }
            if (r2 == 0) goto L_0x00a5
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Close r4 = (com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.Close) r4     // Catch:{ all -> 0x00ab }
            int r2 = r4.code     // Catch:{ all -> 0x00ab }
            com.mbridge.msdk.thrid.okio.ByteString r4 = r4.reason     // Catch:{ all -> 0x00ab }
            r0.writeClose(r2, r4)     // Catch:{ all -> 0x00ab }
            if (r1 == 0) goto L_0x00a0
            com.mbridge.msdk.thrid.okhttp.WebSocketListener r0 = r12.listener     // Catch:{ all -> 0x00ab }
        ...
        L_0x00b0:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    public void writePingFrame() {
        /*
            ...
            return
        L_0x0007:
            com.mbridge.msdk.thrid.okhttp.internal.ws.WebSocketWriter r0 = r7.writer     // Catch:{ all -> 0x0053 }
        ...
        L_0x0012:
            ...
            return
        L_0x0048:
            com.mbridge.msdk.thrid.okio.ByteString r1 = com.mbridge.msdk.thrid.okio.ByteString.EMPTY     // Catch:{ IOException -> 0x004e }
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.writePingFrame():void");
    }
    ...
    public void failWebSocket(java.lang.Exception r4, @javax.annotation.Nullable com.mbridge.msdk.thrid.okhttp.Response r5) {
        ...
        L_0x0007:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.ws.RealWebSocket$Streams r0 = r3.streams     // Catch:{ all -> 0x0031 }
            r1 = 0
        ...
        L_0x0022:
            monitor-exit(r3)     // Catch:{ all -> 0x0031 }
            com.mbridge.msdk.thrid.okhttp.WebSocketListener r1 = r3.listener     // Catch:{ all -> 0x002c }
        ...
        L_0x0031:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket.failWebSocket(java.lang.Exception, com.mbridge.msdk.thrid.okhttp.Response):void");
    }
