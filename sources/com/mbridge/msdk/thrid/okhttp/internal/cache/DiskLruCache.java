...
import com.mbridge.msdk.thrid.okhttp.internal.p212io.FileSystem;
...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final Runnable cleanupRunnable = new Runnable() {
        /* JADX WARNING: Code restructure failed: missing block: B:20:?, code lost:
            ...
            r5.this$0.journalWriter = com.mbridge.msdk.thrid.okio.Okio.buffer(com.mbridge.msdk.thrid.okio.Okio.blackhole());
         */
        ...
        public void run() {
            /*
                ...
                monitor-enter(r0)
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
            ...
            L_0x000d:
                r1 = 0
            L_0x000e:
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r4 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                ...
                return
            L_0x0017:
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x001d }
            ...
            L_0x0021:
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0033 }
            ...
            L_0x0033:
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ all -> 0x0045 }
                com.mbridge.msdk.thrid.okio.Sink r2 = com.mbridge.msdk.thrid.okio.Okio.blackhole()     // Catch:{ all -> 0x0045 }
                com.mbridge.msdk.thrid.okio.BufferedSink r2 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Sink) r2)     // Catch:{ all -> 0x0045 }
            ...
            L_0x0045:
                ...
                throw r1
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.C68361.run():void");
        }
    };
    boolean closed;
    ...
    private void readJournal() throws java.io.IOException {
        ...
        L_0x0053:
            ...
            goto L_0x0053
        L_0x005d:
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r2 = r9.lruEntries     // Catch:{ all -> 0x00a8 }
            ...
            goto L_0x0076
        L_0x0070:
            com.mbridge.msdk.thrid.okio.BufferedSink r0 = r9.newJournalWriter()     // Catch:{ all -> 0x00a8 }
    ...
    public synchronized com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r0 = r3.lruEntries     // Catch:{ all -> 0x0050 }
            java.lang.Object r0 = r0.get(r4)     // Catch:{ all -> 0x0050 }
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r0 = (com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Entry) r0     // Catch:{ all -> 0x0050 }
            r1 = 0
            ...
            goto L_0x004e
        L_0x001a:
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Snapshot r0 = r0.snapshot()     // Catch:{ all -> 0x0050 }
        ...
        L_0x0022:
            ...
            com.mbridge.msdk.thrid.okio.BufferedSink r1 = r3.journalWriter     // Catch:{ all -> 0x0050 }
            java.lang.String r2 = "READ"
            com.mbridge.msdk.thrid.okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x0050 }
            r2 = 32
            com.mbridge.msdk.thrid.okio.BufferedSink r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0050 }
            com.mbridge.msdk.thrid.okio.BufferedSink r4 = r1.writeUtf8(r4)     // Catch:{ all -> 0x0050 }
            r1 = 10
    ...
    public synchronized com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r0 = r5.lruEntries     // Catch:{ all -> 0x0074 }
            java.lang.Object r0 = r0.get(r6)     // Catch:{ all -> 0x0074 }
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r0 = (com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Entry) r0     // Catch:{ all -> 0x0074 }
            r1 = -1
            r3 = 0
        ...
        L_0x0023:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Editor r7 = r0.currentEditor     // Catch:{ all -> 0x0074 }
        ...
        L_0x002b:
            ...
            goto L_0x006b
        L_0x0034:
            com.mbridge.msdk.thrid.okio.BufferedSink r7 = r5.journalWriter     // Catch:{ all -> 0x0074 }
            java.lang.String r8 = "DIRTY"
            com.mbridge.msdk.thrid.okio.BufferedSink r7 = r7.writeUtf8(r8)     // Catch:{ all -> 0x0074 }
            r8 = 32
            com.mbridge.msdk.thrid.okio.BufferedSink r7 = r7.writeByte(r8)     // Catch:{ all -> 0x0074 }
            com.mbridge.msdk.thrid.okio.BufferedSink r7 = r7.writeUtf8(r6)     // Catch:{ all -> 0x0074 }
            r8 = 10
        ...
        L_0x0056:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r0 = new com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry     // Catch:{ all -> 0x0074 }
            r0.<init>(r6)     // Catch:{ all -> 0x0074 }
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r7 = r5.lruEntries     // Catch:{ all -> 0x0074 }
            r7.put(r6, r0)     // Catch:{ all -> 0x0074 }
        L_0x0062:
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Editor r6 = new com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Editor     // Catch:{ all -> 0x0074 }
    ...
    public synchronized void completeEdit(com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Editor r10, boolean r11) throws java.io.IOException {
        /*
            r9 = this;
            monitor-enter(r9)
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r0 = r10.entry     // Catch:{ all -> 0x00fb }
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Editor r1 = r0.currentEditor     // Catch:{ all -> 0x00fb }
        ...
        L_0x000f:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.io.FileSystem r3 = r9.fileSystem     // Catch:{ all -> 0x00fb }
        ...
        L_0x0047:
            ...
            com.mbridge.msdk.thrid.okhttp.internal.io.FileSystem r2 = r9.fileSystem     // Catch:{ all -> 0x00fb }
            ...
            com.mbridge.msdk.thrid.okhttp.internal.io.FileSystem r10 = r9.fileSystem     // Catch:{ all -> 0x00fb }
        ...
        L_0x007f:
            ...
            com.mbridge.msdk.thrid.okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r1 = "CLEAN"
            com.mbridge.msdk.thrid.okio.BufferedSink r10 = r10.writeUtf8(r1)     // Catch:{ all -> 0x00fb }
            ...
            goto L_0x00d9
        L_0x00bb:
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r10 = r9.lruEntries     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fb }
            r10.remove(r11)     // Catch:{ all -> 0x00fb }
            com.mbridge.msdk.thrid.okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = "REMOVE"
            com.mbridge.msdk.thrid.okio.BufferedSink r10 = r10.writeUtf8(r11)     // Catch:{ all -> 0x00fb }
            r10.writeByte(r3)     // Catch:{ all -> 0x00fb }
            com.mbridge.msdk.thrid.okio.BufferedSink r10 = r9.journalWriter     // Catch:{ all -> 0x00fb }
            java.lang.String r11 = r0.key     // Catch:{ all -> 0x00fb }
    ...
    public synchronized boolean remove(java.lang.String r7) throws java.io.IOException {
        /*
            ...
            java.util.LinkedHashMap<java.lang.String, com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry> r0 = r6.lruEntries     // Catch:{ all -> 0x0029 }
            java.lang.Object r7 = r0.get(r7)     // Catch:{ all -> 0x0029 }
            com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r7 = (com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.Entry) r7     // Catch:{ all -> 0x0029 }
            r0 = 0
    ...
    public final class Editor {
        ...
        public com.mbridge.msdk.thrid.okio.Source newSource(int r5) {
            /*
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x002f }
                boolean r1 = r1.readable     // Catch:{ all -> 0x002f }
                r2 = 0
                if (r1 == 0) goto L_0x0027
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x002f }
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Editor r1 = r1.currentEditor     // Catch:{ all -> 0x002f }
                if (r1 == r4) goto L_0x0015
                goto L_0x0027
            L_0x0015:
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ FileNotFoundException -> 0x0025 }
                com.mbridge.msdk.thrid.okhttp.internal.io.FileSystem r1 = r1.fileSystem     // Catch:{ FileNotFoundException -> 0x0025 }
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r3 = r4.entry     // Catch:{ FileNotFoundException -> 0x0025 }
                java.io.File[] r3 = r3.cleanFiles     // Catch:{ FileNotFoundException -> 0x0025 }
                r5 = r3[r5]     // Catch:{ FileNotFoundException -> 0x0025 }
                com.mbridge.msdk.thrid.okio.Source r5 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0025 }
        ...
        public Sink newSink(int i) {
            synchronized (DiskLruCache.this) {
                if (this.done) {
                    ...
                    try {
                        C68391 r1 = new FaultHidingSink(DiskLruCache.this.fileSystem.sink(this.entry.dirtyFiles[i])) {
                            /* access modifiers changed from: protected */
                            public void onException(IOException iOException) {
                                synchronized (DiskLruCache.this) {
                                    Editor.this.detach();
        ...
        public void abortUnlessCommitted() {
            /*
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Entry r1 = r3.entry     // Catch:{ all -> 0x0015 }
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache$Editor r1 = r1.currentEditor     // Catch:{ all -> 0x0015 }
                if (r1 != r3) goto L_0x0013
                com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache r1 = com.mbridge.msdk.thrid.okhttp.internal.cache.DiskLruCache.this     // Catch:{ IOException -> 0x0013 }
                r2 = 0
