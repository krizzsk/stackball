    ...
    class RelaySource implements Source {
        ...
        public long read(com.mbridge.msdk.thrid.okio.Buffer r22, long r23) throws java.io.IOException {
            ...
            L_0x000b:
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                long r7 = r0.upstreamPos     // Catch:{ all -> 0x0137 }
                r0 = 2
                r9 = -1
                int r11 = (r5 > r7 ? 1 : (r5 == r7 ? 0 : -1))
                if (r11 != 0) goto L_0x0039
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r5 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
            ...
            L_0x0020:
                ...
                com.mbridge.msdk.thrid.okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x0137 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r5 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
            ...
            L_0x0039:
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r5 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                com.mbridge.msdk.thrid.okio.Buffer r5 = r5.buffer     // Catch:{ all -> 0x0137 }
            ...
            L_0x0069:
                r4 = 0
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okio.Source r0 = r0.upstream     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r5 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okio.Buffer r5 = r5.upstreamBuffer     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r6 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                ...
                monitor-enter(r2)
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0091 }
            ...
            L_0x0094:
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okio.Buffer r13 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                r15 = 0
                r14 = r22
                r17 = r2
                r13.copyTo((com.mbridge.msdk.thrid.okio.Buffer) r14, (long) r15, (long) r17)     // Catch:{ all -> 0x0109 }
                long r9 = r1.sourcePos     // Catch:{ all -> 0x0109 }
                long r9 = r9 + r2
                r1.sourcePos = r9     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.FileOperator r15 = r1.fileOperator     // Catch:{ all -> 0x0109 }
                long r16 = r7 + r11
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okio.Buffer r0 = r0.upstreamBuffer     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okio.Buffer r18 = r0.clone()     // Catch:{ all -> 0x0109 }
                r19 = r5
                r15.write(r16, r18, r19)     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r7 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0109 }
                monitor-enter(r7)     // Catch:{ all -> 0x0109 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r8 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okio.Buffer r8 = r8.upstreamBuffer     // Catch:{ all -> 0x0106 }
                r0.write((com.mbridge.msdk.thrid.okio.Buffer) r8, (long) r5)     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                ...
                com.mbridge.msdk.thrid.okio.Buffer r0 = r0.buffer     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r8 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okio.Buffer r8 = r8.buffer     // Catch:{ all -> 0x0106 }
                long r8 = r8.size()     // Catch:{ all -> 0x0106 }
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r10 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0106 }
            ...
            L_0x00ed:
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r5 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this
                monitor-enter(r5)
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0103 }
            ...
            L_0x0109:
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r2 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this
                monitor-enter(r2)
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r3 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0118 }
            ...
            L_0x011b:
                ...
                com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay r0 = com.mbridge.msdk.thrid.okhttp.internal.cache2.Relay.this     // Catch:{ all -> 0x0137 }
                com.mbridge.msdk.thrid.okio.Buffer r9 = r0.buffer     // Catch:{ all -> 0x0137 }
                long r7 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r11 = r7 - r5
                r10 = r22
                r13 = r2
                r9.copyTo((com.mbridge.msdk.thrid.okio.Buffer) r10, (long) r11, (long) r13)     // Catch:{ all -> 0x0137 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x0137 }
                long r5 = r5 + r2
