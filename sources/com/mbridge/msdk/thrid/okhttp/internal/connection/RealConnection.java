...
import com.mbridge.msdk.thrid.okhttp.internal.p213ws.RealWebSocket;
...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    private void connectTls(com.mbridge.msdk.thrid.okhttp.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        /*
            ...
            com.mbridge.msdk.thrid.okhttp.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x0130 }
            java.lang.String r4 = r4.host()     // Catch:{ AssertionError -> 0x0130 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r5 = r0.url()     // Catch:{ AssertionError -> 0x0130 }
            ...
            com.mbridge.msdk.thrid.okhttp.ConnectionSpec r8 = r8.configureSecureSocket(r1)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            boolean r3 = r8.supportsTlsExtensions()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            if (r3 == 0) goto L_0x0041
            com.mbridge.msdk.thrid.okhttp.internal.platform.Platform r3 = com.mbridge.msdk.thrid.okhttp.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r4 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        ...
        L_0x0041:
            ...
            com.mbridge.msdk.thrid.okhttp.Handshake r4 = com.mbridge.msdk.thrid.okhttp.Handshake.get(r3)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            javax.net.ssl.HostnameVerifier r5 = r0.hostnameVerifier()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r6 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            com.mbridge.msdk.thrid.okhttp.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.lang.String r0 = com.mbridge.msdk.thrid.okhttp.CertificatePinner.pin(r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.lang.String r0 = "\n    DN: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            java.lang.String r0 = "\n    subjectAltNames: "
            r4.append(r0)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.util.List r8 = com.mbridge.msdk.thrid.okhttp.internal.tls.OkHostnameVerifier.allSubjectAltNames(r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        ...
        L_0x00d8:
            com.mbridge.msdk.thrid.okhttp.CertificatePinner r3 = r0.certificatePinner()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            com.mbridge.msdk.thrid.okhttp.HttpUrl r0 = r0.url()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.lang.String r0 = r0.host()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            com.mbridge.msdk.thrid.okhttp.internal.platform.Platform r8 = com.mbridge.msdk.thrid.okhttp.internal.platform.Platform.get()     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        ...
        L_0x00f9:
            ...
            com.mbridge.msdk.thrid.okio.Source r8 = com.mbridge.msdk.thrid.okio.Okio.source((java.net.Socket) r1)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            com.mbridge.msdk.thrid.okio.BufferedSource r8 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Source) r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            r7.source = r8     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            com.mbridge.msdk.thrid.okio.Sink r8 = com.mbridge.msdk.thrid.okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            com.mbridge.msdk.thrid.okio.BufferedSink r8 = com.mbridge.msdk.thrid.okio.Okio.buffer((com.mbridge.msdk.thrid.okio.Sink) r8)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            r7.sink = r8     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            r7.handshake = r4     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            if (r2 == 0) goto L_0x011a
            com.mbridge.msdk.thrid.okhttp.Protocol r8 = com.mbridge.msdk.thrid.okhttp.Protocol.get(r2)     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            goto L_0x011c
        L_0x011a:
            com.mbridge.msdk.thrid.okhttp.Protocol r8 = com.mbridge.msdk.thrid.okhttp.Protocol.HTTP_1_1     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
        L_0x011c:
        ...
        L_0x0130:
            r8 = move-exception
        L_0x0131:
            boolean r0 = com.mbridge.msdk.thrid.okhttp.internal.Util.isAndroidGetsocknameError(r8)     // Catch:{ all -> 0x012e }
    ...
    private Request createTunnelRequest() throws IOException {
        Request build = new Request.Builder().url(this.route.address().url()).method("CONNECT", (RequestBody) null).header(com.google.common.net.HttpHeaders.HOST, Util.hostHeader(this.route.address().url(), true)).header("Proxy-Connection", "Keep-Alive").header("User-Agent", Version.userAgent()).build();
