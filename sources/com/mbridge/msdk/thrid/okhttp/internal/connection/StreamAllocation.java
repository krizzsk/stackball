...
public final class StreamAllocation {
    ...
    public void streamFailed(java.io.IOException r7) {
        /*
            ...
            monitor-enter(r0)
            boolean r1 = r7 instanceof com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException     // Catch:{ all -> 0x0069 }
            r2 = 0
            r3 = 0
            r4 = 1
            if (r1 == 0) goto L_0x0023
            com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException r7 = (com.mbridge.msdk.thrid.okhttp.internal.http2.StreamResetException) r7     // Catch:{ all -> 0x0069 }
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r7 = r7.errorCode     // Catch:{ all -> 0x0069 }
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r1 = com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode.REFUSED_STREAM     // Catch:{ all -> 0x0069 }
            if (r7 != r1) goto L_0x001c
            int r7 = r6.refusedStreamCount     // Catch:{ all -> 0x0069 }
            int r7 = r7 + r4
            r6.refusedStreamCount = r7     // Catch:{ all -> 0x0069 }
            if (r7 <= r4) goto L_0x004a
            r6.route = r3     // Catch:{ all -> 0x0069 }
            goto L_0x0048
        L_0x001c:
            com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode r1 = com.mbridge.msdk.thrid.okhttp.internal.http2.ErrorCode.CANCEL     // Catch:{ all -> 0x0069 }
            if (r7 == r1) goto L_0x004a
            r6.route = r3     // Catch:{ all -> 0x0069 }
            goto L_0x0048
        L_0x0023:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0069 }
            if (r1 == 0) goto L_0x004a
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0069 }
            boolean r1 = r1.isMultiplexed()     // Catch:{ all -> 0x0069 }
            if (r1 == 0) goto L_0x0033
            boolean r1 = r7 instanceof com.mbridge.msdk.thrid.okhttp.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x0069 }
            if (r1 == 0) goto L_0x004a
        L_0x0033:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0069 }
            int r1 = r1.successCount     // Catch:{ all -> 0x0069 }
            if (r1 != 0) goto L_0x0048
            com.mbridge.msdk.thrid.okhttp.Route r1 = r6.route     // Catch:{ all -> 0x0069 }
            if (r1 == 0) goto L_0x0046
            if (r7 == 0) goto L_0x0046
            com.mbridge.msdk.thrid.okhttp.internal.connection.RouteSelector r1 = r6.routeSelector     // Catch:{ all -> 0x0069 }
            com.mbridge.msdk.thrid.okhttp.Route r5 = r6.route     // Catch:{ all -> 0x0069 }
        ...
        L_0x004b:
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r1 = r6.connection     // Catch:{ all -> 0x0069 }
            java.net.Socket r7 = r6.deallocate(r7, r2, r4)     // Catch:{ all -> 0x0069 }
            com.mbridge.msdk.thrid.okhttp.internal.connection.RealConnection r2 = r6.connection     // Catch:{ all -> 0x0069 }
            if (r2 != 0) goto L_0x005b
            boolean r2 = r6.reportedAcquired     // Catch:{ all -> 0x0069 }
    ...
    public boolean hasMoreRoutes() {
        ...
        L_0x001a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.internal.connection.StreamAllocation.hasMoreRoutes():boolean");
    }
