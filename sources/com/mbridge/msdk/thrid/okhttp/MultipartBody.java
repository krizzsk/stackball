...
public final class MultipartBody extends RequestBody {
    ...
    private static final byte[] CRLF = {Ascii.f10100CR, 10};
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v1, resolved type: com.mbridge.msdk.thrid.okio.BufferedSink} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v0, resolved type: com.mbridge.msdk.thrid.okio.Buffer} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v1, resolved type: com.mbridge.msdk.thrid.okio.Buffer} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r13v3, resolved type: com.mbridge.msdk.thrid.okio.BufferedSink} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r0v2, resolved type: com.mbridge.msdk.thrid.okio.Buffer} */
    ...
    private long writeOrCountBytes(@javax.annotation.Nullable com.mbridge.msdk.thrid.okio.BufferedSink r13, boolean r14) throws java.io.IOException {
        ...
        L_0x0014:
            ...
            r13.write((com.mbridge.msdk.thrid.okio.ByteString) r8)
            byte[] r8 = CRLF
            r13.write((byte[]) r8)
        ...
        L_0x0038:
            ...
            byte[] r11 = COLONSPACE
            com.mbridge.msdk.thrid.okio.BufferedSink r10 = r10.write((byte[]) r11)
        ...
        L_0x00a6:
            ...
            r13.write((com.mbridge.msdk.thrid.okio.ByteString) r1)
            byte[] r1 = DASHDASH
            r13.write((byte[]) r1)
            byte[] r1 = CRLF
            r13.write((byte[]) r1)
        ...
        L_0x00c4:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.thrid.okhttp.MultipartBody.writeOrCountBytes(com.mbridge.msdk.thrid.okio.BufferedSink, boolean):long");
    }
