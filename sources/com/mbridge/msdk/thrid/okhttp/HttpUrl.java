    ...
    public static final class Builder {
        ...
        private void resolvePath(java.lang.String r11, int r12, int r13) {
            ...
            L_0x0029:
                ...
                int r12 = com.mbridge.msdk.thrid.okhttp.internal.Util.delimiterOffset((java.lang.String) r11, (int) r6, (int) r13, (java.lang.String) r12)
            ...
            if (!z || !(codePointAt == 9 || codePointAt == 10 || codePointAt == 12 || codePointAt == 13)) {
                if (codePointAt == 43 && z3) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte((int) HEX_DIGITS[readByte & Ascii.f10109SI]);
                    }
                } else {
                    buffer.writeUtf8CodePoint(codePointAt);
                }
