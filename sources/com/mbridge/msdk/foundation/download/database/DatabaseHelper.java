        ...
        this.handler.post(new Runnable() {
            ...
            public void run() {
                ...
                L_0x00a1:
                    throw r2
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.download.database.DatabaseHelper.C61761.run():void");
            }
        });
    }
    ...
    public void findByDownloadUrl(final String str, final IDatabaseHelper.IDatabaseListener iDatabaseListener) {
        this.handler.post(new Runnable() {
            ...
            public void run() {
                ...
                L_0x0019:
                    r0 = 0
                    java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    r1.<init>()     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    java.lang.String r2 = "SELECT * FROM "
                    r1.append(r2)     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    com.mbridge.msdk.foundation.download.database.DatabaseHelper r2 = com.mbridge.msdk.foundation.download.database.DatabaseHelper.this     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    java.lang.String r2 = r2.tableName     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    r1.append(r2)     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    ...
                    java.lang.String r2 = " = '"
                    r1.append(r2)     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    java.lang.String r2 = r3     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    r1.append(r2)     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    java.lang.String r2 = "'"
                    r1.append(r2)     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    java.lang.String r1 = r1.toString()     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    com.mbridge.msdk.foundation.download.database.DatabaseHelper r2 = com.mbridge.msdk.foundation.download.database.DatabaseHelper.this     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    android.database.sqlite.SQLiteDatabase r2 = r2.database     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    android.database.Cursor r1 = r2.rawQuery(r1, r0)     // Catch:{ Exception -> 0x007e, all -> 0x006f }
                    if (r1 == 0) goto L_0x0065
                    boolean r2 = r1.moveToFirst()     // Catch:{ Exception -> 0x0063, all -> 0x0061 }
                    if (r2 == 0) goto L_0x0065
                    com.mbridge.msdk.foundation.download.database.DownloadModel r0 = com.mbridge.msdk.foundation.download.database.DownloadModel.create((android.database.Cursor) r1)     // Catch:{ Exception -> 0x0063, all -> 0x0061 }
                    goto L_0x0065
                L_0x0061:
                    r2 = move-exception
                    goto L_0x0071
                ...
                L_0x008b:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.download.database.DatabaseHelper.C61772.run():void");
            }
        });
    }
            ...
            public void run() {
                ...
                synchronized (DatabaseHelper.this.object) {
                    if (Objects.isNull(DatabaseHelper.this.database)) {
                        SQLiteDatabase unused = DatabaseHelper.this.database = DatabaseHelper.this.databaseOpenHelper.getWritableDatabase();
                    }
                    ...
                    try {
                        ...
                        access$000 = DatabaseHelper.this.database;
                    } catch (Exception e) {
                        try {
                            e.printStackTrace();
                            access$000 = DatabaseHelper.this.database;
