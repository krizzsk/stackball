        ...
        if (this.request.getStatus() == DownloadStatus.CANCELLED) {
            ...
            if (cacheDirectorPathType != 0) {
                ...
                if (!Objects.isNotNull(run) || !run.isSuccessful()) {
                    ...
                    DownloadModel create = DownloadModel.create(this.downloadModel.getDownloadId(), this.downloadModel.getDownloadUrl(), this.downloadModel.getResourceUrl(), this.downloadModel.getEtag(), this.downloadModel.getSaveDirectorPath(), this.downloadModel.getSaveFileName(), this.request.getTotalBytes(), this.downloadModel.getDownloadedBytes(), this.downloadModel.getDownloadRate(), this.downloadModel.getUsageCounter() + 1, this.downloadModel.getDownloadResourceType());
                    this.downloadModel = create;
                    this.databaseHelper.update(create, cacheDirectoryPath);
                    if (this.request.getStatus() == DownloadStatus.CANCELLED) {
                ...
                DownloadModel create2 = DownloadModel.create(this.downloadModel.getDownloadId(), this.downloadModel.getDownloadUrl(), this.downloadModel.getResourceUrl(), this.downloadModel.getEtag(), this.downloadModel.getSaveDirectorPath(), this.downloadModel.getSaveFileName(), this.request.getTotalBytes(), this.downloadModel.getDownloadedBytes(), this.downloadModel.getDownloadRate(), this.downloadModel.getUsageCounter() + 1, this.downloadModel.getDownloadResourceType());
                this.downloadModel = create2;
                this.databaseHelper.update(create2, cacheDirectoryPath);
                if (this.request.getStatus() == DownloadStatus.CANCELLED) {
                ...
                DownloadModel create3 = DownloadModel.create(this.downloadModel.getDownloadId(), this.downloadModel.getDownloadUrl(), this.downloadModel.getResourceUrl(), this.downloadModel.getEtag(), this.downloadModel.getSaveDirectorPath(), this.downloadModel.getSaveFileName(), this.request.getTotalBytes(), this.downloadModel.getDownloadedBytes(), this.downloadModel.getDownloadRate(), this.downloadModel.getUsageCounter() + 1, this.downloadModel.getDownloadResourceType());
                this.downloadModel = create3;
                this.databaseHelper.update(create3, cacheDirectoryPath);
                if (this.request.getStatus() == DownloadStatus.CANCELLED) {
                    run.setCancelled(true);
                }
                return run;
