...
public class BatchReportDao extends C6137a<BatchReportMessage> implements NoProGuard, Serializable {
    private static volatile BatchReportDao instance;

    protected BatchReportDao(C6146e eVar) {
        super(eVar);
    }

    public static BatchReportDao getInstance(C6146e eVar) {
        if (instance == null) {
            synchronized (BatchReportDao.class) {
                if (instance == null) {
                    instance = new BatchReportDao(eVar);
                }
            }
        }
        return instance;
    ...
    public static BatchReportDao getInstance(Context context) {
        if (instance == null) {
            synchronized (BatchReportDao.class) {
                if (instance == null) {
                    instance = new BatchReportDao(C6148f.m15420a(context));
                }
            }
        }
        return instance;
    ...
    public java.util.ArrayList<com.mbridge.msdk.foundation.same.report.BatchReportMessage> getBatchReportMessages(long r13) {
        ...
        L_0x007d:
            r3 = move-exception
            r3.printStackTrace()     // Catch:{ all -> 0x007b }
        L_0x0081:
        ...
        L_0x00ad:
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.foundation.p164db.BatchReportDao.getBatchReportMessages(long):java.util.ArrayList");
    }
