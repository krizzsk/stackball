...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        while (i5 < size2) {
            ...
            if (containerAtom3.type == Atom.TYPE_trak) {
                ...
                if (parseTrak != null) {
                    sparseArray2.put(parseTrak.f16397id, parseTrak);
                }
            } else {
                i = i5;
                i2 = size2;
        ...
        if (this.trackBundles.size() == 0) {
            while (i3 < size3) {
                ...
                trackBundle.init(track, getDefaultSampleValues(sparseArray, track.f16397id));
                this.trackBundles.put(track.f16397id, trackBundle);
        ...
        while (i3 < size3) {
            ...
            this.trackBundles.get(track2.f16397id).init(track2, getDefaultSampleValues(sparseArray, track2.f16397id));
            i3++;
        }
    }
    ...
    private static int parseTrun(TrackBundle trackBundle, int i, long j, int i2, ParsableByteArray parsableByteArray, int i3) {
        ...
        while (i10 < i9) {
            ...
            jArr2[i10] = Util.scaleLargeTimestamp(j5, 1000, j3) - j4;
            iArr[i10] = i5;
