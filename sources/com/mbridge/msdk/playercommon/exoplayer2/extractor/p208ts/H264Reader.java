        ...
        if (!this.hasOutputFormat || this.sampleReader.needsSpsPps()) {
            ...
            if (!this.hasOutputFormat) {
                if (this.sps.isCompleted() && this.pps.isCompleted()) {
                    ...
                    this.output.format(Format.createVideoSampleFormat(this.formatId, "video/avc", (String) null, -1, -1, parseSpsNalUnit.width, parseSpsNalUnit.height, -1.0f, arrayList, -1, parseSpsNalUnit.pixelWidthAspectRatio, (DrmInitData) null));
    ...
    private static final class SampleReader {
        ...
        public final void appendToNalUnit(byte[] r24, int r25, int r26) {
            ...
            L_0x0192:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.playercommon.exoplayer2.extractor.p208ts.H264Reader.SampleReader.appendToNalUnit(byte[], int, int):void");
        }
        ...
        private static final class SliceHeaderData {
            ...
            public final boolean isISlice() {
                ...
                L_0x000f:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.playercommon.exoplayer2.extractor.p208ts.H264Reader.SampleReader.SliceHeaderData.isISlice():boolean");
            }
