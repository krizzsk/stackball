...
final class VorbisReader extends StreamReader {
    ...
    public final boolean readHeaders(ParsableByteArray parsableByteArray, long j, StreamReader.SetupData setupData) throws IOException, InterruptedException {
        ...
        setupData.format = Format.createAudioSampleFormat((String) null, "audio/vorbis", (String) null, this.vorbisSetup.idHeader.bitrateNominal, -1, this.vorbisSetup.idHeader.channels, (int) this.vorbisSetup.idHeader.sampleRate, arrayList, (DrmInitData) null, 0, (String) null);
        return true;
    }
