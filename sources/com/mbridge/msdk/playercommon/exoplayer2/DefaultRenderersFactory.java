...
public class DefaultRenderersFactory implements RenderersFactory {
    ...
    public DefaultRenderersFactory(Context context2, int i) {
        this(context2, (DrmSessionManager<FrameworkMediaCrypto>) null, i, 5000);
    }
    ...
    public void buildAudioRenderers(android.content.Context r14, com.mbridge.msdk.playercommon.exoplayer2.drm.DrmSessionManager<com.mbridge.msdk.playercommon.exoplayer2.drm.FrameworkMediaCrypto> r15, com.mbridge.msdk.playercommon.exoplayer2.audio.AudioProcessor[] r16, android.os.Handler r17, com.mbridge.msdk.playercommon.exoplayer2.audio.AudioRendererEventListener r18, int r19, java.util.ArrayList<com.mbridge.msdk.playercommon.exoplayer2.Renderer> r20) {
        ...
        L_0x002a:
            ...
            com.mbridge.msdk.playercommon.exoplayer2.Renderer r5 = (com.mbridge.msdk.playercommon.exoplayer2.Renderer) r5     // Catch:{ ClassNotFoundException -> 0x0069, Exception -> 0x0060 }
            int r6 = r1 + 1
            r10.add(r1, r5)     // Catch:{ ClassNotFoundException -> 0x005e, Exception -> 0x0060 }
            java.lang.String r1 = "Loaded LibopusAudioRenderer."
            android.util.Log.i(r11, r1)     // Catch:{ ClassNotFoundException -> 0x005e, Exception -> 0x0060 }
            goto L_0x006a
        L_0x005e:
            r1 = r6
            goto L_0x0069
        ...
        L_0x006a:
            ...
            com.mbridge.msdk.playercommon.exoplayer2.Renderer r1 = (com.mbridge.msdk.playercommon.exoplayer2.Renderer) r1     // Catch:{ ClassNotFoundException -> 0x00a6, Exception -> 0x009d }
            int r5 = r6 + 1
            r10.add(r6, r1)     // Catch:{ ClassNotFoundException -> 0x009b, Exception -> 0x009d }
            java.lang.String r1 = "Loaded LibflacAudioRenderer."
            android.util.Log.i(r11, r1)     // Catch:{ ClassNotFoundException -> 0x009b, Exception -> 0x009d }
            goto L_0x00a7
        L_0x009b:
            r6 = r5
            goto L_0x00a6
        ...
        L_0x00a7:
            ...
            com.mbridge.msdk.playercommon.exoplayer2.Renderer r0 = (com.mbridge.msdk.playercommon.exoplayer2.Renderer) r0     // Catch:{ ClassNotFoundException -> 0x00df, Exception -> 0x00d6 }
            r10.add(r5, r0)     // Catch:{ ClassNotFoundException -> 0x00df, Exception -> 0x00d6 }
            java.lang.String r0 = "Loaded FfmpegAudioRenderer."
            android.util.Log.i(r11, r0)     // Catch:{ ClassNotFoundException -> 0x00df, Exception -> 0x00d6 }
            goto L_0x00df
        L_0x00d6:
            r0 = move-exception
            java.lang.RuntimeException r1 = new java.lang.RuntimeException
