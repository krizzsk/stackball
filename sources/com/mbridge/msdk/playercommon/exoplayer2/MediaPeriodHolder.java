...
final class MediaPeriodHolder {
    ...
    public MediaPeriodHolder(RendererCapabilities[] rendererCapabilitiesArr, long j, TrackSelector trackSelector2, Allocator allocator, MediaSource mediaSource2, Object obj, MediaPeriodInfo mediaPeriodInfo) {
        ...
        MediaPeriod createPeriod = mediaSource2.createPeriod(mediaPeriodInfo.f16393id, allocator);
        this.mediaPeriod = mediaPeriodInfo.endPositionUs != Long.MIN_VALUE ? new ClippingMediaPeriod(createPeriod, true, 0, mediaPeriodInfo.endPositionUs) : createPeriod;
    }
