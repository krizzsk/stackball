...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    public final void prepareChildSource(final T t, MediaSource mediaSource) {
        ...
        C66851 r0 = new MediaSource.SourceInfoRefreshListener() {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i, MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodId2 = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f16409id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f16409id, i);
        ...
        private MediaSourceEventListener.MediaLoadData maybeUpdateMediaLoadData(MediaSourceEventListener.MediaLoadData mediaLoadData) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f16409id, mediaLoadData.mediaStartTimeMs);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f16409id, mediaLoadData.mediaEndTimeMs);
