...
public final class DeferredMediaPeriod implements MediaPeriod, MediaPeriod.Callback {
    ...
    /* renamed from: id */
    public final MediaSource.MediaPeriodId f16410id;
    ...
    public final void createPeriod() {
        MediaPeriod createPeriod = this.mediaSource.createPeriod(this.f16410id, this.allocator);
    ...
    public final void maybeThrowPrepareError() throws IOException {
        try {
            ...
            if (prepareErrorListener == null) {
                ...
                prepareErrorListener.onPrepareError(this.f16410id, e);
            }
        }
    }
