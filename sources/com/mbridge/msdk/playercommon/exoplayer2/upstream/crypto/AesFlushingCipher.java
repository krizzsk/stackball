...
public final class AesFlushingCipher {
    ...
    public AesFlushingCipher(int i, byte[] bArr, long j, long j2) {
        try {
            ...
            this.cipher.init(i, new SecretKeySpec(bArr, Util.splitAtFirst(this.cipher.getAlgorithm(), "/")[0]), new IvParameterSpec(getInitializationVector(j, j2 / ((long) blockSize2))));
            if (i2 != 0) {
