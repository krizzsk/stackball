...
public final class CachedRegionTracker implements Cache.Listener {
    ...
    public final synchronized int getRegionEndTimeMs(long r8) {
        /*
            r7 = this;
            monitor-enter(r7)
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = r7.lookupRegion     // Catch:{ all -> 0x0066 }
            r0.startOffset = r8     // Catch:{ all -> 0x0066 }
            java.util.TreeSet<com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region> r0 = r7.regions     // Catch:{ all -> 0x0066 }
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region r1 = r7.lookupRegion     // Catch:{ all -> 0x0066 }
            java.lang.Object r0 = r0.floor(r1)     // Catch:{ all -> 0x0066 }
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = (com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker.Region) r0     // Catch:{ all -> 0x0066 }
            r1 = -1
        ...
        L_0x001d:
            int r8 = r0.endOffsetIndex     // Catch:{ all -> 0x0066 }
            com.mbridge.msdk.playercommon.exoplayer2.extractor.ChunkIndex r9 = r7.chunkIndex     // Catch:{ all -> 0x0066 }
    ...
    public final synchronized void onSpanRemoved(com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.Cache r7, com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CacheSpan r8) {
        /*
            r6 = this;
            monitor-enter(r6)
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region r7 = new com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region     // Catch:{ all -> 0x006b }
            ...
            java.util.TreeSet<com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region> r8 = r6.regions     // Catch:{ all -> 0x006b }
            java.lang.Object r8 = r8.floor(r7)     // Catch:{ all -> 0x006b }
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region r8 = (com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker.Region) r8     // Catch:{ all -> 0x006b }
            ...
            return
        L_0x0020:
            java.util.TreeSet<com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region> r0 = r6.regions     // Catch:{ all -> 0x006b }
            r0.remove(r8)     // Catch:{ all -> 0x006b }
            long r0 = r8.startOffset     // Catch:{ all -> 0x006b }
            long r2 = r7.startOffset     // Catch:{ all -> 0x006b }
            int r4 = (r0 > r2 ? 1 : (r0 == r2 ? 0 : -1))
            if (r4 >= 0) goto L_0x004c
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = new com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region     // Catch:{ all -> 0x006b }
            long r1 = r8.startOffset     // Catch:{ all -> 0x006b }
            long r3 = r7.startOffset     // Catch:{ all -> 0x006b }
            r0.<init>(r1, r3)     // Catch:{ all -> 0x006b }
            com.mbridge.msdk.playercommon.exoplayer2.extractor.ChunkIndex r1 = r6.chunkIndex     // Catch:{ all -> 0x006b }
        ...
        L_0x0045:
            ...
            java.util.TreeSet<com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region> r1 = r6.regions     // Catch:{ all -> 0x006b }
        ...
        L_0x004c:
            ...
            java.util.TreeSet<com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedRegionTracker$Region> r7 = r6.regions     // Catch:{ all -> 0x006b }
