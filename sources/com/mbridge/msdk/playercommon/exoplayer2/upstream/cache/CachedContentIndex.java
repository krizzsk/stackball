...
class CachedContentIndex {
    ...
    public void maybeRemove(String str) {
        ...
        if (cachedContent != null && cachedContent.isEmpty() && !cachedContent.isLocked()) {
            ...
            this.idToKey.remove(cachedContent.f16419id);
            this.changed = true;
        }
    }
    ...
    private boolean readFile() {
        /*
            ...
            com.mbridge.msdk.playercommon.exoplayer2.util.AtomicFile r3 = r9.atomicFile     // Catch:{ IOException -> 0x009f, all -> 0x0098 }
        ...
        L_0x001d:
            ...
            com.mbridge.msdk.playercommon.exoplayer2.util.Util.closeQuietly((java.io.Closeable) r3)
            return r0
        L_0x002d:
            r5 = 16
        ...
        L_0x0063:
            ...
            com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedContent r7 = com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedContent.readFromStream(r1, r3)     // Catch:{ IOException -> 0x0096, all -> 0x0093 }
        ...
        L_0x0099:
            ...
            com.mbridge.msdk.playercommon.exoplayer2.util.Util.closeQuietly((java.io.Closeable) r1)
        L_0x009e:
            throw r0
        L_0x009f:
        L_0x00a0:
        ...
        L_0x00a5:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.mbridge.msdk.playercommon.exoplayer2.upstream.cache.CachedContentIndex.readFile():boolean");
    }
    ...
    private void add(CachedContent cachedContent) {
        ...
        this.idToKey.put(cachedContent.f16419id, cachedContent.key);
    }
