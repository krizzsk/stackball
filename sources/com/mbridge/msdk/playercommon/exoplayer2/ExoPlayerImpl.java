...
final class ExoPlayerImpl implements ExoPlayer {
    ...
    public final void seekTo(int i, long j) {
        ...
        if (timeline.isEmpty()) {
            ...
            long defaultPositionUs = j == -9223372036854775807L ? timeline.getWindow(i, this.window).getDefaultPositionUs() : C6603C.msToUs(j);
            Pair<Integer, Long> periodPosition = timeline.getPeriodPosition(this.window, this.period, i, defaultPositionUs);
            this.maskingWindowPositionMs = C6603C.usToMs(defaultPositionUs);
            this.maskingPeriodIndex = ((Integer) periodPosition.first).intValue();
        }
        this.internalPlayer.seekTo(timeline, i, C6603C.msToUs(j));
        Iterator<Player.EventListener> it = this.listeners.iterator();
        while (it.hasNext()) {
    ...
    public final long getDuration() {
        ...
        return C6603C.usToMs(this.period.getAdDurationUs(mediaPeriodId.adGroupIndex, mediaPeriodId.adIndexInAdGroup));
    }
    ...
    public final long getContentPosition() {
        ...
        return this.period.getPositionInWindowMs() + C6603C.usToMs(this.playbackInfo.contentPositionUs);
    }
    ...
    private PlaybackInfo getResetPlaybackInfo(boolean z, boolean z2, int i) {
        ...
        return new PlaybackInfo(timeline, obj, this.playbackInfo.periodId, this.playbackInfo.startPositionUs, this.playbackInfo.contentPositionUs, i, false, z2 ? TrackGroupArray.EMPTY : this.playbackInfo.trackGroups, z2 ? this.emptyTrackSelectorResult : this.playbackInfo.trackSelectorResult);
    }
