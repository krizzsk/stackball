...
public final class Id3Decoder implements MetadataDecoder {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:129:0x0192, code lost:
        if (r13 == 67) goto L_0x0194;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.mbridge.msdk.playercommon.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        ...
        L_0x010f:
            ...
            if (r10 != r3) goto L_0x0124
            if (r0 == r2) goto L_0x011e
            if (r13 != r3) goto L_0x0124
        L_0x011e:
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x0124:
            if (r8 != r1) goto L_0x0133
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.TextInformationFrame r1 = decodeTextInformationFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x0130:
            r0 = move-exception
            goto L_0x0213
        ...
        L_0x013f:
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeWxxxFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x0145:
            if (r8 != r4) goto L_0x0151
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.UrlLinkFrame r1 = decodeUrlLinkFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x0151:
            r3 = 73
            r4 = 80
            ...
            if (r10 != r3) goto L_0x0167
            r5 = 86
            if (r13 != r5) goto L_0x0167
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.PrivFrame r1 = decodePrivFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x0167:
            r5 = 71
            r6 = 79
            ...
            if (r10 != r6) goto L_0x017f
            r5 = 66
            if (r13 == r5) goto L_0x0179
            if (r0 != r2) goto L_0x017f
        L_0x0179:
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.GeobFrame r1 = decodeGeobFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x017f:
            r5 = 65
            r11 = 67
        ...
        L_0x018c:
            ...
            if (r13 != r11) goto L_0x0199
        L_0x0194:
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.ApicFrame r1 = decodeApicFrame(r7, r15, r0)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x0199:
        ...
        L_0x01a5:
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.CommentFrame r1 = decodeCommentFrame(r7, r15)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x01aa:
            ...
            r5 = r22
            r6 = r23
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.ChapterFrame r1 = decodeChapterFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x01c4:
            if (r8 != r11) goto L_0x01dc
            if (r9 != r1) goto L_0x01dc
            if (r10 != r6) goto L_0x01dc
            if (r13 != r11) goto L_0x01dc
            r1 = r20
            r2 = r15
            r3 = r19
            r4 = r21
            r5 = r22
            r6 = r23
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.ChapterTocFrame r1 = decodeChapterTOCFrame(r1, r2, r3, r4, r5, r6)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            goto L_0x01e4
        L_0x01dc:
            java.lang.String r1 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            com.mbridge.msdk.playercommon.exoplayer2.metadata.id3.BinaryFrame r1 = decodeBinaryFrame(r7, r15, r1)     // Catch:{ UnsupportedEncodingException -> 0x020a }
        L_0x01e4:
            if (r1 != 0) goto L_0x0206
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ UnsupportedEncodingException -> 0x020a }
            r2.<init>()     // Catch:{ UnsupportedEncodingException -> 0x020a }
            java.lang.String r3 = "Failed to decode frame: id="
            r2.append(r3)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            java.lang.String r0 = getFrameId(r0, r8, r9, r10, r13)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            r2.append(r0)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            java.lang.String r0 = ", frameSize="
            r2.append(r0)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            r2.append(r15)     // Catch:{ UnsupportedEncodingException -> 0x020a }
            java.lang.String r0 = r2.toString()     // Catch:{ UnsupportedEncodingException -> 0x020a }
            android.util.Log.w(r12, r0)     // Catch:{ UnsupportedEncodingException -> 0x020a }
        L_0x0206:
            r7.setPosition(r14)
            return r1
        L_0x020a:
            java.lang.String r0 = "Unsupported character encoding"
            android.util.Log.w(r12, r0)     // Catch:{ all -> 0x0130 }
            r7.setPosition(r14)
            return r16
        L_0x0213:
            r7.setPosition(r14)
    ...
    private static UrlLinkFrame decodeWxxxFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        String str = new String(bArr, 0, indexOfEos, charsetName);
        int delimiterLength = indexOfEos + delimiterLength(readUnsignedByte);
        return new UrlLinkFrame("WXXX", str, decodeStringIfValid(bArr, delimiterLength, indexOfZeroByte(bArr, delimiterLength), C3716C.ISO88591_NAME));
    }
    ...
    private static UrlLinkFrame decodeUrlLinkFrame(ParsableByteArray parsableByteArray, int i, String str) throws UnsupportedEncodingException {
        ...
        return new UrlLinkFrame(str, (String) null, new String(bArr, 0, indexOfZeroByte(bArr, 0), C3716C.ISO88591_NAME));
    }
    ...
    private static PrivFrame decodePrivFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        return new PrivFrame(new String(bArr, 0, indexOfZeroByte, C3716C.ISO88591_NAME), copyOfRangeIfValid(bArr, indexOfZeroByte + 1, i));
    }
    ...
    private static GeobFrame decodeGeobFrame(ParsableByteArray parsableByteArray, int i) throws UnsupportedEncodingException {
        ...
        parsableByteArray.readBytes(bArr, 0, i2);
        int indexOfZeroByte = indexOfZeroByte(bArr, 0);
        String str = new String(bArr, 0, indexOfZeroByte, C3716C.ISO88591_NAME);
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        if (i2 == 2) {
            str = "image/" + Util.toLowerInvariant(new String(bArr, 0, 3, C3716C.ISO88591_NAME));
            ...
            String lowerInvariant = Util.toLowerInvariant(new String(bArr, 0, i3, C3716C.ISO88591_NAME));
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        String str = new String(parsableByteArray2.data, position, indexOfZeroByte - position, C3716C.ISO88591_NAME);
    ...
    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, FramePredicate framePredicate2) throws UnsupportedEncodingException {
        ...
        for (int i4 = 0; i4 < readUnsignedByte2; i4++) {
            ...
            strArr[i4] = new String(parsableByteArray2.data, position2, indexOfZeroByte2 - position2, C3716C.ISO88591_NAME);
