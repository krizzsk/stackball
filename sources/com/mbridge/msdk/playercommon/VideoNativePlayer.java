...
public class VideoNativePlayer implements Player.EventListener {
    ...
    private Runnable playProgressMSRunnable = new Runnable() {
        public void run() {
            try {
                ...
                C6361q.m16158d(VideoNativePlayer.TAG, e.getMessage());
            }
        }
    };
    ...
    private void postOnPlayErrorOnMainThread(final String str) {
        try {
            ...
            C6323d.m16031a(42, this.mPlayUrl, str);
        } catch (Exception e) {
            C6361q.m16158d(TAG, e.getMessage());
        }
    }
    ...
    public void setDataSource(android.content.Context r7) {
        ...
        L_0x0018:
            ...
            com.mbridge.msdk.foundation.tools.C6361q.m16158d(r0, r2)     // Catch:{ Exception -> 0x00b0 }
        L_0x0020:
        ...
        L_0x00b0:
            ...
            com.mbridge.msdk.foundation.tools.C6361q.m16158d(r0, r2)
            r6.hideLoading()
    ...
    public void onPositionDiscontinuity(int i) {
        C6361q.m16158d(TAG, "onPositionDiscontinuity : " + i);
        if (i == 0) {
            onCompletion();
        }
    }
