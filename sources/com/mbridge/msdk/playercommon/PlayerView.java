...
public class PlayerView extends LinearLayout {
    ...
    public void addSurfaceView() {
        try {
            C6361q.m16156b(TAG, "addSurfaceView");
    ...
    public void removeSurface() {
        try {
            C6361q.m16156b(TAG, "removeSurface");
    ...
    private void initView() {
        View inflate = LayoutInflater.from(getContext()).inflate(C6347k.m16084a(getContext(), "mbridge_playercommon_player_view", "layout"), (ViewGroup) null);
        if (inflate != null) {
            this.mLlSurContainer = (LinearLayout) inflate.findViewById(C6347k.m16084a(getContext(), "mbridge_playercommon_ll_sur_container", "id"));
            this.mLoadingView = (LinearLayout) inflate.findViewById(C6347k.m16084a(getContext(), "mbridge_playercommon_ll_loading", "id"));
            addSurfaceView();
            addView(inflate, -1, -1);
        }
    }
    ...
    private class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder surfaceHolder) {
            try {
                ...
                C6361q.m16158d(PlayerView.TAG, e.getMessage());
            }
        }
