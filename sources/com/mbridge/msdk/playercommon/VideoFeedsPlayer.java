...
public class VideoFeedsPlayer implements Player.EventListener {
    ...
    private Runnable playProgressRunnable = new Runnable() {
        public void run() {
            ...
            try {
                ...
                C6361q.m16158d(VideoFeedsPlayer.TAG, e.getMessage());
            }
        }
    };
    ...
    public boolean initPlayer(Context context, View view, String str, VideoPlayerStatusListener videoPlayerStatusListener) {
        if (view == null) {
            try {
                C6361q.m16156b(TAG, "loadingView is NULL");
    ...
    public void onPrepared() {
        try {
            if (!this.mIsFrontDesk) {
                C6361q.m16158d(TAG, "At background, Do not process");
                ...
                if (this.exoPlayer != null) {
                    ...
                    if (!this.isStart) {
                        ...
                        C6361q.m16156b(TAG, "onPlayStarted()，getCurrentPosition:" + this.exoPlayer.getCurrentPosition());
                        this.isStart = true;
                    }
                }
                postOnBufferinEndOnMainThread();
                startPlayProgressTimer();
                C6361q.m16156b(TAG, "onPrepare mCurrentPosition:" + this.mCurrentPosition + " onPrepare mHasPrepare：" + this.mHasPrepare);
            }
        } catch (Throwable th) {
            C6361q.m16158d(TAG, th.getMessage());
        }
                    ...
                    public void run() {
                        ...
                        if (VideoFeedsPlayer.this.mInnerVFPLisener != null) {
                            try {
                                ...
                                C6361q.m16158d(VideoFeedsPlayer.TAG, e2.getMessage());
                            }
                        }
                    }
                });
    ...
    private void postOnPlayErrorOnMainThread(final String str) {
        try {
            ...
            C6323d.m16031a(94, this.mPlayUrl, str);
        } catch (Exception e) {
            C6361q.m16158d(TAG, e.getMessage());
        }
    }
    ...
    public void pause() {
        try {
            if (this.mHasPrepare && this.exoPlayer != null && exoPlayerIsPlaying()) {
                C6361q.m16156b(TAG, "pause isPalying:" + exoPlayerIsPlaying() + " mIsPlaying:" + this.mIsPlaying);
                hideLoading();
    ...
    public boolean onError(int i, String str) {
        try {
            hideLoading();
            if (!this.mIsFrontDesk && "MIX 3".equalsIgnoreCase(C6349m.m16091a()) && C6349m.m16099c().equalsIgnoreCase("Xiaomi")) {
                return true;
            }
            this.mHasPrepare = false;
    ...
    public void onPlayerStateChanged(boolean z, int i) {
        C6361q.m16158d(TAG, "onPlaybackStateChanged : " + i);
        if (i == 1) {
            C6361q.m16158d(TAG, "onPlaybackStateChanged : IDLE");
            postOnPlayErrorOnMainThread("The player state IDLE.");
        } else if (i == 2) {
            C6361q.m16158d(TAG, "onPlaybackStateChanged : Buffering");
            this.mIsBuffering = true;
            showLoading();
            startBufferIngTimer(PlayerErrorConstant.PLAYERING_TIMEOUT);
        } else if (i == 3) {
            C6361q.m16158d(TAG, "onPlaybackStateChanged : READY");
            this.mIsBuffering = false;
            hideLoading();
            postOnBufferinEndOnMainThread();
            onPrepared();
        } else if (i == 4) {
            C6361q.m16158d(TAG, "onPlaybackStateChanged : Ended : PLAY ENDED");
            cancelPlayProgressTimer();
            onCompletion();
        }
    }
    ...
    public void onPlayerError(ExoPlaybackException exoPlaybackException) {
        ...
        if (exoPlaybackException != null) {
            ...
            C6361q.m16158d(TAG, "onPlayerError : " + str);
    ...
    public void onPlaybackParametersChanged(PlaybackParameters playbackParameters) {
        C6361q.m16158d(TAG, "onPlaybackParametersChanged : " + playbackParameters.speed);
    }
}
