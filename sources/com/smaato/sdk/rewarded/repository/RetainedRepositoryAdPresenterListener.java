...
public abstract class RetainedRepositoryAdPresenterListener implements StateMachine.Listener<AdStateMachine.State> {
    ...
    public abstract void onReadyToBeRemovedFromCache(RewardedAdPresenter rewardedAdPresenter2);

    RetainedRepositoryAdPresenterListener(RewardedAdPresenter rewardedAdPresenter2) {
        this.rewardedAdPresenter = (RewardedAdPresenter) Objects.requireNonNull(rewardedAdPresenter2);
    }

    /* renamed from: com.smaato.sdk.rewarded.repository.RetainedRepositoryAdPresenterListener$1 */
    static /* synthetic */ class C88441 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.smaato.sdk.rewarded.repository.RetainedRepositoryAdPresenterListener.C88441.<clinit>():void");
        }
    }

    public void onStateChanged(AdStateMachine.State state, AdStateMachine.State state2, Metadata metadata) {
        switch (C88441.$SwitchMap$com$smaato$sdk$core$ad$AdStateMachine$State[state2.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
