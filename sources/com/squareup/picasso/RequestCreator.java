...
public class RequestCreator {
    ...
    public void into(RemoteViews remoteViews, int i, int i2, Notification notification, String str) {
        into(remoteViews, i, i2, notification, str, (Callback) null);
    }
    ...
    public void into(RemoteViews remoteViews, int i, int i2, Notification notification, String str, Callback callback) {
        ...
        if (remoteViews == null) {
            ...
            String str2 = str;
            performRemoteViewInto(new RemoteViewsAction.NotificationAction(this.picasso, createRequest, remoteViews2, i3, i4, notification2, str2, this.memoryPolicy, this.networkPolicy, Utils.createKey(createRequest, new StringBuilder()), this.tag, this.errorResId, callback));
        } else {
    ...
    public void into(RemoteViews remoteViews, int i, int[] iArr, Callback callback) {
        ...
        if (remoteViews == null) {
            ...
            int i2 = i;
            int[] iArr2 = iArr;
            performRemoteViewInto(new RemoteViewsAction.AppWidgetAction(this.picasso, createRequest, remoteViews2, i2, iArr2, this.memoryPolicy, this.networkPolicy, Utils.createKey(createRequest, new StringBuilder()), this.tag, this.errorResId, callback));
        } else {
            throw new IllegalArgumentException("Cannot use placeholder or error drawables with remote views.");
        }
    }
    ...
    private Request createRequest(long j) {
        ...
        if (transformRequest != build) {
            transformRequest.f21844id = andIncrement;
