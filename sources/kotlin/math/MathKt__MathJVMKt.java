...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m45526ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m45527ln(float f) {
