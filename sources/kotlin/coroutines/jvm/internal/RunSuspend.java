...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m47206getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m46014boximpl(obj);
            notifyAll();
        ...
        synchronized (this) {
            while (true) {
                ...
                if (result2 == null) {
                    ...
                    ResultKt.throwOnFailure(result2.m46024unboximpl());
                }
            }
        }
    }
