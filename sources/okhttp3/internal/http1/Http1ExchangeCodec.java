...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    public Sink createRequestBody(Request request, long j) throws IOException {
        ...
        } else if ("chunked".equalsIgnoreCase(request.header(HttpHeaders.TRANSFER_ENCODING))) {
    ...
    public Response.Builder readResponseHeaders(boolean z) throws IOException {
        ...
        if (i == 1 || i == 3) {
            try {
                ...
                RealConnection realConnection2 = this.realConnection;
                String redact = realConnection2 != null ? realConnection2.route().address().url().redact() : "unknown";
