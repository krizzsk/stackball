...
public final class Util {
    ...
    public static final Headers EMPTY_HEADERS = Headers.m45529of(new String[0]);
    ...
    private static final Options UNICODE_BOMS = Options.m45533of(ByteString.decodeHex("efbbbf"), ByteString.decodeHex("feff"), ByteString.decodeHex("fffe"), ByteString.decodeHex("0000ffff"), ByteString.decodeHex("ffff0000"));
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        ...
        return str + CertificateUtil.DELIMITER + httpUrl.port();
    }
