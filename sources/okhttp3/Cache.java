...
import okhttp3.internal.p273io.FileSystem;
        ...
        return new Iterator<String>() {
            ...
            public boolean hasNext() {
                ...
                L_0x0009:
                    ...
                    java.util.Iterator<okhttp3.internal.cache.DiskLruCache$Snapshot> r2 = r5.delegate     // Catch:{ IOException -> 0x003b }
                    java.lang.Object r2 = r2.next()     // Catch:{ IOException -> 0x003b }
                    okhttp3.internal.cache.DiskLruCache$Snapshot r2 = (okhttp3.internal.cache.DiskLruCache.Snapshot) r2     // Catch:{ IOException -> 0x003b }
                    okio.Source r3 = r2.getSource(r0)     // Catch:{ all -> 0x002d }
                    okio.BufferedSource r3 = okio.Okio.buffer((okio.Source) r3)     // Catch:{ all -> 0x002d }
                    java.lang.String r3 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x002d }
                    r5.nextUrl = r3     // Catch:{ all -> 0x002d }
                ...
                L_0x0036:
                    r2 = move-exception
                    r3.addSuppressed(r2)     // Catch:{ IOException -> 0x003b }
                L_0x003a:
                ...
                L_0x003d:
                    return r0
                */
                throw new UnsupportedOperationException("Method not decompiled: okhttp3.Cache.C155942.hasNext():boolean");
            }
    ...
    private static final class Entry {
        ...
        private void writeCertList(BufferedSink bufferedSink, List<Certificate> list) throws IOException {
            try {
                ...
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    bufferedSink.writeUtf8(ByteString.m45531of(list.get(i).getEncoded()).base64()).writeByte(10);
                }
