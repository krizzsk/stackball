    ...
    final class AsyncCall extends NamedRunnable {
        ...
        public void execute() {
            /*
                ...
                r0.timeoutEnter()
                r0 = 0
                okhttp3.RealCall r1 = okhttp3.RealCall.this     // Catch:{ IOException -> 0x0055, all -> 0x0028 }
                okhttp3.Response r0 = r1.getResponseWithInterceptorChain()     // Catch:{ IOException -> 0x0055, all -> 0x0028 }
                r1 = 1
                okhttp3.Callback r2 = r5.responseCallback     // Catch:{ IOException -> 0x0026, all -> 0x0024 }
            ...
            L_0x0028:
                ...
                r1 = 0
            L_0x002b:
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0053 }
                ...
                okhttp3.Callback r2 = r5.responseCallback     // Catch:{ all -> 0x0053 }
                okhttp3.RealCall r3 = okhttp3.RealCall.this     // Catch:{ all -> 0x0053 }
            ...
            L_0x0058:
                ...
                okhttp3.internal.platform.Platform r1 = okhttp3.internal.platform.Platform.get()     // Catch:{ all -> 0x0053 }
                r2 = 4
                ...
                okhttp3.RealCall r4 = okhttp3.RealCall.this     // Catch:{ all -> 0x0053 }
                java.lang.String r4 = r4.toLoggableString()     // Catch:{ all -> 0x0053 }
                r3.append(r4)     // Catch:{ all -> 0x0053 }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0053 }
                r1.log(r2, r3, r0)     // Catch:{ all -> 0x0053 }
                goto L_0x0018
            L_0x007a:
                okhttp3.Callback r1 = r5.responseCallback     // Catch:{ all -> 0x0053 }
                okhttp3.RealCall r2 = okhttp3.RealCall.this     // Catch:{ all -> 0x0053 }
